...
void HintTable_Init() {
    ...
    hintTable[HOARDS]          = HintText::Exclude({Text{"hoards",                      /*french*/"rec\x95le",                       /*spanish*/"acapara"}});
    ...
    hintTable[KOKIRI_SWORD] = HintText::Item({
                       //obscure text
                       Text{"a butter knife",    /*french*/"un couteau \x90 beurre",  /*spanish*/"un \x91gil puñal"},
                       Text{"a starter slasher", /*french*/"une arme de d\x96butant", /*spanish*/"una hoja de principiantes"},
                       Text{"a switchblade",     /*french*/"un canif",             /*spanish*/"una navaja"},
                     }, {
                       //ambiguous text
                       Text{"a sword", /*french*/"une \x96p\x96e", /*spanish*/"una espada"},
                     },
                       //clear text
                       Text{"the Kokiri Sword", /*french*/"l'\x96p\x96e Kokiri", /*spanish*/"la Espada Kokiri"}
    );

    hintTable[MASTER_SWORD] = HintText::Item({
                       //obscure text
                       Text{"evil's bane",        /*french*/"le fl\x96au du mal",       /*spanish*/"la destructora del mal"},
                       ...
                       //clear text
                       Text{"the Master Sword", /*french*/"l'\x96p\x96e de l\x96gende", /*spanish*/"la Espada Maestra"}
    );

    hintTable[GIANTS_KNIFE] = HintText::Item({
                       //obscure text
                       Text{"a fragile blade",     /*french*/"une lame fragile",    /*spanish*/"una fr\x91gil hoja"},
                       ...
                       //clear text
                       Text{"the Giant's Knife", /*french*/"la lame des g\x96ants", /*spanish*/"la daga gigante"}
    );
    ...
    hintTable[BIGGORON_SWORD] = HintText::Item({
                       ...
                       //clear text
                       Text{"the Biggoron Sword", /*french*/"l'\x96p\x96e de Grogoron", /*spanish*/"la Espada de Biggoron"}
    );

    hintTable[DEKU_SHIELD] = HintText::Item({
                       //obscure text
                       Text{"a wooden ward",      /*french*/"un \x96cu d'\x96corce",            /*spanish*/"una protección del bosque"},
    ...
    hintTable[MIRROR_SHIELD] = HintText::Item({
                       //obscure text
                       Text{"a reflective rampart", /*french*/"un capteur de lumi\x95re",   /*spanish*/"una muralla reflectora"},
                       Text{"Medusa's weakness",    /*french*/"la faiblesse de M\x96duse", /*spanish*/"la debilidad de Medusa"},
                       Text{"a silvered surface",   /*french*/"une surface argent\x96e",    /*spanish*/"una superficie plateada"},
                     }, {
                       //ambiguous text
                       Text{"a shield", /*french*/"un bouclier", /*spanish*/"un escudo"},
                     },
    ...
    hintTable[GORON_TUNIC] = HintText::Item({
                       ...
                       Text{"fireproof fabric", /*french*/"un tr\x96sor anti-flamme", /*spanish*/"una ignífuga prenda"},
    ...
    hintTable[ZORA_TUNIC] = HintText::Item({
                       //obscure text
                       Text{"a sapphire suit", /*french*/"un pigment bleut\x96",      /*spanish*/"una vestidura zafiro"},
                       Text{"scuba gear",      /*french*/"un habit de plong\x96e",    /*spanish*/"un traje impermeable"},
    ...
    hintTable[IRON_BOOTS] = HintText::Item({
                       ...
                       Text{"clank cleats", /*french*/"une paire de talons bruyants", /*spanish*/"unas suelas f\x96rreas"},
                     }, {
                       //ambiguous text
                       Text{"some boots", /*french*/"une paire de bottes", /*spanish*/"un par de botas"},
                       Text{"a feature of the Water Temple", /*french*/"une particularit\x96 du temple de l'eau", /*spanish*/"algo particular del Templo del Agua"},
                       Text{"something heavy", /*french*/"une chose pesante", /*spanish*/"algo de lo m\x91s pesado"},
                     },
                       //clear text
    ...
    hintTable[HOVER_BOOTS] = HintText::Item({
                       ...
                       Text{"sacred slippers", /*french*/"une paire de pantoufles sacr\x96es", /*spanish*/"unos escurridizos botines"},
    ...
    hintTable[BOOMERANG] = HintText::Item({
                       //obscure text
                       Text{"a banana",       /*french*/"une banane",            /*spanish*/"un pl\x91tano"},
                       Text{"a stun stick",   /*french*/"un b\x92ton \x96tourdissant", /*spanish*/"un palo aturdidor"},
                       Text{"a yellow angle", /*french*/"un angle jaune",        /*spanish*/"un \x91ngulo amarillo"},
                     }, {
                       //ambiguous text
                       ...
                       //clear text
                       Text{"the Boomerang", /*french*/"le boomerang", /*spanish*/"el bumer\x91n"}
    );

    hintTable[LENS_OF_TRUTH] = HintText::Item({
                       //obscure text
                       Text{"a lie detector",     /*french*/"un d\x96tecteur de mensonges", /*spanish*/"el detector de ilusiones"},
                       Text{"a ghost tracker",    /*french*/"un trouve-fantôme",         /*spanish*/"el rastreador paranormal"},
                       Text{"true sight",         /*french*/"le troisi\x95me œil",         /*spanish*/"el ojo que todo ve"},
                       Text{"a detective's tool", /*french*/"un tr\x96sor Sheikah",         /*spanish*/"la revelación verdadera"},
                     }, {
                       //ambiguous text
                       Text{"a secret-finding tool", /*french*/"un cherche-secrets", /*spanish*/"un instrumento para hallar objetos"},
                     },
                       //clear text
                       Text{"the Lens of Truth", /*french*/"le monocle de V\x96rit\x96", /*spanish*/"la Lupa de la Verdad"}
    );
    ...
    hintTable[MEGATON_HAMMER] = HintText::Item({
                       ...
                       //ambiguous text
                       Text{"something that can remove boulders", /*french*/"une chose qui enl\x95ve les rochers", /*spanish*/"algo que pueda quitar rocas"},
                     },
                       //clear text
    ...
    hintTable[DINS_FIRE] = HintText::Item({
                       ...
                       //ambiguous text
                       Text{"a Great Fairy's power", /*french*/"le pouvoir d'une grande f\x96e", /*spanish*/"el poder de una Gran Hada"},
                     },
                       //clear text
    ...
    hintTable[FARORES_WIND] = HintText::Item({
                       //obscure text
                       Text{"teleportation",     /*french*/"la t\x96l\x96portation",      /*spanish*/"un teletransportador"},
    ...
    hintTable[NAYRUS_LOVE] = HintText::Item({
                       ...
                       Text{"an impregnable aura", /*french*/"un aura imp\x96n\x96trable", /*spanish*/"un aura impenetrable"},
    ...
    hintTable[FIRE_ARROWS] = HintText::Item({
                       //obscure text
                       Text{"the furnace firearm" , /*french*/"une fus\x96e solaire",     /*spanish*/"el ardiente aguijón"},
                       Text{"the burning bolts",    /*french*/"un obus enflamm\x96",      /*spanish*/"las puntas ígneas"},
                       Text{"a magma missile",      /*french*/"un missile volcanique", /*spanish*/"el misil abrasador"},
                     }, {
                       //ambiguous text
                       Text{"a magic arrow", /*french*/"une fl\x95che magique", /*spanish*/"una flecha m\x91gica"},
                     },
                       //clear text
                       Text{"the Fire Arrows", /*french*/"la fl\x95che de feu", /*spanish*/"la flecha de fuego"}
    );

    hintTable[ICE_ARROWS] = HintText::Item({
                       //obscure text
                       Text{"the refrigerator rocket", /*french*/"un missile p\x96trifiant", /*spanish*/"el misil congelador"},
                       Text{"the frostbite bolts",     /*french*/"un froid mordant",      /*spanish*/"las puntas g\x96lidas"},
                       ...
                       //clear text
                       Text{"the Ice Arrows", /*french*/"la fl\x95che de glace", /*spanish*/"la flecha de hielo"}
    );

    hintTable[LIGHT_ARROWS] = HintText::Item({
                       //obscure text
                       Text{"the shining shot",      /*french*/"l'arme brillante",      /*spanish*/"el haz de luz"},
                       Text{"the luminous launcher", /*french*/"un jet de lumi\x95re",      /*spanish*/"el disparo luminoso"},
                       Text{"Ganondorf's bane",      /*french*/"le fl\x96au de Ganondorf", /*spanish*/"la perdición de Ganondorf"},
                       Text{"the lighting bolts",    /*french*/"l'\x96clair sacr\x96",        /*spanish*/"las puntas resplandecientes"},
                     }, {
                       //ambiguous text
                       Text{"a magic arrow", /*french*/"une fl\x95che magique", /*spanish*/"una flecha m\x91gica"},
                     },
                       //clear text
                       Text{"the Light Arrows", /*french*/"la fl\x95che de lumi\x95re", /*spanish*/"la flecha de luz"}
    );

    hintTable[GERUDO_TOKEN] = HintText::Item({
                       //obscure text
                       Text{"a girl club membership", /*french*/"une carte de membre", /*spanish*/"una f\x96mina membresía"},
    ...
    hintTable[MAGIC_BEAN] = HintText::Item({
                       //obscure text
                       Text{"a wizardly legume", /*french*/"un l\x96gume ensorcel\x96", /*spanish*/"una legumbre hechizada"},
                     }, {
                       //ambiguous text
                       Text{"something sometimes buried", /*french*/"une chose parfois enterr\x96e", /*spanish*/"algo a veces enterrado"},
                     },
                       //clear text
                       Text{"a Magic Bean", /*french*/"un haricot magique", /*spanish*/"una judía m\x91gica"}
    );

    hintTable[MAGIC_BEAN_PACK] = HintText::Item({
                       //obscure text
                       Text{"wizardly legumes", /*french*/"un paquet de l\x96gumes ensorcel\x96s", /*spanish*/"unas legumbres hechizadas"},
                     }, {
                       //ambiguous text
                       Text{"something sometimes buried", /*french*/"une chose parfois enterr\x96e", /*spanish*/"algo a veces enterrado"},
                     },
                       //clear text
                       Text{"Magic Beans", /*french*/"un paquet de haricots magiques", /*spanish*/"unas judías m\x91gicas"}
    );

    hintTable[DOUBLE_DEFENSE] = HintText::Item({
                       //obscure text
                       Text{"a white outline",   /*french*/"un rebord blanc",               /*spanish*/"un contorno blanco"},
                       Text{"damage decrease",   /*french*/"une protection suppl\x96mentaire", /*spanish*/"una reducción de daño"},
                       ...
                       //clear text
                       Text{"Double Defense", /*french*/"la double d\x96fence", /*spanish*/"la doble defensa"}
    );

    hintTable[GOLD_SKULLTULA_TOKEN] = HintText::Item({
                       //obscure text
                       Text{"proof of destruction",   /*french*/"un certificat d'\x96limination", /*spanish*/"una prueba de la destrucción"},
                       Text{"an arachnid chip",       /*french*/"un symbole cranien",            /*spanish*/"una figura ar\x91cnida"},
                       Text{"spider remains",         /*french*/"une d\x96pouille dor\x96e",         /*spanish*/"unos restos dorados"},
                       Text{"one percent of a curse", /*french*/"un centi\x95me de mal\x96diction",  /*spanish*/"una cent\x96sima de una maldición"},
                     }, {
                       //ambiguous text
                       Text{"a token of recognition", /*french*/"une preuve de reconnaissance", /*spanish*/"una prueba de reconocimiento"},
                       Text{"something sometimes buried", /*french*/"une chose parfois enterr\x96e", /*spanish*/"algo a veces enterrado"},
    ...
    hintTable[POCKET_EGG] = HintText::Item({
                       //obscure text
                       Text{"a Cucco container",   /*french*/"un r\x96servoir \x90 Cocotte", /*spanish*/"cuco contenido"},
                       Text{"a Cucco, eventually", /*french*/"un poussin \x96ventuel",    /*spanish*/"un futuro cuco"},
                       Text{"a fowl youth",        /*french*/"une omelette crue",      /*spanish*/"una dulce juventud"},
                     }, {
                       //ambiguous text
                       Text{"a trade quest item", /*french*/"un objet de quête d'\x96changes", /*spanish*/"un objeto de una misión secundaria"},
                       Text{"an egg", /*french*/"un oeuf", /*spanish*/"un huevo"},
                     },
                       //clear text
    ...
    hintTable[ODD_MUSHROOM] = HintText::Item({
                       //obscure text
                       Text{"a powder ingredient", /*french*/"un ingr\x96dient \x90 poudre", /*spanish*/"un oloroso ingrediente"},
                     }, {
                       //ambiguous text
                       Text{"a trade quest item", /*french*/"un objet de quête d'\x96changes", /*spanish*/"un objeto de una misión secundaria"},
                     },
    ...
    hintTable[ODD_POULTICE] = HintText::Item({
                       ...
                       //ambiguous text
                       Text{"something that contains medicine", /*french*/"une chose m\x96dicamenteuse", /*spanish*/"algo que contenga medicina"},
    ...
    hintTable[POACHERS_SAW] = HintText::Item({
                       //obscure text
                       Text{"a tree killer", /*french*/"un coupeur d'arbres", /*spanish*/"un destructor de \x91rboles"},
                     }, {
                       //ambiguous text
                       Text{"a trade quest item", /*french*/"un objet de quête d'\x96changes", /*spanish*/"un objeto de una misión secundaria"},
                     },
    ...
    hintTable[BROKEN_SWORD] = HintText::Item({
                       //obscure text
                       Text{"a shattered slicer", /*french*/"une arme cass\x96e", /*spanish*/"una rebanadora rota"},
                     }, {
                       //ambiguous text
                       Text{"a trade quest item", /*french*/"un objet de quête d'\x96changes", /*spanish*/"un objeto de una misión secundaria"},
                       Text{"a sword", /*french*/"une \x96p\x96e", /*spanish*/"una espada"},
                       ...
                       //clear text
                       Text{"the Broken Goron's Sword", /*french*/"l'\x96p\x96e bris\x96e de Goron", /*spanish*/"la espada goron rota"}
    );

    hintTable[PRESCRIPTION] = HintText::Item({
                       //obscure text
                       Text{"a pill pamphlet", /*french*/"un document urgent", /*spanish*/"un instructivo medicinal"},
                       Text{"a doctor's note", /*french*/"un papier m\x96dical",  /*spanish*/"unas notas del doctor"},
                     }, {
                       //ambiguous text
                       Text{"a trade quest item", /*french*/"un objet de quête d'\x96changes", /*spanish*/"un objeto de una misión secundaria"},
                     },
    ...
    hintTable[PROGRESSIVE_STRENGTH] = HintText::Item({
                       ...
                       Text{"metal mittens",   /*french*/"une paire de mitaines",               /*spanish*/"unas manoplas met\x91licas"},
                       ...
                       //clear text
                       Text{"a Strength Upgrade", /*french*/"une am\x96lioration de force", /*spanish*/"un aumento de fuerza"}
    );
    ...
    hintTable[PROGRESSIVE_BOW] = HintText::Item({
                       ...
                       Text{"a danger dart launcher", /*french*/"un tire-fl\x96chette",      /*spanish*/"un peligroso lanzadardos"},
                     }, {
                       //ambiguous text
                       Text{"a projectile shooter", /*french*/"un tire-projectile", /*spanish*/"un arma de proyectil"},
                     },
                       //clear text
                       Text{"a Bow", /*french*/"l'arc des f\x96es", /*spanish*/"un arco de las hadas"}
    );

    hintTable[PROGRESSIVE_SLINGSHOT] = HintText::Item({
                       //obscure text
                       Text{"a seed shooter",     /*french*/"un lance-noix",     /*spanish*/"un lanzasemillas"},
                       Text{"a rubberband",       /*french*/"un \x96lastique",      /*spanish*/"un tirachinas"},
    ...
    hintTable[PROGRESSIVE_WALLET] = HintText::Item({
                       //obscure text
                       Text{"a mo' money holder", /*french*/"un sac \x90 sous",     /*spanish*/"una cartera de dinero"},
    ...
    hintTable[PROGRESSIVE_SCALE] = HintText::Item({
                       //obscure text
                       Text{"a deeper dive",   /*french*/"une bulle de plong\x96e", /*spanish*/"un profundo buceo"},
                       Text{"a piece of Zora", /*french*/"un morceau de Zora",   /*spanish*/"un fragmento de Zora"},
                     }, {
                       //ambiguous text
                       Text{"a diving tool", /*french*/"un outil de plong\x96e", /*spanish*/"un instrumento de buceo"},
                     },
                       //clear text
                       Text{"a Zora Scale", /*french*/"une \x96caille Zora", /*spanish*/"una escama Zora"}
    );

    hintTable[PROGRESSIVE_NUT_UPGRADE] = HintText::Item({
                       //obscure text
                       Text{"more nuts",         /*french*/"ecnore plus de noix", /*spanish*/"m\x91s semillas de nogal"},
                       Text{"flashbang storage", /*french*/"un sac \x90 noix",       /*spanish*/"m\x91s frutos aturdidores"},
                     }, {
                       //ambiguous text
    ...
    hintTable[PROGRESSIVE_STICK_UPGRADE] = HintText::Item({
                       //obscure text
                       Text{"a lumber rack",        /*french*/"un paquet de bois",    /*spanish*/"m\x91s bastones"},
                       Text{"more flammable twigs", /*french*/"beaucoup de branches", /*spanish*/"m\x91s varas"},
                     }, {
                       //ambiguous text
                       Text{"some Deku munitions", /*french*/"un paquet de munitions Mojo", /*spanish*/"un montón de municiones Deku"},
                     },
                       //clear text
                       Text{"Deku Stick Capacity", /*french*/"une augmentation de b\x92tons Mojo", /*spanish*/"un aumento de palos deku"}
    );
    ...
    hintTable[PROGRESSIVE_MAGIC_METER] = HintText::Item({
                       ...
                       Text{"pixie dust",         /*french*/"de la poudre de f\x96e", /*spanish*/"un polvo de hada"},
                       ...
                       //clear text
                       Text{"a Magic Meter", /*french*/"une jauge de magie", /*spanish*/"un aumento de poder m\x91gico"}
    );
    ...
    hintTable[PROGRESSIVE_BOMBCHUS] = HintText::Item({
                       ...
                       Text{"trail blazers",  /*french*/"un zigzag \x96clatant", /*spanish*/"unas ratas propulsadas"},
                     }, {
                       //ambiguous text
                       Text{"a prize of the House of Skulltulas", /*french*/"un prix de la maison des Skulltulas", /*spanish*/"un obsequio de la Casa Skulltula"},
                       Text{"explosives", /*french*/"un paquet d'explosifs", /*spanish*/"un montón de explosivos"},
    ...
    hintTable[PROGRESSIVE_GORONSWORD] = HintText::Item({
                       ...
                       //clear text
                       Text{"a Goron Sword", /*french*/"une \x96p\x96e Goron", /*spanish*/"una espada goron"}
    );
    ...
    hintTable[BOTTLE_WITH_MILK] = HintText::Item({
                       ...
                       Text{"a baby's breakfast", /*french*/"du jus pour b\x96b\x96",     /*spanish*/"un trago para beb\x96s"},
                     }, {
                       //ambiguous text
                       Text{"a bottle", /*french*/"un flacon", /*spanish*/"una botella"},
                     },
    ...
    hintTable[BOTTLE_WITH_RED_POTION] = HintText::Item({
                       //obscure text
                       Text{"a vitality vial", /*french*/"un m\x96lange de vitalit\x96", /*spanish*/"una pócima vitalicia"},
    ...
    hintTable[BOTTLE_WITH_GREEN_POTION] = HintText::Item({
                       //obscure text
                       Text{"a magic mixture", /*french*/"une r\x96serve magique", /*spanish*/"un potingue m\x91gico"},
    ...
    hintTable[BOTTLE_WITH_BLUE_POTION] = HintText::Item({
                       //obscure text
                       Text{"an ailment antidote", /*french*/"l'\x96lixir ultime", /*spanish*/"un antídoto para el dolor"},
    ...
    hintTable[BOTTLE_WITH_FAIRY] = HintText::Item({
                       //obscure text
                       Text{"an imprisoned fairy", /*french*/"une f\x96e emprisonn\x96e", /*spanish*/"un hada atrapada"},
                       Text{"an extra life",       /*french*/"une vie de rechange", /*spanish*/"una oportunidad m\x91s"},
                       ...
                       //clear text
                       Text{"a Fairy Bottle", /*french*/"une f\x96e en flacon", /*spanish*/"un hada en una botella"}
    );

    hintTable[BOTTLE_WITH_FISH] = HintText::Item({
                       //obscure text
                       Text{"an aquarium",     /*french*/"un aquarium",               /*spanish*/"un escamado ser"},
                       Text{"a deity's snack", /*french*/"le repas d'un dieu marin", /*spanish*/"un tentempi\x96 de cierta deidad"},
                     }, {
                       //ambiguous text
                       Text{"a bottle", /*french*/"un flacon", /*spanish*/"una botella"},
                     },
    ...
    hintTable[BOTTLE_WITH_BLUE_FIRE] = HintText::Item({
                       //obscure text
                       Text{"a conflagration canteen", /*french*/"une myst\x96rieuse flamme", /*spanish*/"un incendio retenido"},
    ...
    hintTable[BOTTLE_WITH_BUGS] = HintText::Item({
                       ...
                       Text{"Skulltula finders", /*french*/"une poign\x96e de trouve-Skulltula", /*spanish*/"unos rastreadores de skulltulas"},
                     }, {
                       //ambiguous text
                       Text{"a bottle", /*french*/"un flacon", /*spanish*/"una botella"},
                     },
    ...
    hintTable[BOTTLE_WITH_BIG_POE] = HintText::Item({
                       //obscure text
                       Text{"the spookiest ghost", /*french*/"un \x96pouvantable spectre", /*spanish*/"el espectro m\x91s espeluznante"},
                       Text{"a sidequest spirit",  /*french*/"un pr\x96cieux esprit",      /*spanish*/"un buen valorado espíritu"},
                     }, {
                       //ambiguous text
                       Text{"a bottle", /*french*/"un flacon", /*spanish*/"una botella"},
                     },
    ...
    hintTable[RUTOS_LETTER] = HintText::Item({
                       ...
                       Text{"a fishy stationery",   /*french*/"un papier mouill\x96",  /*spanish*/"un mensaje de ayuda"},
                     }, {
                       //ambiguous text
                       Text{"a bottle", /*french*/"un flacon", /*spanish*/"una botella"},
                     },
    ...
    hintTable[ZELDAS_LULLABY] = HintText::Item({
                       ...
                       Text{"a triforce tune",         /*french*/"la musique sacr\x96e", /*spanish*/"la melodía de la trifuerza"},
                     }, {
                       //ambiguous text
    ...
    hintTable[EPONAS_SONG] = HintText::Item({
                       //obscure text
                       Text{"an equestrian etude", /*french*/"une hymne \x96questre",     /*spanish*/"una copla ecuestre"},
                       Text{"Malon's melody",      /*french*/"la m\x96lodie des vaches", /*spanish*/"la sonata de Malon"},
    ...
    hintTable[SARIAS_SONG] = HintText::Item({
                       ...
                       Text{"Saria's phone number",     /*french*/"le t\x96l\x96phone d'une amie", /*spanish*/"una consulta de asistencia"},
                     }, {
                       //ambiguous text
                       Text{"a regular song", /*french*/"une chanson normale", /*spanish*/"una cancion normal"},
                       Text{"something given by Saria", /*french*/"un cadeau de Saria", /*spanish*/"un obsequio de Saria"},
    ...
    hintTable[SUNS_SONG] = HintText::Item({
                       //obscure text
                       Text{"Sunny Day",         /*french*/"Z\x96nith",               /*spanish*/"un día soleado"},
                       Text{"the ReDead's bane", /*french*/"le fl\x96au des Remorts", /*spanish*/"la destructora de Redeads"},
                       Text{"the Gibdo's bane",  /*french*/"le fl\x96au des Gibdo",   /*spanish*/"la destructora de Gibdos"},
                     }, {
                       //ambiguous text
                       Text{"a regular song", /*french*/"une chanson normale", /*spanish*/"una cancion normal"},
                       Text{"something that can stun", /*french*/"une chose qui peut paralyser", /*spanish*/"algo que pueda paralizar"},
    ...
    hintTable[SONG_OF_TIME] = HintText::Item({
                       ...
                       Text{"the tune of ages",    /*french*/"le Chant des \x82ges",  /*spanish*/"la melodía eónica"},
                     }, {
                       //ambiguous text
                       Text{"a regular song", /*french*/"une chanson normale", /*spanish*/"una cancion normal"},
                     },
    ...
    hintTable[SONG_OF_STORMS] = HintText::Item({
                       ...
                       Text{"windmill acceleration", /*french*/"l'acc\x96l\x96rateur de moulins", /*spanish*/"el arranque de molinos"},
                     }, {
                       //ambiguous text
                       Text{"a regular song", /*french*/"une chanson normale", /*spanish*/"una cancion normal"},
                     },
    ...
    hintTable[MINUET_OF_FOREST] = HintText::Item({
                       ...
                       Text{"a green spark trail",    /*french*/"une com\x95te verte",     /*spanish*/"el sendero esmeralda"},
                     }, {
                       //ambiguous text
                       Text{"a warp song", /*french*/"une chanson de t\x96l\x96portation", /*spanish*/"una canción de teletransportación"},
                     },
                       //clear text
    ...
    hintTable[BOLERO_OF_FIRE] = HintText::Item({
                       //obscure text
                       Text{"a song of lethal lava", /*french*/"une musique enflamm\x96e",          /*spanish*/"la canción de la lava"},
                       Text{"a red spark trail",     /*french*/"une com\x95te rouge",      /*spanish*/"el sendero rubí"},
                       Text{"a volcanic verse",      /*french*/"le souffle du volcan", /*spanish*/"el verso volc\x91nico"},
                     }, {
                       //ambiguous text
                       Text{"a warp song", /*french*/"une chanson de t\x96l\x96portation", /*spanish*/"una canción de teletransportación"},
                     },
                       //clear text
                       Text{"the Bolero of Fire", /*french*/"le bol\x96ro du feu", /*spanish*/"el Bolero del fuego"}
    );
    ...
    hintTable[SERENADE_OF_WATER] = HintText::Item({
                       ...
                       Text{"a blue spark trail",     /*french*/"une com\x95te bleue",   /*spanish*/"el sendero zafiro"},
                       ...
                       //clear text
                       Text{"the Serenade of Water", /*french*/"la s\x96r\x96nade de l'eau", /*spanish*/"la Serenata del agua"}
    );

    hintTable[REQUIEM_OF_SPIRIT] = HintText::Item({
                       //obscure text
                       Text{"a song of sandy statues", /*french*/"la m\x96lodie d'une grande statue", /*spanish*/"la canción de la gran estatua"},
                       Text{"an orange spark trail",   /*french*/"une com\x95te orange",               /*spanish*/"el sendero \x91mbar"},
                       Text{"the desert ditty",        /*french*/"le vent du d\x96sert",              /*spanish*/"la estrofa del desierto"},
                     }, {
                       //ambiguous text
                       Text{"a warp song", /*french*/"une chanson de t\x96l\x96portation", /*spanish*/"una canción de teletransportación"},
                     },
                       //clear text
                       Text{"the Requiem of Spirit", /*french*/"le requiem des esprits", /*spanish*/"el R\x96quiem del espíritu"}
    );
    ...
    hintTable[NOCTURNE_OF_SHADOW] = HintText::Item({
                       ...
                       Text{"a purple spark trail",     /*french*/"une com\x95te mauve",            /*spanish*/"el sendero malva"},
                     }, {
                       //ambiguous text
                       Text{"a warp song", /*french*/"une chanson de t\x96l\x96portation", /*spanish*/"una canción de teletransportación"},
                     },
    ...
    hintTable[PRELUDE_OF_LIGHT] = HintText::Item({
                       //obscure text
                       Text{"a luminous prologue melody", /*french*/"une matine illumin\x96e", /*spanish*/"la melodía refulgente"},
                       Text{"a yellow spark trail",       /*french*/"une com\x95te jaune",        /*spanish*/"el sendero resplandeciente"},
                       ...
                       //clear text
                       Text{"the Prelude of Light", /*french*/"le pr\x96lude de la lumi\x95re", /*spanish*/"el Preludio de la luz"}
    );
    hintTable[DEKU_TREE_MAP] = HintText::Item({
                        //obscure text
                        Text{"a mossy atlas", /*french*/"un atlas bois\x96",  /*spanish*/"un atlas musgoso"},
                        Text{"some mossy blueprints",      /*french*/"un plan bois\x96",             /*spanish*/"unos planos musgosos"},
                      }, {
                        //ambiguous text
    ...
    hintTable[JABU_JABUS_BELLY_MAP] = HintText::Item({
                        //obscure text
                        Text{"a fishy atlas", /*french*/"un atlas dig\x96r\x96",  /*spanish*/"un atlas digesto"},
                        Text{"some fishy blueprints",      /*french*/"un plan dig\x96r\x96",             /*spanish*/"unos planos digestos"},
                      }, {
                        //ambiguous text
                        Text{"a dungeon map", /*french*/"une carte", /*spanish*/"un mapa"},
                      },
    ...
    hintTable[DEKU_TREE_COMPASS] = HintText::Item({
                        //obscure text
                        Text{"a mossy treasure tracker", /*french*/"un cherche-tr\x96sor bois\x96",  /*spanish*/"un zahorí musgoso"},
                        Text{"a mossy magnetic needle",      /*french*/"une aimant bois\x96e",             /*spanish*/"un im\x91n musgoso"},
                      }, {
                        //ambiguous text
    ...
    hintTable[DODONGOS_CAVERN_COMPASS] = HintText::Item({
                        //obscure text
                        Text{"a rocky treasure tracker", /*french*/"un cherche-tr\x96sor rocheux",  /*spanish*/"un zahorí rocoso"},
                        Text{"a rocky magnetic needle",      /*french*/"une aimant rocheux",             /*spanish*/"un im\x91n rocoso"},
                      }, {
                        //ambiguous text
                        Text{"a compass", /*french*/"une boussole", /*spanish*/"una brújula"},
                      },
    ...
    hintTable[JABU_JABUS_BELLY_COMPASS] = HintText::Item({
                        //obscure text
                        Text{"a fishy treasure tracker", /*french*/"un cherche-tr\x96sor dig\x96r\x96",  /*spanish*/"un zahorí digesto"},
                        Text{"a fishy magnetic needle",      /*french*/"une aimant dig\x96r\x96",             /*spanish*/"un im\x91n digesto"},
                      }, {
                        //ambiguous text
                        Text{"a compass", /*french*/"une boussole", /*spanish*/"una brújula"},
                      },
    ...
    hintTable[FOREST_TEMPLE_COMPASS] = HintText::Item({
                        //obscure text
                        Text{"a sylvan treasure tracker", /*french*/"un cherche-tr\x96sor sylvestre",  /*spanish*/"un zahorí enselvado"},
                        Text{"a sylvan magnetic needle",      /*french*/"une aimant sylvestre",             /*spanish*/"un im\x91n enselvado"},
                      }, {
                        //ambiguous text
                        Text{"a compass", /*french*/"une boussole", /*spanish*/"una brújula"},
                      },
    ...
    hintTable[FIRE_TEMPLE_COMPASS] = HintText::Item({
                        //obscure text
                        Text{"a molten treasure tracker", /*french*/"un cherche-tr\x96sor fondu",  /*spanish*/"un zahorí fundido"},
                        Text{"a molten magnetic needle",      /*french*/"une aimant fondu",             /*spanish*/"un im\x91n fundido"},
                      }, {
                        //ambiguous text
                        Text{"a compass", /*french*/"une boussole", /*spanish*/"una brújula"},
                      },
    ...
    hintTable[WATER_TEMPLE_COMPASS] = HintText::Item({
                        //obscure text
                        Text{"a wet treasure tracker", /*french*/"un cherche-tr\x96sor humide",  /*spanish*/"un zahorí mojado"},
                        Text{"a wet magnetic needle",      /*french*/"une aimant humide",             /*spanish*/"un im\x91n mojado"},
                      }, {
                        //ambiguous text
                        Text{"a compass", /*french*/"une boussole", /*spanish*/"una brújula"},
                      },
    ...
    hintTable[SPIRIT_TEMPLE_COMPASS] = HintText::Item({
                        //obscure text
                        Text{"a sandy treasure tracker", /*french*/"un cherche-tr\x96sor sableux",  /*spanish*/"un zahorí arenoso"},
                        Text{"a sandy magnetic needle",      /*french*/"une aimant sableux",             /*spanish*/"un im\x91n arenoso"},
                      }, {
                        //ambiguous text
                        Text{"a compass", /*french*/"une boussole", /*spanish*/"una brújula"},
                      },
    ...
    hintTable[SHADOW_TEMPLE_COMPASS] = HintText::Item({
                        //obscure text
                        Text{"a creepy treasure tracker", /*french*/"un cherche-tr\x96sor sinistre",  /*spanish*/"un zahorí siniestra"},
                        Text{"a creepy magnetic needle",      /*french*/"une aimant sinistre",             /*spanish*/"un im\x91n siniestra"},
                      }, {
                        //ambiguous text
                        Text{"a compass", /*french*/"une boussole", /*spanish*/"una brújula"},
                      },
    ...
    hintTable[BOTTOM_OF_THE_WELL_COMPASS] = HintText::Item({
                        //obscure text
                        Text{"a dank treasure tracker", /*french*/"un cherche-tr\x96sor moisi",  /*spanish*/"un zahorí mohoso"},
                        Text{"a dank magnetic needle",      /*french*/"une aimant moisi",             /*spanish*/"un im\x91n mohoso"},
                      }, {
                        //ambiguous text
                        Text{"a compass", /*french*/"une boussole", /*spanish*/"una brújula"},
                      },
    ...
    hintTable[ICE_CAVERN_COMPASS] = HintText::Item({
                        //obscure text
                        Text{"a polar treasure tracker", /*french*/"un cherche-tr\x96sor polaire",  /*spanish*/"un zahorí polar"},
                        Text{"a polar magnetic needle",      /*french*/"une aimant polaire",             /*spanish*/"un im\x91n polar"},
                      }, {
                        //ambiguous text
                        Text{"a compass", /*french*/"une boussole", /*spanish*/"una brújula"},
                      },
    ...
    hintTable[FOREST_TEMPLE_BOSS_KEY] = HintText::Item({
                        ...
                        Text{"a sylvan dungeon's master pass",      /*french*/"une cl\x96 mal\x96fique sylvestree",             /*spanish*/"el pase maestro enselvado"},
                      }, {
                        //ambiguous text
                        Text{"a boss key", /*french*/"une cl\x96 d'or", /*spanish*/"una gran llave"},
                      },
                        //clear text
                        Text{"the Forest Temple Boss Key", /*french*/"la cl\x96 d'or du temple de la forêt", /*spanish*/"la gran llave del Templo del Bosque"}
     );
    hintTable[FIRE_TEMPLE_BOSS_KEY] = HintText::Item({
                        ...
                        Text{"a molten dungeon's master pass",      /*french*/"une cl\x96 mal\x96fique fondu",             /*spanish*/"el pase maestro fundido"},
                      }, {
                        //ambiguous text
                        Text{"a boss key", /*french*/"une cl\x96 d'or", /*spanish*/"una gran llave"},
                      },
                        //clear text
                        Text{"the Fire Temple Boss Key", /*french*/"la cl\x96 d'or du temple du feu", /*spanish*/"la gran llave del Templo del Fuego"}
     );
    hintTable[WATER_TEMPLE_BOSS_KEY] = HintText::Item({
                        ...
                        Text{"a wet dungeon's master pass",      /*french*/"une cl\x96 mal\x96fique humide",             /*spanish*/"el pase maestro mojado"},
                      }, {
                        //ambiguous text
                        Text{"a boss key", /*french*/"une cl\x96 d'or", /*spanish*/"una gran llave"},
                      },
                        //clear text
                        Text{"the Water Temple Boss Key", /*french*/"la cl\x96 d'or du temple de l'eau", /*spanish*/"la gran llave del Templo del Agua"}
     );
    hintTable[SPIRIT_TEMPLE_BOSS_KEY] = HintText::Item({
                        ...
                        Text{"a sandy dungeon's master pass",      /*french*/"une cl\x96 mal\x96fique sableux",             /*spanish*/"el pase maestro arenoso"},
                      }, {
                        //ambiguous text
                        Text{"a boss key", /*french*/"une cl\x96 d'or", /*spanish*/"una gran llave"},
                      },
                        //clear text
                        Text{"the Spirit Temple Boss Key", /*french*/"la cl\x96 d'or du temple de l'esprit", /*spanish*/"la gran llave del Templo del Espíritu"}
     );
    hintTable[SHADOW_TEMPLE_BOSS_KEY] = HintText::Item({
                        ...
                        Text{"a creepy dungeon's master pass",      /*french*/"une cl\x96 mal\x96fique sinistre",             /*spanish*/"el pase maestro siniestra"},
                      }, {
                        //ambiguous text
                        Text{"a boss key", /*french*/"une cl\x96 d'or", /*spanish*/"una gran llave"},
                      },
                        //clear text
                        Text{"the Shadow Temple Boss Key", /*french*/"la cl\x96 d'or du temple de l'ombre", /*spanish*/"la gran llave del Templo de las Sombras"}
     );
    hintTable[GANONS_CASTLE_BOSS_KEY] = HintText::Item({
                        ...
                        Text{"a final dungeon's master pass",      /*french*/"une cl\x96 mal\x96fique final",             /*spanish*/"el pase maestro final"},
                      }, {
                        //ambiguous text
                        Text{"a boss key", /*french*/"une cl\x96 d'or", /*spanish*/"una gran llave"},
                      },
                        //clear text
                        Text{"the Ganon's Castle Boss Key", /*french*/"la cl\x96 d'or du ch\x92teau de Ganon", /*spanish*/"la gran llave del Castillo de Ganon"}
     );
    hintTable[FOREST_TEMPLE_SMALL_KEY] = HintText::Item({
                        ...
                        Text{"a sylvan lockpick",           /*french*/"un crochet \x90 porte sylvestre",       /*spanish*/"una apertura portentosa enselvada"},
                      }, {
                        //ambiguous text
                        Text{"a small key", /*french*/"une petite cl\x96", /*spanish*/"una llave pequeña"},
                      },
                        //clear text
                        Text{"a Forest Temple Small Key", /*french*/"une petite cl\x96 du temple de la forêt", /*spanish*/"una llave pequeña del Templo del Bosque"}
     );
    hintTable[FIRE_TEMPLE_SMALL_KEY] = HintText::Item({
                        ...
                        Text{"a molten lockpick",           /*french*/"un crochet \x90 porte fondu",       /*spanish*/"una apertura portentosa fundida"},
                      }, {
                        //ambiguous text
                        Text{"a small key", /*french*/"une petite cl\x96", /*spanish*/"una llave pequeña"},
                      },
                        //clear text
                        Text{"a Fire Temple Small Key", /*french*/"une petite cl\x96 du temple du feu", /*spanish*/"una llave pequeña del Templo del Fuego"}
     );
    hintTable[WATER_TEMPLE_SMALL_KEY] = HintText::Item({
                        ...
                        Text{"a wet lockpick",           /*french*/"un crochet \x90 porte humide",       /*spanish*/"una apertura portentosa mojada"},
                      }, {
                        //ambiguous text
                        Text{"a small key", /*french*/"une petite cl\x96", /*spanish*/"una llave pequeña"},
                      },
                        //clear text
                        Text{"a Water Temple Small Key", /*french*/"une petite cl\x96 du temple de l'eau", /*spanish*/"una llave pequeña del Templo del Agua"}
     );
    hintTable[SPIRIT_TEMPLE_SMALL_KEY] = HintText::Item({
                        ...
                        Text{"a sandy lockpick",           /*french*/"un crochet \x90 porte sableux",       /*spanish*/"una apertura portentosa arenosa"},
                      }, {
                        //ambiguous text
                        Text{"a small key", /*french*/"une petite cl\x96", /*spanish*/"una llave pequeña"},
                      },
                        //clear text
                        Text{"a Spirit Temple Small Key", /*french*/"une petite cl\x96 du temple de l'esprit", /*spanish*/"una llave pequeña del Templo del Espíritu"}
     );
    hintTable[SHADOW_TEMPLE_SMALL_KEY] = HintText::Item({
                        ...
                        Text{"a creepy lockpick",           /*french*/"un crochet \x90 porte sinistre",       /*spanish*/"una apertura portentosa siniestra:a"},
                      }, {
                        //ambiguous text
                        Text{"a small key", /*french*/"une petite cl\x96", /*spanish*/"una llave pequeña"},
                      },
                        //clear text
                        Text{"a Shadow Temple Small Key", /*french*/"une petite cl\x96 du temple de l'ombre", /*spanish*/"una llave pequeña del Templo de las Sombras"}
     );
    hintTable[GERUDO_TRAINING_GROUNDS_SMALL_KEY] = HintText::Item({
                        ...
                        Text{"a labyrinthian lockpick",           /*french*/"un crochet \x90 porte labyrinthique",       /*spanish*/"una apertura portentosa laberíntica"},
                      }, {
                        //ambiguous text
                        Text{"a small key", /*french*/"une petite cl\x96", /*spanish*/"una llave pequeña"},
                      },
                        //clear text
                        Text{"a Gerudo Training Ground Small Key", /*french*/"une petite cl\x96 du gymnase Gerudo", /*spanish*/"una llave pequeña del Centro de Instrucción Gerudo"}
     );
    hintTable[GERUDO_FORTRESS_SMALL_KEY] = HintText::Item({
                        //obscure text
                        Text{"an imprisoned tool for unlocking", /*french*/"un anti-porte emprisonn\x96",            /*spanish*/"una clave de una entrada encarcelada"},
                        Text{"an imprisoned dungeon pass",       /*french*/"le rêve emprisonn\x96 d'un prisonnier",  /*spanish*/"un pase de una mazmorra encarcelada"},
                        Text{"an imprisoned lock remover",       /*french*/"un efface-serrure emprisonn\x96",        /*spanish*/"un destructor de cerraduras encarcelada"},
                        Text{"an imprisoned lockpick",           /*french*/"un crochet \x90 porte emprisonn\x96",       /*spanish*/"una apertura portentosa encarcelada"},
                      }, {
                        //ambiguous text
                        Text{"a small key", /*french*/"une petite cl\x96", /*spanish*/"una llave pequeña"},
                      },
                        //clear text
                        Text{"a Gerudo Fortress Small Key", /*french*/"une petite cl\x96 de la forteresse Gerudo", /*spanish*/"una llave pequeña de la Fortaleza Gerudo"}
     );
    hintTable[BOTTOM_OF_THE_WELL_SMALL_KEY] = HintText::Item({
                        ...
                        Text{"a moldy lockpick",           /*french*/"un crochet \x90 porte moisi",       /*spanish*/"una apertura portentosa mohosa"},
                      }, {
                        //ambiguous text
                        Text{"a small key", /*french*/"une petite cl\x96", /*spanish*/"una llave pequeña"},
                      },
                        //clear text
                        Text{"a Bottom of the Well Small Key", /*french*/"une petite cl\x96 du fond du puits", /*spanish*/"una llave pequeña del Fondo del pozo"}
     );
    hintTable[GANONS_CASTLE_SMALL_KEY] = HintText::Item({
                        ...
                        Text{"a final lockpick",           /*french*/"un crochet \x90 porte final",       /*spanish*/"una apertura portentosa final"},
                      }, {
                        //ambiguous text
                        Text{"a small key", /*french*/"une petite cl\x96", /*spanish*/"una llave pequeña"},
                      },
                        //clear text
                        Text{"a Ganon's Castle Small Key", /*french*/"une petite cl\x96 du ch\x92teau de Ganon", /*spanish*/"una llave pequeña del Castillo de Ganon"}
     );
     hintTable[FOREST_TEMPLE_KEY_RING] = HintText::Item({
                        ...
                        Text{"a sylvan skeleton key",          /*french*/"des crochets \x90 porte sylvestres",       /*spanish*/"un anillo silvestre contra cerrojos"},
                      }, {
                        //ambiguous text
                        Text{"a key ring", /*french*/"un trousseau de cl\x96s", /*spanish*/"un llavero"},
                      },
                        //clear text
                        Text{"a Forest Temple Key Ring", /*french*/"un trousseau de cl\x96s du temple de la forêt", /*spanish*/"un llavero del Templo del Bosque"}
     );
    hintTable[FIRE_TEMPLE_KEY_RING] = HintText::Item({
                        ...
                        Text{"a molten skeleton key",          /*french*/"des crochets \x90 porte fondus",       /*spanish*/"un anillo fundido contra cerrojos"},
                      }, {
                        //ambiguous text
                        Text{"a key ring", /*french*/"un trousseau de cl\x96s", /*spanish*/"un llavero"},
                      },
                        //clear text
                        Text{"a Fire Temple Key Ring", /*french*/"un trousseau de cl\x96s du temple du feu", /*spanish*/"un llavero del Templo del Fuego"}
     );
    hintTable[WATER_TEMPLE_KEY_RING] = HintText::Item({
                        ...
                        Text{"a wet skeleton key",          /*french*/"des crochets \x90 porte humides",       /*spanish*/"un anillo abisal contra cerrojos"},
                      }, {
                        //ambiguous text
                        Text{"a key ring", /*french*/"un trousseau de cl\x96s", /*spanish*/"un llavero"},
                      },
                        //clear text
                        Text{"a Water Temple Key Ring", /*french*/"un trousseau de cl\x96s du temple de l'eau", /*spanish*/"un llavero del Templo del Agua"}
     );
    hintTable[SPIRIT_TEMPLE_KEY_RING] = HintText::Item({
                        ...
                        Text{"a sandy skeleton key",          /*french*/"des crochets \x90 porte sableux",       /*spanish*/"un anillo arenoso contra cerrojos"},
                      }, {
                        //ambiguous text
                        Text{"a key ring", /*french*/"un trousseau de cl\x96s", /*spanish*/"un llavero"},
                      },
                        //clear text
                        Text{"a Spirit Temple Key Ring", /*french*/"un trousseau de cl\x96s du temple de l'esprit", /*spanish*/"un llavero del Templo del Espíritu"}
     );
    hintTable[SHADOW_TEMPLE_KEY_RING] = HintText::Item({
                        ...
                        Text{"a creepy skeleton key",          /*french*/"des crochets \x90 porte sinistres",       /*spanish*/"un anillo tenebroso contra cerrojos"},
                      }, {
                        //ambiguous text
                        Text{"a key ring", /*french*/"un trousseau de cl\x96s", /*spanish*/"un llavero"},
                      },
                        //clear text
                        Text{"a Shadow Temple Key Ring", /*french*/"un trousseau de cl\x96s du temple de l'ombre", /*spanish*/"un llavero del Templo de las Sombras"}
     );
    hintTable[GERUDO_TRAINING_GROUNDS_KEY_RING] = HintText::Item({
                        ...
                        Text{"a labyrinthian skeleton key",          /*french*/"des crochets \x90 porte labyrinthiques",       /*spanish*/"un anillo laberíntico contra cerrojos"},
                      }, {
                        //ambiguous text
                        Text{"a key ring", /*french*/"un trousseau de cl\x96s", /*spanish*/"un llavero"},
                      },
                        //clear text
                        Text{"a Gerudo Training Ground Key Ring", /*french*/"un trousseau de cl\x96s du gymnase Gerudo", /*spanish*/"un llavero del Centro de Instrucción Gerudo"}
     );
    hintTable[GERUDO_FORTRESS_KEY_RING] = HintText::Item({
                        //obscure text
                        Text{"an imprisoned toolbox for unlocking", /*french*/"des anti-portes emprisonn\x96s",            /*spanish*/"un conjunto enjaulado de cerrajero"},
                        Text{"an imprisoned dungeon season pass",   /*french*/"les rêves emprisonn\x96s d'un prisonnier",  /*spanish*/"un pase vip de una mazmorra enjaulado"},
                        Text{"an imprisoned jingling ring",         /*french*/"des efface-serrures emprisonn\x96s",        /*spanish*/"una cadena multiusos enjaulada"},
                        Text{"an imprisoned skeleton key",          /*french*/"des crochets \x90 porte emprisonn\x96s",       /*spanish*/"un anillo enjaulado contra cerrojos"},
                      }, {
                        //ambiguous text
                        Text{"a key ring", /*french*/"un trousseau de cl\x96s", /*spanish*/"un llavero"},
                      },
                        //clear text
                        Text{"a Gerudo Fortress Key Ring", /*french*/"un trousseau de cl\x96s de la forteresse Gerudo", /*spanish*/"un llavero de la Fortaleza Gerudo"}
     );
    hintTable[BOTTOM_OF_THE_WELL_KEY_RING] = HintText::Item({
                        //obscure text
                        Text{"a moldy toolbox for unlocking", /*french*/"des anti-portes moisis",            /*spanish*/"un conjunto subterr\x91neo de cerrajero"},
                        Text{"a moldy dungeon season pass",   /*french*/"les rêves moisis d'un prisonnier",  /*spanish*/"un pase vip de una mazmorra subterr\x91neo"},
                        Text{"a moldy jingling ring",         /*french*/"des efface-serrures moisis",        /*spanish*/"una cadena multiusos subterr\x91nea"},
                        Text{"a moldy skeleton key",          /*french*/"des crochets \x90 porte moisis",       /*spanish*/"un anillo subterr\x91neo contra cerrojos"},
                      }, {
                        //ambiguous text
                        Text{"a key ring", /*french*/"un trousseau de cl\x96s", /*spanish*/"un llavero"},
                      },
                        //clear text
                        Text{"a Bottom of the Well Key Ring", /*french*/"un trousseau de cl\x96s du fond du puits", /*spanish*/"un llavero del Fondo del pozo"}
     );
    hintTable[GANONS_CASTLE_KEY_RING] = HintText::Item({
                        ...
                        Text{"a final skeleton key",          /*french*/"des crochets \x90 porte finaux",       /*spanish*/"un anillo decisivo multiusos"},
                      }, {
                        //ambiguous text
                        Text{"a key ring", /*french*/"un trousseau de cl\x96s", /*spanish*/"un llavero"},
                      },
                        //clear text
                        Text{"a Ganon's Castle Key Ring", /*french*/"un trousseau de cl\x96s du ch\x92teau de Ganon", /*spanish*/"un llavero del Castillo de Ganon"}
     );
    ...
    hintTable[TREASURE_GAME_SMALL_KEY] = HintText::Item({
                        ...
                        Text{"a gambler's lockpick",           /*french*/"un crochet \x90 serrure de parieur", /*spanish*/"una apertura portentosa del juego de azar"},
                      }, {
                        //ambiguous text
                        Text{"a small key", /*french*/"une petite cl\x96", /*spanish*/"una llave pequeña"},
                      },
                        //clear text
                        Text{"a Treasure Chest Shop Small Key", /*french*/"une petite cl\x96 de la chasse aux tr\x96sors", /*spanish*/"una llave pequeña del Cofre del Tesoro"}
    );
    ...
    hintTable[KOKIRI_EMERALD] = HintText::Item({
                       ...
                       //clear text
                       Text{"the Kokiri Emerald", /*french*/"l'\x96meraude Kokiri", /*spanish*/"la Esmeralda de los Kokiri"}
    );

    hintTable[GORON_RUBY] = HintText::Item({
                       //obscure text
                       Text{"a red stone",       /*french*/"une pierre rouge",         /*spanish*/"una piedra carmín"},
                       Text{"sworn brotherhood", /*french*/"un serment de fraternit\x96", /*spanish*/"el juramento de hermanos de sangre"},
                     }, {
                       //ambiguous text
                       Text{"a spiritual stone", /*french*/"une pierre spirituelle", /*spanish*/"una piedra espiritual"},
                     },
    ...
    hintTable[FOREST_MEDALLION] = HintText::Item({
                       //obscure text
                       Text{"a green coin",       /*french*/"une pi\x95ce verte",    /*spanish*/"una moneda esmeralda"},
                       Text{"Saria's friendship", /*french*/"l'amiti\x96 de Saria", /*spanish*/"la amistad de Saria"},
                     }, {
                       //ambiguous text
                       Text{"a medallion", /*french*/"un m\x96daillon", /*spanish*/"un medallón"},
                     },
                       //clear text
                       Text{"the Forest Medallion", /*french*/"le m\x96daillon de la forêt", /*spanish*/"el Medallón del Bosque"}
    );

    hintTable[FIRE_MEDALLION] = HintText::Item({
                       //obscure text
                       Text{"a red coin",      /*french*/"une pi\x95ce rouge",           /*spanish*/"una moneda rubí"},
                       Text{"Darunia's power", /*french*/"la fraternit\x96 de Darunia", /*spanish*/"la fraternidad de Darunia"},
                     }, {
                       //ambiguous text
                       Text{"a medallion", /*french*/"un m\x96daillon", /*spanish*/"un medallón"},
                     },
                       //clear text
                       Text{"the Fire Medallion", /*french*/"le m\x96daillon du feu", /*spanish*/"el Medallón del Fuego"}
    );

    hintTable[WATER_MEDALLION] = HintText::Item({
                       //obscure text
                       Text{"a blue coin",  /*french*/"une pi\x95ce bleue",  /*spanish*/"una moneda zafiro"},
                       ...
                       //clear text
                       Text{"the Water Medallion", /*french*/"le m\x96daillon de l'eau", /*spanish*/"el Medallón del Agua"}
    );

    hintTable[SPIRIT_MEDALLION] = HintText::Item({
                       //obscure text
                       Text{"an orange coin",  /*french*/"une pi\x95ce orange",       /*spanish*/"una moneda \x91mbar"},
                       ...
                       //clear text
                       Text{"the Spirit Medallion", /*french*/"le m\x96daillon de l'esprit", /*spanish*/"el Medallón del Espíritu"}
    );

    hintTable[SHADOW_MEDALLION] = HintText::Item({
                       //obscure text
                       Text{"a purple coin", /*french*/"une pi\x95ce pourpre",    /*spanish*/"una moneda malva"},
                       ...
                       //clear text
                       Text{"the Shadow Medallion", /*french*/"le m\x96daillon de l'ombre", /*spanish*/"el Medallón de la Sombra"}
    );

    hintTable[LIGHT_MEDALLION] = HintText::Item({
                       //obscure text
                       Text{"a yellow coin", /*french*/"une pi\x95ce jaune",  /*spanish*/"una moneda resplandeciente"},
                       ...
                       //clear text
                       Text{"the Light Medallion", /*french*/"le m\x96daillon de la lumi\x95re", /*spanish*/"el Medallón de la Luz"}
    );

    hintTable[RECOVERY_HEART] = HintText::Item({
                       //obscure text
                       Text{"a free heal",   /*french*/"un bec-au-bobo", /*spanish*/"una cura de regalo"},
                       Text{"a hearty meal", /*french*/"un petit amour",   /*spanish*/"una sanación rom\x91ntica"},
    ...
    hintTable[GREEN_RUPEE] = HintText::Item({
                       //obscure text
                       Text{"a unique coin", /*french*/"un rubis bien m\x96rit\x96", /*spanish*/"una singular moneda"},
                       Text{"a penny",       /*french*/"un sou",               /*spanish*/"un peso hyliano"},
                       Text{"a green gem",   /*french*/"un joyau vert",        /*spanish*/"una gema verde"},
                     }, {
                       //ambiguous text
                       Text{"some rupees", /*french*/"une quantit\x96 de rubis", /*spanish*/"una cantidad de rupias"},
                     },
                       //clear text
    ...
    hintTable[HUGE_RUPEE] = HintText::Item({
                       ...
                       Text{"a yellow gem",    /*french*/"un joyau dor\x96",         /*spanish*/"una gema amarilla"},
                       Text{"a giant gem",     /*french*/"un gros joyau",         /*spanish*/"una gema descomunal"},
                       Text{"great wealth",    /*french*/"l'aisance financi\x95re", /*spanish*/"dinero a caudales"},
                     }, {
                       //ambiguous text
                       Text{"some rupees", /*french*/"une quantit\x96 de rubis", /*spanish*/"una cantidad de rupias"},
                     },
                       //clear text
                       Text{"a Huge Rupee", /*french*/"un \x96norme rubis", /*spanish*/"una rupia gigante"}
    );

    hintTable[PIECE_OF_HEART] = HintText::Item({
                       //obscure text
                       Text{"a little love",  /*french*/"un peu plus d'amour", /*spanish*/"un cuarto de amor"},
                       Text{"a broken heart", /*french*/"un cœur bris\x96",       /*spanish*/"un corazón roto"},
                     }, {
                       //ambiguous text
                       Text{"something heart-shaped", /*french*/"une chose en forme de cœur", /*spanish*/"algo con forma de corazón"},
                     },
    ...
    hintTable[HEART_CONTAINER] = HintText::Item({
                       ...
                       //clear text
                       Text{"a Heart Container", /*french*/"un cœur d'\x96nergie", /*spanish*/"un contenedor de corazón"}
    );

    hintTable[ICE_TRAP] = HintText::Item({
                       //obscure text
                       Text{"a gift from Ganon",    /*french*/"un cadeau de Ganon",         /*spanish*/"un regalo de Ganon"},
                       Text{"a chilling discovery", /*french*/"une frissonante d\x96couverte", /*spanish*/"un escalofriante hallazgo"},
                       Text{"frosty fun",           /*french*/"une engelure",               /*spanish*/"una g\x96lida diversión"},
                     }, {
                       //ambiguous text
                       Text{"a Great Fairy's power", /*french*/"le pouvoir d'une grande f\x96e", /*spanish*/"el poder de una Gran Hada"},
                       Text{"a magic arrow", /*french*/"une fl\x95che magique", /*spanish*/"una flecha m\x91gica"},
                       ...
                       //clear text
                       Text{"an Ice Trap", /*french*/"un pi\x95ge de glace", /*spanish*/"una trampa de hielo"}
    );
  ...
  //MILK
    ...
    hintTable[BOMBS_5] = HintText::Item({
                       //obscure text
                       Text{"a few explosives",  /*french*/"une poign\x96e de p\x96tards",       /*spanish*/"un par de explosivos"},
                       Text{"a few blast balls", /*french*/"une poign\x96e de boules bleues", /*spanish*/"un par de estallidos"},
                     }, {
                       //ambiguous text
                       Text{"explosives", /*french*/"un paquet d'explosifs", /*spanish*/"un montón de explosivos"},
                     },
    ...
    hintTable[BOMBS_10] = HintText::Item({
                       //obscure text
                       Text{"some explosives",  /*french*/"un paquet de p\x96tards",       /*spanish*/"unos cuantos explosivos"},
    ...
    hintTable[BOMBS_20] = HintText::Item({
                       //obscure text
                       Text{"lots-o-explosives",     /*french*/"une abondance de p\x96tards",       /*spanish*/"un puñado de explosivos"},
    ...
    hintTable[BOMBCHU_5] = HintText::Item({
                       //obscure text
                       Text{"a few mice bombs",     /*french*/"une poign\x96e de mignons explosifs", /*spanish*/"un par de bombas roedoras"},
                       Text{"a few proximity mice", /*french*/"une poign\x96e de jouets \x90 remonter", /*spanish*/"un par de explosivos ratoncitos"},
                       Text{"a few wall crawlers",  /*french*/"une poign\x96e de rapides grimpeurs", /*spanish*/"un par de trepaparedes"},
                       Text{"a few trail blazers",  /*french*/"une poign\x96e de zigzags \x96clatants", /*spanish*/"un par de ratas propulsadas"},
                     }, {
                       //ambiguous text
                       Text{"a prize of the House of Skulltulas", /*french*/"un prix de la maison des Skulltulas", /*spanish*/"un obsequio de la Casa Skulltula"},
                       Text{"explosives", /*french*/"un paquet d'explosifs", /*spanish*/"un montón de explosivos"},
    ...
    hintTable[BOMBCHU_10] = HintText::Item({
                       ...
                       Text{"some proximity mice", /*french*/"un paquet de jouets \x90 remonter", /*spanish*/"unos cuantos explosivos ratoncitos"},
                       Text{"some wall crawlers",  /*french*/"un paquet de rapides grimpeurs", /*spanish*/"unos cuantos trepaparedes"},
                       Text{"some trail blazers",  /*french*/"un paquet de zigzags \x96clatants", /*spanish*/"unas cuantas ratas propulsadas"},
                     }, {
                       //ambiguous text
                       Text{"a prize of the House of Skulltulas", /*french*/"un prix de la maison des Skulltulas", /*spanish*/"un obsequio de la Casa Skulltula"},
                       Text{"explosives", /*french*/"un paquet d'explosifs", /*spanish*/"un montón de explosivos"},
    ...
    hintTable[BOMBCHU_20] = HintText::Item({
                       ...
                       Text{"plenty of proximity mice", /*french*/"une abondance de jouets \x90 remonter", /*spanish*/"bastantes explosivos ratoncitos"},
                       Text{"plenty of wall crawlers",  /*french*/"une abondance de rapides grimpeurs", /*spanish*/"bastantes trepaparedes"},
                       Text{"plenty of trail blazers",  /*french*/"une abondance de zigzags \x96clatants", /*spanish*/"bastantes ratas propulsadas"},
                     }, {
                       //ambiguous text
                       Text{"a prize of the House of Skulltulas", /*french*/"un prix de la maison des Skulltulas", /*spanish*/"un obsequio de la Casa Skulltula"},
                       Text{"explosives", /*french*/"un paquet d'explosifs", /*spanish*/"un montón de explosivos"},
  ...
  //BOMBCHU_DROP
    ...
    hintTable[ARROWS_5] = HintText::Item({
                       //obscure text
                       Text{"a few danger darts", /*french*/"une poign\x96e d'obus",    /*spanish*/"un par de peligrosos dardos"},
                       Text{"a few sharp shafts", /*french*/"une poign\x96e de piquets", /*spanish*/"un par de puntas afiladas"},
                     }, {
                       //ambiguous text
                       Text{"a projectile", /*french*/"un projectile", /*spanish*/"un proyectil"},
                     },
                       //clear text
                       Text{"Arrows (5 pieces)", /*french*/"une demi-dizaine de fl\x95ches", /*spanish*/"unas (5) flechas"}
    );
    ...
    hintTable[ARROWS_10] = HintText::Item({
                       ...
                       //clear text
                       Text{"Arrows (10 pieces)", /*french*/"une dizaine de fl\x95ches", /*spanish*/"unas (10) flechas"}
    );
    ...
    hintTable[ARROWS_30] = HintText::Item({
                       ...
                       //clear text
                       Text{"Arrows (30 pieces)", /*french*/"une trentaine de fl\x95ches", /*spanish*/"unas (30) flechas"}
    );

    hintTable[DEKU_NUTS_5] = HintText::Item({
                       //obscure text
                       Text{"some nuts",       /*french*/"une poign\x96e de noisettes",     /*spanish*/"un par de nueces"},
                       Text{"some flashbangs", /*french*/"une poign\x96e d'\x96clats",        /*spanish*/"un par de semillas aturdidoras"},
                       Text{"some scrub spit", /*french*/"une poign\x96e de crachats Mojo", /*spanish*/"un par de escupitajos deku"},
                     }, {
                       //ambiguous text
                       Text{"some Deku munitions", /*french*/"un paquet de munitions Mojo", /*spanish*/"un montón de municiones Deku"},
                       Text{"something that can stun", /*french*/"une chose qui peut paralyser", /*spanish*/"algo que pueda paralizar"},
    ...
    hintTable[DEKU_NUTS_10] = HintText::Item({
                       ...
                       Text{"plenty of flashbangs", /*french*/"un paquet d'\x96clats",         /*spanish*/"unas cuantas semillas aturdidoras"},
    ...
    hintTable[DEKU_SEEDS_30] = HintText::Item({
                       //obscure text
                       Text{"catapult ammo", /*french*/"un paquet de d\x96licieuses munitions", /*spanish*/"un par de munición infantil"},
                       Text{"lots-o-seeds",  /*french*/"un paquet de germes s\x96ch\x96s",   /*spanish*/"un puñado de semillas"},
                     }, {
                       //ambiguous text
                       Text{"a projectile", /*french*/"un projectile", /*spanish*/"un proyectil"},
                       Text{"some Deku munitions", /*french*/"un paquet de munitions Mojo", /*spanish*/"un montón de municiones Deku"},
    ...
    hintTable[DEKU_STICK_1] = HintText::Item({
                       //obscure text
                       Text{"a breakable branch", /*french*/"un bout de bois", /*spanish*/"un pequeño b\x91culo"},
                     }, {
                       //ambiguous text
                       Text{"some Deku munitions", /*french*/"un paquet de munitions Mojo", /*spanish*/"un montón de municiones Deku"},
                     },
                       //clear text
                       Text{"a Deku Stick", /*french*/"un b\x92ton Mojo", /*spanish*/"un palo deku"}
    );
    ...
    hintTable[TREASURE_GAME_GREEN_RUPEE] = HintText::Item({
                       //obscure text
                       Text{"the dollar of defeat", /*french*/"le rubis de la d\x96faite", /*spanish*/"el peso de la derrota"},
                     }, {
                       //ambiguous text
                       Text{"some rupees", /*french*/"une quantit\x96 de rubis", /*spanish*/"una cantidad de rupias"},
                     },
    ...
    hintTable[EPONA] = HintText::Item({
                       //obscure text
                       Text{"a horse",              /*french*/"un fid\x95le destrier", /*spanish*/"una yegua"},
                       ...
                       Text{"a song sung by frogs", /*french*/"une chanson aim\x96e des grenouilles", /*spanish*/"una melodía de ranas"},
                       Text{"something to cross a broken bridge", /*french*/"une chose pour traverser un pont bris\x96", /*spanish*/"algo para cruzar un puente roto"},
                     },
                       //clear text
    ...
    //                      //obscure text
    //                      Text{"something mysterious", /*french*/"un sacr\x96 myst\x95re", /*spanish*/"algo misterioso"},
    //                      Text{"an unknown treasure",  /*french*/"un tr\x96sor inconnu", /*spanish*/"un desconocido tesoro"},
    //                    },
    //                      //clear text
    ...
    hintTable[ZR_FROGS_OCARINA_GAME] = HintText::Always({
                       ...
                       //clear text
                       Text{"the final reward from the #Frogs of Zora's River# is", /*french*/"la derni\x95re r\x96compense des #grenouilles du fleuve zora# est", /*spanish*/"la recompensa final de las #ranas del Río Zora# premia"}
  );

    hintTable[KF_LINKS_HOUSE_COW] = HintText::Always({
                       //obscure text
                       Text{"the #bovine bounty of a horseback hustle# gifts", /*french*/"le cadeau #qui d\x96coule d'une r\x96ussite \x96questre# est", /*spanish*/"la #recompensa bovina de un paseo a caballo# brinda"},
                     }, {},
                       //clear text
                       Text{"#Malon's obstacle course# leads to", /*french*/"la #course \x90 obstacle de Malon# am\x95ne \x90", /*spanish*/"la #carrera de obst\x91culos de Malon# brinda"}
  );
    ...
    hintTable[SONG_FROM_OCARINA_OF_TIME] = HintText::Sometimes({
                       //obscure text
                       Text{"the #Ocarina of Time# teaches", /*french*/"l'#ocarina du temps# est accompagn\x96 par", /*spanish*/"la #Ocarina del Tiempo# enseña"},
  });

    hintTable[SONG_FROM_COMPOSERS_GRAVE] = HintText::Sometimes({
                       //obscure text
                       Text{"#ReDead in the Composers' Grave# guard", /*french*/"les #Remorts du tombeau des compositeurs# prot\x95gent", /*spanish*/"los #ReDeads del Panteón Real# guardan"},
                       Text{"the #Composer Brothers wrote#",          /*french*/"le #tr\x96sor des compositeurs# est",                    /*spanish*/"los #hermanos compositores escribieron#"},
  });

    hintTable[SHEIK_IN_FOREST] = HintText::Sometimes({
                       //obscure text
                       Text{"#in a meadow# Sheik teaches", /*french*/"Sheik confiera, #dans une clairi\x95re#,", /*spanish*/"#en la pradera sagrada# Sheik enseña"},
  });

    hintTable[SHEIK_AT_TEMPLE] = HintText::Sometimes({
                       //obscure text
                       Text{"Sheik waits at a #monument to time# to teach", /*french*/"Sheik confiera, #au pied de l'\x96p\x96e l\x96gendaire#,", /*spanish*/"Sheik espera en el #momumento del tiempo# para enseñar"},
  });

    hintTable[SHEIK_IN_CRATER] = HintText::Sometimes({
                       //obscure text
                       Text{"the #crater's melody# is", /*french*/"Sheik confiera, #entour\x96 de lave#,", /*spanish*/"la #melodía del cr\x91ter# otorga"},
  });

    hintTable[SHEIK_IN_ICE_CAVERN] = HintText::Sometimes({
                       //obscure text
                       Text{"the #frozen cavern# echoes with", /*french*/"Sheik confiera, #dans une caverne \x96toil\x96e#,", /*spanish*/"en la #caverna de hielo# retumban los ecos de"},
  });

    hintTable[SHEIK_IN_KAKARIKO] = HintText::Sometimes({
                       //obscure text
                       Text{"a #ravaged village# mourns with", /*french*/"Sheik confirera, #au cœur d'un village ravag\x96#,", /*spanish*/"un #arrasado pueblo# llora"},
  });

    hintTable[SHEIK_AT_COLOSSUS] = HintText::Sometimes({
                       //obscure text
                       Text{"a hero ventures #beyond the wasteland# to learn", /*french*/"Sheik confiera, #au bout d'un chemin sableux#,", /*spanish*/"el h\x96roe que se adentre #m\x91s all\x91 del desierto# aprender\x91"},
  });


    hintTable[MARKET_10_BIG_POES] = HintText::Sometimes({
                       //obscure text
                       Text{"#ghost hunters# will be rewarded with", /*french*/"#les chasseurs de fantômes# sont r\x96compens\x96s avec", /*spanish*/"los #cazafantasmas# son premiados con"},
                     }, {},
                       //clear text
    ...
    hintTable[DEKU_THEATER_SKULL_MASK] = HintText::Sometimes({
                       //obscure text
                       Text{"the #Skull Mask# yields", /*french*/"le #masque de mort# donne", /*spanish*/"la #m\x91scara de calavera# otorga"},
  });

    hintTable[DEKU_THEATER_MASK_OF_TRUTH] = HintText::Sometimes({
                       //obscure text
                       Text{"showing a #truthful eye to the crowd# rewards", /*french*/"montrer #l'oeil de v\x96rit\x96 \x90 la foule# donne", /*spanish*/"#mostrarle el ojo verdadero# a una multitud brinda"},
                     }, {},
                       //clear text
                       Text{"the #Mask of Truth# yields", /*french*/"le #masque de v\x96rit\x96# donne", /*spanish*/"la #m\x91scara de la verdad# premia"}
  );

    hintTable[HF_OCARINA_OF_TIME_ITEM] = HintText::Sometimes({
                       //obscure text
                       Text{"the #treasure thrown by Princess Zelda# is", /*french*/"le tr\x96sor #laiss\x96 par la princesse# est", /*spanish*/"el #tesoro arrojado por la Princesa Zelda# se trata de"},
  });

    hintTable[DMT_TRADE_BROKEN_SWORD] = HintText::Sometimes({
                       //obscure text
                       Text{"a #blinded Biggoron# entrusts", /*french*/"un #Grogoron aveugl\x96# confie", /*spanish*/"un #miope Biggoron# otorga"},
  });

    hintTable[DMT_TRADE_EYEDROPS] = HintText::Sometimes({
                       //obscure text
                       Text{"while you wait, #Biggoron# gives", /*french*/"pendant que tu attends, #Grogoron# donne", /*spanish*/"#Biggoron# est\x91 a la espera de otorgar"},
  });
    ...
    hintTable[KAK_50_GOLD_SKULLTULA_REWARD] = HintText::Sometimes({
                       //obscure text
                       Text{"#50 bug badges# rewards",           /*french*/"#50 m\x96dailles d'insectes# donnent",             /*spanish*/"#50 medallas de insectos# otorgan"},
                       Text{"#50 spider souls# yields",          /*french*/"#50 \x92mes# donnent",                 /*spanish*/"#50 almas de araña# otorgan"},
                       Text{"#50 auriferous arachnids# lead to", /*french*/"#50 arachnides aurif\x95res# donnent", /*spanish*/"#50 ar\x91cnidos auríferos# otorgan"},
                     }, {},
                       //clear text
                       Text{"slaying #50 Gold Skulltulas# reveals", /*french*/"d\x96truire #50 Skulltulas d'or# donne", /*spanish*/"exterminar #50 skulltulas doradas# revela"}
  );

    hintTable[KAK_40_GOLD_SKULLTULA_REWARD] = HintText::Sometimes({
                       //obscure text
                       Text{"#40 bug badges# rewards",           /*french*/"#40 m\x96dailles d'insectes# donnent",             /*spanish*/"#40 medallas de insectos# otorgan"},
                       Text{"#40 spider souls# yields",          /*french*/"#40 \x92mes# donnent",                 /*spanish*/"#40 almas de araña# otorgan"},
                       Text{"#40 auriferous arachnids# lead to", /*french*/"#40 arachnides aurif\x95res# donnent", /*spanish*/"#40 ar\x91cnidos auríferos# otorgan"},
                     }, {},
                       //clear text
                       Text{"slaying #40 Gold Skulltulas# reveals", /*french*/"d\x96truire #40 Skulltulas d'or# donne", /*spanish*/"exterminar #40 skulltulas doradas# revela"}
  );

    hintTable[KAK_30_GOLD_SKULLTULA_REWARD] = HintText::Sometimes({
                       //obscure text
                       Text{"#30 bug badges# rewards",           /*french*/"#30 m\x96dailles d'insectes# donnent",             /*spanish*/"#30 medallas de insectos# otorgan"},
                       Text{"#30 spider souls# yields",          /*french*/"#30 \x92mes# donnent",                 /*spanish*/"#30 almas de araña# otorgan"},
                       Text{"#30 auriferous arachnids# lead to", /*french*/"#30 arachnides aurif\x95res# donnent", /*spanish*/"#30 ar\x91cnidos auríferos# otorgan"},
                     }, {},
                       //clear text
                       Text{"slaying #30 Gold Skulltulas# reveals", /*french*/"d\x96truire #30 Skulltulas d'or# donne", /*spanish*/"exterminar #30 skulltulas doradas# revela"}
  );

    hintTable[KAK_20_GOLD_SKULLTULA_REWARD] = HintText::Sometimes({
                       //obscure text
                       Text{"#20 bug badges# rewards",           /*french*/"#20 m\x96dailles d'insectes# donnent",             /*spanish*/"#20 medallas de insectos# otorgan"},
                       Text{"#20 spider souls# yields",          /*french*/"#20 \x92mes# donnent",                 /*spanish*/"#20 almas de araña# otorgan"},
                       Text{"#20 auriferous arachnids# lead to", /*french*/"#20 arachnides aurif\x95res# donnent", /*spanish*/"#20 ar\x91cnidos auríferos# otorgan"},
                     }, {},
                       //clear text
                       Text{"slaying #20 Gold Skulltulas# reveals", /*french*/"d\x96truire #20 Skulltulas d'or# donne", /*spanish*/"exterminar #20 skulltulas doradas# revela"}
  );
    ...
    hintTable[KAK_TRADE_ODD_MUSHROOM] = HintText::Sometimes({
                       //obscure text
                       Text{"the #potion shop lady# entrusts", /*french*/"la #dame du magasin de potion# confie", /*spanish*/"la #señora de la tienda de pociones# otorga"},
  });
    ...
    hintTable[LW_TRADE_COJIRO] = HintText::Sometimes({
                       //obscure text
                       Text{"returning a #special Cucco# awards", /*french*/"ramener une #poulette pr\x96cieuse# donne", /*spanish*/"quien devuelva un #cuco especial# encontrar\x91"},
  });
    ...
    hintTable[LH_SUN] = HintText::Sometimes({
                       ...
                       //clear text
                       Text{"shooting #the sun# grants", /*french*/"tirer une fl\x95che dans #sur le soleil# donne", /*spanish*/"#disparar al sol# revela"}
  );
    ...
    hintTable[MARKET_TREASURE_CHEST_GAME_REWARD] = HintText::Sometimes({
                       ...
                       //clear text
                       Text{"the #treasure chest game# grants", /*french*/"la #chasse aux tr\x96sors# donne", /*spanish*/"#el Cofre del Tesoro# premia"}
  );

    hintTable[MARKET_TREASURE_CHEST_GAME_ITEM_1] = HintText::Sometimes({
                       //obscure text
                       Text{"#gambling once# grants",                    /*french*/"#parier une fois# donne",                        /*spanish*/"#apostar solo una vez# revelar\x91"},
                       Text{"the #first or second game chest# contains", /*french*/"le #premier ou deuxi\x95me coffre \x90 jeu# contient", /*spanish*/"#el primer o segundo cofre del azar# revela"},
                     }, {},
                       //clear text
                       Text{"the #first locked room# in the chest game contains", /*french*/"la #premi\x95re salle# de la chasse aux tr\x96sors contient", /*spanish*/"#en la primera sala del Cofre del Tesoro# aguarda"}
  );

    hintTable[MARKET_TREASURE_CHEST_GAME_ITEM_2] = HintText::Sometimes({
                       //obscure text
                       Text{"#gambling twice# grants",                   /*french*/"#parier deux fois# donne",                          /*spanish*/"#apostar dos veces# revelar\x91"},
                       Text{"the #third or fourth game chest# contains", /*french*/"le #troisi\x95me ou quatri\x95me coffre \x90 jeu# contient", /*spanish*/"#el tercer o cuarto cofre del azar# revela"},
                     }, {},
                       //clear text
                       Text{"the #second locked room# in the chest game contains", /*french*/"la #deuxi\x95me salle# de la chasse aux tr\x96sors contient", /*spanish*/"#en la segunda sala del Cofre del Tesoro# aguarda"}
  );

    hintTable[MARKET_TREASURE_CHEST_GAME_ITEM_3] = HintText::Sometimes({
                       //obscure text
                       Text{"#gambling 3 times# grants",                /*french*/"#parier trois fois# donne",                       /*spanish*/"#apostar tres veces# revelar\x91"},
                       Text{"the #fifth or sixth game chest# contains", /*french*/"le #cinqui\x95me ou sixi\x95me coffre \x90 jeu# contient", /*spanish*/"#el quinto o sexto cofre del azar# revela"},
                     }, {},
                       //clear text
                       Text{"the #third locked room# in the chest game contains", /*french*/"la #troisi\x95me salle# de la chasse aux tr\x96sors contient", /*spanish*/"#en la tercera sala del Cofre del Tesoro# aguarda"}
  );

    hintTable[MARKET_TREASURE_CHEST_GAME_ITEM_4] = HintText::Sometimes({
                       //obscure text
                       Text{"#gambling 4 times# grants",                   /*french*/"#parier quatre fois# donne",                      /*spanish*/"#apostar cuatro veces# revelar\x91"},
                       Text{"the #seventh or eighth game chest# contains", /*french*/"le #septi\x95me ou huiti\x95me coffre \x90 jeu# contient", /*spanish*/"#el s\x96ptimo u octavo cofre del azar# revela"},
                     }, {},
                       //clear text
                       Text{"the #fourth locked room# in the chest game contains", /*french*/"la #quatri\x95me salle# de la chasse aux tr\x96sors contient", /*spanish*/"#en la cuarta sala del Cofre del Tesoro# aguarda"}
  );

    hintTable[MARKET_TREASURE_CHEST_GAME_ITEM_5] = HintText::Sometimes({
                       //obscure text
                       Text{"#gambling 5 times# grants",                /*french*/"#parier cinq fois# donne",                       /*spanish*/"#apostar cinco veces# revelar\x91"},
                       Text{"the #ninth or tenth game chest# contains", /*french*/"le #neuvi\x95me ou dixi\x95me coffre \x90 jeu# contient", /*spanish*/"#el noveno o d\x96cimo cofre del azar# revela"},
                     }, {},
                       //clear text
                       Text{"the #fifth locked room# in the chest game contains", /*french*/"la #cinqui\x95me salle# de la chasse aux tr\x96sors contient", /*spanish*/"#en la quinta sala del Cofre del Tesoro# aguarda"}
  );
    ...
    hintTable[GC_MAZE_LEFT_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"in #Goron City# the hammer unlocks", /*french*/"dans le #village Goron#, le marteau donne acc\x95s \x90", /*spanish*/"en la #Ciudad Goron# el martillo desbloquea"},
  });

    hintTable[GV_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"in #Gerudo Valley# the hammer unlocks", /*french*/"dans la #vall\x96e Gerudo#, le marteau donne acc\x95s \x90", /*spanish*/"en el #Valle Gerudo# el martillo desbloquea"},
  });
    ...
    hintTable[GV_COW] = HintText::Sometimes({
                       //obscure text
                       Text{"a #cow in Gerudo Valley# gifts", /*french*/"la #vache de la vall\x96e Gerudo# donne", /*spanish*/"una #vaca del Valle Gerudo# brinda"},
  });

    hintTable[HC_GS_STORMS_GROTTO] = HintText::Sometimes({
                       //obscure text
                       Text{"a #spider behind a muddy wall# in a grotto holds", /*french*/"l'#araign\x96e derri\x95re un mur de boue# dans une grotte donne", /*spanish*/"una #Skulltula tras la agrietada pared# de una cueva otorga"},
  });

    hintTable[HF_GS_COW_GROTTO] = HintText::Sometimes({
                       //obscure text
                       Text{"a #spider behind webs# in a grotto holds", /*french*/"l'#araign\x96e derri\x95re une toile# dans une grotte donne", /*spanish*/"una #Skulltula tras la telaraña# de una cueva otorga"},
  });

    hintTable[HF_COW_GROTTO_COW] = HintText::Sometimes({
                       //obscure text
                       Text{"the #cobwebbed cow# gifts", /*french*/"la #vache prisonni\x95re d'araign\x96es# donne", /*spanish*/"una #vaca tras una telaraña# brinda"},
                     }, {},
                       //clear text
                       Text{"a #cow behind webs# in a grotto gifts", /*french*/"la #vache derri\x95re les toiles# d'une grotte donne", /*spanish*/"una #vaca tras la telaraña# de una cueva brinda"}
  );

    hintTable[ZF_GS_HIDDEN_CAVE] = HintText::Sometimes({
                       //obscure text
                       Text{"a spider high #above the icy waters# holds", /*french*/"l'araign\x96e #en haut des eaux glac\x96es# donne", /*spanish*/"una Skulltula en lo #alto de las congeladas aguas# otorga"},
  });
    ...
    hintTable[WASTELAND_GS] = HintText::Sometimes({
                       //obscure text
                       Text{"a #spider in the wasteland# holds", /*french*/"#l'araign\x96e dans le d\x96sert# donne", /*spanish*/"una #Skulltula del desierto encantado# otorga"},
  });
    ...
    hintTable[GRAVEYARD_COMPOSERS_GRAVE_CHEST] = HintText::Sometimes({
                       ...
                       Text{"the #Composer Brothers hid#",             /*french*/"#les Fr\x95res compositeurs on cach\x96#",                     /*spanish*/"los #hermanos compositores esconden#"},
  });

    hintTable[ZF_BOTTOM_FREESTANDING_POH] = HintText::Sometimes({
                       //obscure text
                       Text{"#under the icy waters# lies", /*french*/"#sous les eaux glac\x96es# se cache", /*spanish*/"#bajo las congeladas aguas# yace"},
  });

    hintTable[GC_POT_FREESTANDING_POH] = HintText::Sometimes({
                       //obscure text
                       Text{"spinning #Goron pottery# contains", /*french*/"la #potterie Goron# contient", /*spanish*/"una #cer\x91mica goron# contiene"},
  });

    hintTable[ZD_KING_ZORA_THAWED] = HintText::Sometimes({
                       //obscure text
                       Text{"a #defrosted dignitary# gifts", /*french*/"le #monarque lib\x96r\x96# donne", /*spanish*/"una #liberación mon\x91rquica# brinda"},
                     }, {},
                       //clear text
                       Text{"unfreezing #King Zora# grants", /*french*/"d\x96geler # le Roi Zora# donne", /*spanish*/"#descongelar al Rey Zora# conduce a"}
  );
    ...
    hintTable[DMC_DEKU_SCRUB] = HintText::Sometimes({
                       //obscure text
                       Text{"a single #scrub in the crater# sells", /*french*/"la #peste Mojo dans le crat\x95re# vend", /*spanish*/"un solitario #deku del cr\x91ter# vende"},
  });
    ...
    hintTable[DEKU_TREE_MQ_AFTER_SPINNING_LOG_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"a #temporal stone within a tree# contains", /*french*/"la #pierre bleue dans un arbre# m\x95ne \x90", /*spanish*/"un #bloque temporal de un \x91rbol# contiene"},
                     }, {},
                       //clear text
    ...
    hintTable[DEKU_TREE_MQ_GS_BASEMENT_GRAVES_ROOM] = HintText::Sometimes({
                       //obscure text
                       Text{"a #spider on a ceiling in a tree# holds", /*french*/"l'#araign\x96e haut-perch\x96e dans un arbre# a", /*spanish*/"una #Skulltula en el techo de un \x91rbol# otorga"},
                     }, {},
                       //clear text
                       Text{"a #spider on a ceiling in the Deku Tree# holds", /*french*/"la#Skulltula dans le cimeti\x95re de l'arbre Mojo# a", /*spanish*/"una #Skulltula en el techo del Gran Árbol Deku# otorga"}
  );

    hintTable[DODONGOS_CAVERN_MQ_GS_SONG_OF_TIME_BLOCK_ROOM] = HintText::Sometimes({
                       //obscure text
                       Text{"a spider under #temporal stones in a cavern# holds", /*french*/"l'araign\x96e sous #une pierre bleue dans une caverne# a", /*spanish*/"una Skulltula bajo #bloques temporales de una cueva# otorga"},
                     }, {},
                       //clear text
    ...
    hintTable[JABU_JABUS_BELLY_BOOMERANG_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"a school of #stingers swallowed by a deity# guard", /*french*/"les #raies dans un gardien# prot\x95gent", /*spanish*/"unos de #stingers engullidos por cierta deidad# guardan"},
                     }, {},
                       //clear text
                       Text{"a school of #stingers swallowed by Jabu-Jabu# guard", /*french*/"les #raies dans Jabu-Jabu# prot\x95gent", /*spanish*/"unos #stingers engullidos por Jabu-Jabu# guardan"}
  );

    hintTable[JABU_JABUS_BELLY_MQ_GS_INVISIBLE_ENEMIES_ROOM] = HintText::Sometimes({
                       //obscure text
                       Text{"a spider surrounded by #shadows in the belly of a deity# holds", /*french*/"l'araign\x96e entour\x96e d'#ombres dans le ventre du gardien# poss\x95de", /*spanish*/"una Skulltula rodeada de #sombras en la tripa de cierta diedad# otorga"},
                     }, {},
                       //clear text
                       Text{"a spider surrounded by #shadows in Jabu-Jabu's Belly# holds", /*french*/"la Skulltula entour\x96e d'#ombres dans Jabu-Jabu# poss\x95de", /*spanish*/"una Skulltula rodeada de #sombras en la Tripa de Jabu-Jabu# otorga"}
  );
    ...
    hintTable[JABU_JABUS_BELLY_MQ_COW] = HintText::Sometimes({
                       ...
                       //clear text
                       Text{"a #cow swallowed by Jabu-Jabu# gifts", /*french*/"la #vache avall\x96e par Jabu-Jabu# donne", /*spanish*/"una #vaca engullida por Jabu-Jabu# brinda"}
  );

    hintTable[FIRE_TEMPLE_SCARECROW_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"a #scarecrow atop the volcano# hides", /*french*/"l'#\x96pouvantail au sommet d'un volcan# donne", /*spanish*/"un #espantap\x91jaros en lo alto del volc\x91n# esconde"},
                     }, {},
                       //clear text
    ...
    hintTable[FIRE_TEMPLE_MEGATON_HAMMER_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"the #Flare Dancer atop the volcano# guards a chest containing", /*french*/"le #danseur au sommet du volcan# prot\x95ge", /*spanish*/"el #Bailafuego en lo alto del volc\x91n# otorga"},
                     }, {},
                       //clear text
                       Text{"the #Flare Dancer atop the Fire Temple# guards a chest containing", /*french*/"le #Danse-Flamme au sommet du temple du feu# prot\x95ge", /*spanish*/"el #Bailaguego en lo alto del Templo del Fuego# otorga"}
  );
    ...
    hintTable[FIRE_TEMPLE_MQ_CHEST_ON_FIRE] = HintText::Sometimes({
                       ...
                       //clear text
                       Text{"the #Flare Dancer atop the Fire Temple# guards a chest containing", /*french*/"le #Danse-Flamme au sommet du temple du feu# prot\x95ge", /*spanish*/"el #Bailafuego en lo alto del Templo del Fuego# otorga"}
  );

    hintTable[FIRE_TEMPLE_MQ_GS_SKULL_ON_FIRE] = HintText::Sometimes({
                       //obscure text
                       Text{"a #spider under a block in the volcano# holds", /*french*/"l'#araign\x96e sous un bloc dans le volcan# a", /*spanish*/"una #Skulltula bajo el bloque de un volc\x91n# otorga"},
                     }, {},
                       //clear text
    ...
    hintTable[WATER_TEMPLE_RIVER_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"beyond the #river under the lake# waits", /*french*/"au del\x90 de #la rivi\x95re sous le lac# se cache", /*spanish*/"tras el #río bajo el lago# yace"},
                     }, {},
                       //clear text
                       Text{"beyond the #river in the Water Temple# waits", /*french*/"au del\x90 de #la rivi\x95re dans le temple de l'eau# se cache", /*spanish*/"tras el #río del Templo del Agua# yace"}
  );

    hintTable[WATER_TEMPLE_BOSS_KEY_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"dodging #rolling boulders under the lake# leads to", /*french*/"\x96viter des #rochers roulants sous le lac# m\x95ne \x90", /*spanish*/"esquivar #rocas rodantes bajo el lago# conduce a"},
                     }, {},
                       //clear text
                       Text{"dodging #rolling boulders in the Water Temple# leads to", /*french*/"\x96viter des #rochers roulants dans le temple de l'eau# m\x95ne \x90", /*spanish*/"esquivar #rocas rondantes del Templo del Agua# conduce a"}
  );

    hintTable[WATER_TEMPLE_GS_BEHIND_GATE] = HintText::Sometimes({
                       //obscure text
                       Text{"a spider behind a #gate under the lake# holds", /*french*/"l'araign\x96e derri\x95re une #barri\x95re sous le lac# a", /*spanish*/"una Skulltula tras #una valla bajo el lago# otorga"},
                     }, {},
                       //clear text
                       Text{"a spider behind a #gate in the Water Temple# holds", /*french*/"la Skulltula derri\x95re une #barri\x95re dans le temple de l'eau# a", /*spanish*/"una Skulltula tras #una valla del Templo del Agua# otorga"}
  );
    ...
    hintTable[WATER_TEMPLE_MQ_GS_FREESTANDING_KEY_AREA] = HintText::Sometimes({
                       //obscure text
                       Text{"the #locked spider under the lake# holds", /*french*/"l'#araign\x96e emprisonn\x96e sous le lac# a", /*spanish*/"la #Skulltula enjaulada bajo el lago# otorga"},
                     }, {},
                       //clear text
                       Text{"the #locked spider in the Water Temple# holds", /*french*/"une #Skulltula emprisonn\x96e dans le temple de l'eau# a", /*spanish*/"la #Skulltula enjaulada del Templo del Agua# otorga"}
  );
    ...
    hintTable[WATER_TEMPLE_MQ_GS_TRIPLE_WALL_TORCH] = HintText::Sometimes({
                       ...
                       //clear text
                       Text{"a spider behind a #gate in the Water Temple# holds", /*french*/"une #Skulltula derri\x95re une barri\x95re dans le temple de l'eau# a", /*spanish*/"una Skulltula tras una #valla del Templo del Agua#"}
  );

    hintTable[GERUDO_TRAINING_GROUNDS_UNDERWATER_SILVER_RUPEE_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"those who seek #sunken silver rupees# will find", /*french*/"ceux qui pêchent les #joyaux argent\x96s# trouveront", /*spanish*/"aquellos que busquen las #rupias plateadas sumergidas# encontrar\x91n"},
                       Text{"the #thieves' underwater training# rewards",      /*french*/"l'#\x96preuve de plong\x96e des voleurs# rec\x95le",         /*spanish*/"la #instrucción submarina de las bandidas# premia"},
  });
    ...
    hintTable[GERUDO_TRAINING_GROUNDS_MAZE_PATH_FINAL_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"the final prize of #the thieves' training# is", /*french*/"la r\x96compense ultime de #l'\x96preuve des voleurs# est", /*spanish*/"la recompensa final de la #instrucción de las bandida# brinda"},
  });

    hintTable[GERUDO_TRAINING_GROUNDS_MQ_ICE_ARROWS_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"the final prize of #the thieves' training# is", /*french*/"la r\x96compense ultime de #l'\x96preuve des voleurs# est", /*spanish*/"el premio final de la #instrucción de las bandidas# brinda"},
  });
    ...
    hintTable[BOTTOM_OF_THE_WELL_LENS_OF_TRUTH_CHEST] = HintText::Sometimes({
                       ...
                       Text{"a #nether dweller in the well# holds", /*french*/"le #spectre qui r\x96side dans le puits# a", /*spanish*/"el #temido morador del pozo# concede"},
                     }, {},
                       //clear text
    ...
    hintTable[SPIRIT_TEMPLE_SILVER_GAUNTLETS_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"the treasure #sought by Nabooru# is", /*french*/"le tr\x96sor que #recherche Nabooru# est", /*spanish*/"el #ansiado tesoro de Nabooru# brinda"},
                     }, {},
                       //clear text
    ...
    hintTable[SPIRIT_TEMPLE_MQ_CHILD_HAMMER_SWITCH_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"a #temporal paradox in the Colossus# yields", /*french*/"un #paradoxe temporel dans le colosse# r\x96v\x95le", /*spanish*/"una #paradoja temporal del Coloso# conduce a"},
                     }, {},
                       //clear text
                       Text{"a #temporal paradox in the Spirit Temple# yields", /*french*/"le #paradoxe temporel dans le temple de l'esprit# r\x96v\x95le", /*spanish*/"una #paradoja temporal del Coloso# conduce a"}
  );

    hintTable[SPIRIT_TEMPLE_MQ_SYMPHONY_ROOM_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"a #symphony in the Colossus# yields", /*french*/"la #symphonie du colosse# r\x96v\x95le", /*spanish*/"una #sinfonía del Coloso# conduce a"},
                     }, {},
                       //clear text
                       Text{"a #symphony in the Spirit Temple# yields", /*french*/"les #cinq chansons du temple de l'esprit# r\x96v\x95lent", /*spanish*/"una #sinfonía del Coloso# conduce a"}
  );

    hintTable[SPIRIT_TEMPLE_MQ_GS_SYMPHONY_ROOM] = HintText::Sometimes({
                       //obscure text
                       Text{"a #spider's symphony in the Colossus# yields", /*french*/"la #m\x96lodie de l'araign\x96e du colosse# r\x96v\x95le", /*spanish*/"la #Skulltula de la sinfonía del Coloso# otorga"},
                     }, {},
                       //clear text
                       Text{"a #spider's symphony in the Spirit Temple# yields", /*french*/"la #m\x96lodie de la Skulltula du temple de l'esprit# r\x96v\x95le", /*spanish*/"la #Skulltula de la sinfonía del Coloso# otorga"}
  );

    hintTable[SHADOW_TEMPLE_INVISIBLE_FLOORMASTER_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"shadows in an #invisible maze# guard", /*french*/"les ombres dans le #labyrinthe invisible# prot\x95gent", /*spanish*/"las sombras del #laberinto misterioso# esconden"},
  });

    hintTable[SHADOW_TEMPLE_MQ_BOMB_FLOWER_CHEST] = HintText::Sometimes({
                       //obscure text
                       Text{"shadows in an #invisible maze# guard", /*french*/"les ombres dans le #labyrinthe invisible# prot\x95gent", /*spanish*/"las sombras del #laberinto invisible# esconden"},
  });
    ...
    hintTable[KF_KOKIRI_SWORD_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #hidden treasure of the Kokiri# is", /*french*/"le #tr\x96sor des Kokiri# est", /*spanish*/"el #tesoro oculto de los Kokiri# esconde"},
  });
    ...
    hintTable[GRAVEYARD_SHIELD_GRAVE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #treasure of a fallen soldier# is", /*french*/"le #tr\x96sor du soldat mort# est", /*spanish*/"el #tesoro de un soldado caído# esconde"},
  });

    hintTable[DMT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"hidden behind a wall on a #mountain trail# is", /*french*/"derri\x95re une fa\x94ade du #chemin montagneux# est", /*spanish*/"tras una pared del #sendero de la montaña# yace"},
  });

    hintTable[GC_MAZE_RIGHT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"in #Goron City# explosives unlock", /*french*/"des explosions dans le #village Goron# r\x96v\x95lent", /*spanish*/"en la #Ciudad Goron# unos explosivos desbloquean"},
  });
    ...
    hintTable[ZD_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"fire #beyond a waterfall# reveals", /*french*/"du feu #derri\x95re la cascade# \x96claire", /*spanish*/"las #llamas tras una una cascada# revelan"},
  });
    ...
    hintTable[GRAVEYARD_HOOKSHOT_CHEST] = HintText::Exclude({
                       ...
                       //clear text
                       Text{"#dead Damp\x96's first prize# is", /*french*/"la #premi\x95re course d'Igor# donne", /*spanish*/"el primer premio de #la carrera de Damp\x96# se trata de"}
  );
    ...
    hintTable[KAK_REDEAD_GROTTO_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#zombies beneath the earth# guard", /*french*/"les #revenants sous terre# prot\x95gent", /*spanish*/"unos #zombis subterr\x91neos# esconden"},
  });

    hintTable[SFM_WOLFOS_GROTTO_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#wolves beneath the earth# guard", /*french*/"les #loups sous terre# prot\x95gent", /*spanish*/"unos #lobos subterr\x91neos# esconden"},
  });

    hintTable[HF_NEAR_MARKET_GROTTO_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #hole in a field near a drawbridge# holds", /*french*/"la #grotte pr\x95s d'un pont# contient", /*spanish*/"bajo el #hoyo de una llanura cercano a un puente# yace"},
  });

    hintTable[HF_SOUTHEAST_GROTTO_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #hole amongst trees in a field# holds", /*french*/"la #grotte pr\x95s des arbres# contient", /*spanish*/"bajo el #hoyo de una llanura rodeado de \x91rboles# yace"},
  });
    ...
    hintTable[ZR_OPEN_GROTTO_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #hole along a river# holds", /*french*/"la #grotte pr\x95s du fleuve# contient", /*spanish*/"bajo un #hoyo junto a un río# yace"},
  });

    hintTable[KF_STORMS_GROTTO_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #hole in a forest village# holds", /*french*/"la #grotte inond\x96e de pluie dans le Village Kokiri# r\x96v\x95le", /*spanish*/"bajo el #hoyo de una tribu del bosque# yace"},
  });
    ...
    hintTable[DMT_STORMS_GROTTO_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#hole flooded with rain on a mountain# holds", /*french*/"la #grotte inond\x96e de pluie sur la montagne# contient", /*spanish*/"bajo un #hoyo de una montaña inundado de lluvia# yace"},
  });

    hintTable[DMC_UPPER_GROTTO_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #hole in a volcano# holds", /*french*/"la #grotte dans le volcan# contient", /*spanish*/"bajo el #hoyo de un volc\x91n# yace"},
  });
    ...
    hintTable[LW_GIFT_FROM_SARIA] = HintText::Exclude({
                       //obscure text
                       Text{"a #potato hoarder# holds",           /*french*/"le #panini m\x96lodieux# est en fait", /*spanish*/"cierta #jovencita verde# concede"},
    ...
    hintTable[ZF_GREAT_FAIRY_REWARD] = HintText::Exclude({
                       //obscure text
                       Text{"the #fairy of winds# holds", /*french*/"la #f\x96e du vent# a", /*spanish*/"el #hada del viento# brinda"},
  });

    hintTable[HC_GREAT_FAIRY_REWARD] = HintText::Exclude({
                       //obscure text
                       Text{"the #fairy of fire# holds", /*french*/"la #f\x96e du feu# a", /*spanish*/"el #hada del fuego# brinda"},
  });

    hintTable[COLOSSUS_GREAT_FAIRY_REWARD] = HintText::Exclude({
                       //obscure text
                       Text{"the #fairy of love# holds", /*french*/"la #f\x96e de l'amour# a", /*spanish*/"el #hada del amor# brinda"},
  });

    hintTable[DMT_GREAT_FAIRY_REWARD] = HintText::Exclude({
                       //obscure text
                       Text{"a #magical fairy# gifts", /*french*/"la #f\x96e de la magie# a", /*spanish*/"un #hada m\x91gica# brinda"},
  });
    ...
    hintTable[OGC_GREAT_FAIRY_REWARD] = HintText::Exclude({
                       //obscure text
                       Text{"the #fairy of strength# holds", /*french*/"la #f\x96e de la force# a", /*spanish*/"el #hada de la fuerza# brinda"},
  });
    ...
    hintTable[SONG_FROM_WINDMILL] = HintText::Exclude({
                       //obscure text
                       Text{"a man #in a windmill# is obsessed with", /*french*/"l'#homme du moulin# donne", /*spanish*/"el #hombre del molino# est\x91 obsesionado con"},
  });


    hintTable[HC_MALON_EGG] = HintText::Exclude({
                       //obscure text
                       Text{"a #girl looking for her father# gives", /*french*/"la #fillette qui cherche son p\x95re# donne", /*spanish*/"una #chica en busca de su padre# otorga"},
  });

    hintTable[HC_ZELDAS_LETTER] = HintText::Exclude({
                       //obscure text
                       Text{"a #princess in a castle# gifts", /*french*/"la #princesse dans le ch\x92teau# donne", /*spanish*/"la #princesa de un castillo# otorga"},
  });

    hintTable[ZD_DIVING_MINIGAME] = HintText::Exclude({
                       //obscure text
                       Text{"an #unsustainable business model# gifts", /*french*/"le #mauvais mod\x95le d'affaires# donne", /*spanish*/"un #mal modelo de negocio# premia con"},
                     }, {},
                       //clear text
                       Text{"those who #dive for Zora rupees# will find", /*french*/"ceux qui #plongent pour des rubis Zora# trouveront", /*spanish*/"aquellos que se #sumergan por las rupias zora# encontrar\x91n"}
  );
    ...
    hintTable[LH_ADULT_FISHING] = HintText::Exclude({
                       //obscure text
                       Text{"#fishing in maturity# bestows", /*french*/"#pêcher dans sa maturit\x96# promet", /*spanish*/"#pescar en la madurez# conduce a"},
  });

    hintTable[LH_LAB_DIVE] = HintText::Exclude({
                       //obscure text
                       Text{"a #diving experiment# is rewarded with", /*french*/"l'#exp\x96rience de plong\x96e# donne", /*spanish*/"#bucear para un experimento# se premia con"},
  });

    hintTable[GC_ROLLING_GORON_AS_ADULT] = HintText::Exclude({
                       //obscure text
                       Text{"#comforting yourself# provides", /*french*/"se #r\x96conforter soi-même# donne", /*spanish*/"#confrontarte a ti mismo# otorga"},
                     }, {},
                       //clear text
    ...
    hintTable[MARKET_BOMBCHU_BOWLING_SECOND_PRIZE] = HintText::Exclude({
                       //obscure text
                       Text{"the #second explosive prize# is", /*french*/"le #deuxi\x95me prix explosif# est", /*spanish*/"el #segundo premio explosivo# se trata de"},
  });

    hintTable[MARKET_LOST_DOG] = HintText::Exclude({
                       //obscure text
                       Text{"#puppy lovers# will find", /*french*/"les #amoureux canins# trouveront", /*spanish*/"los #amantes caninos# encontrar\x91n"},
                     }, {},
                       //clear text
    ...
    hintTable[LW_OCARINA_MEMORY_GAME] = HintText::Exclude({
                       //obscure text
                       Text{"the prize for a #game of Simon Says# is", /*french*/"la #r\x96compense de Jean Dit# est", /*spanish*/"#repetir ciertas melodías# otorga"},
                       Text{"a #child sing-a-long# holds",             /*french*/"les #jeunes fl\x9Dtistes# donnent",  /*spanish*/"#tocar junto a otros# otorga"},
                     }, {},
                       //clear text
                       Text{"#playing an Ocarina in Lost Woods# is rewarded with", /*french*/"#jouer l'ocarina dans la forêt des m\x96andres# donne", /*spanish*/"#tocar la ocarina en el Bosque Perdido# otorga"}
  );

    hintTable[KAK_10_GOLD_SKULLTULA_REWARD] = HintText::Exclude({
                       //obscure text
                       Text{"#10 bug badges# rewards",           /*french*/"#10 m\x96dailles d'insectes# donnent",             /*spanish*/"#10 medallas de insectos# otorgan"},
                       Text{"#10 spider souls# yields",          /*french*/"#10 \x92mes# donnent",                 /*spanish*/"#10 almas de araña# otorgan"},
                       Text{"#10 auriferous arachnids# lead to", /*french*/"#10 arachnides aurif\x95res# donnent", /*spanish*/"#10 ar\x91cnidos auríferos# otorgan"},
                     }, {},
                       //clear text
                       Text{"slaying #10 Gold Skulltulas# reveals", /*french*/"d\x96truire #10 Skulltulas d'or# donne", /*spanish*/"#exterminar 10 skulltulas doradas# revela"}
  );
    ...
    hintTable[ZR_MAGIC_BEAN_SALESMAN] = HintText::Exclude({
                       //obscure text
                       Text{"a seller of #colorful crops# has", /*french*/"le #marchand de l\x96gumes# vend", /*spanish*/"el vendedor de un #colorido cultivo# ofrece"},
                     }, {},
                       //clear text
    ...
    hintTable[ZR_FROGS_IN_THE_RAIN] = HintText::Exclude({
                       //obscure text
                       Text{"#frogs in a storm# gift", /*french*/"#des grenouilles mouill\x96es# donnent", /*spanish*/"las #ancas bajo la tormenta# otorgan"},
  });

    hintTable[GF_HBA_1000_POINTS] = HintText::Exclude({
                       //obscure text
                       Text{"scoring 1000 in #horseback archery# grants", /*french*/"obtenir 1000 points dans l'#archerie \x96questre# donne", /*spanish*/"conseguir 1000 puntos en el #tiro con arco a caballo# premia"},
  });
    ...
    hintTable[KAK_SHOOTING_GALLERY_REWARD] = HintText::Exclude({
                       //obscure text
                       Text{"#shooting in maturity# grants", /*french*/"#faire du tir dans sa maturit\x96# donne", /*spanish*/"#disparar en la madurez# otorga"},
  });
    ...
    hintTable[KAK_ANJU_AS_ADULT] = HintText::Exclude({
                       //obscure text
                       Text{"a #chicken caretaker# offers adults", /*french*/"devenir un #\x96leveur de Cocottes# donne", /*spanish*/"una #cuidadora de emplumados# le ofrece a los mayores"},
  });
    ...
    hintTable[GC_ROLLING_GORON_AS_CHILD] = HintText::Exclude({
                       //obscure text
                       Text{"the prize offered by a #large rolling Goron# is", /*french*/"la r\x96compense d'un #gros Goron roulant# est", /*spanish*/"un #gran Goron rodante# otorga"},
  });

    hintTable[LH_UNDERWATER_ITEM] = HintText::Exclude({
                       //obscure text
                       Text{"the #sunken treasure in a lake# is", /*french*/"le #tr\x96sor au fond du lac# est", /*spanish*/"el #tesoro hundido del lago# se trata de"},
  });

    hintTable[GF_GERUDO_TOKEN] = HintText::Exclude({
                       //obscure text
                       Text{"#rescuing captured carpenters# is rewarded with", /*french*/"#secourir les charpentiers captur\x96s# assure", /*spanish*/"#rescatar los apresados carpinteros# se premia con"},
  });

    hintTable[WASTELAND_BOMBCHU_SALESMAN] = HintText::Exclude({
                       //obscure text
                       Text{"a #carpet guru# sells", /*french*/"#un marchand du d\x96sert# vend", /*spanish*/"el #genio de una alfombra# vende"},
  });
    ...
    hintTable[GRAVEYARD_DAMPE_RACE_FREESTANDING_POH] = HintText::Exclude({
                       //obscure text
                       Text{"#racing a ghost# leads to", /*french*/"le d\x96fi du #revenant rapide# donne", /*spanish*/"#perseguir a un fantasma# conduce a"},
                     }, {},
                       //clear text
                       Text{"#dead Dampe's second# prize is", /*french*/"la #deuxi\x95me course d'Igor# donne", /*spanish*/"el segundo premio de #la carrera de Damp\x96# se trata de"}
  );
    ...
    hintTable[GV_WATERFALL_FREESTANDING_POH] = HintText::Exclude({
                       //obscure text
                       Text{"behind a #desert waterfall# is", /*french*/"#derri\x95re la cascade du d\x96sert# se cache", /*spanish*/"tras una #desierta cascada# yace"},
  });
    ...
    hintTable[GF_NORTH_F1_CARPENTER] = HintText::Exclude({
                       //obscure text
                       Text{"#defeating Gerudo guards# reveals", /*french*/"les #geôliers Gerudo# d\x96tiennent", /*spanish*/"#derrotar a las guardas Gerudo# revela"},
  });
    ...
    hintTable[DEKU_TREE_MAP_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"in the #center of the Deku Tree# lies", /*french*/"#le cœur de l'arbre Mojo# rec\x95le", /*spanish*/"al #centro del Gran Árbol Deku# yace"},
  });

    hintTable[DEKU_TREE_SLINGSHOT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #treasure guarded by a scrub# in the Deku Tree is", /*french*/"le #tr\x96sor prot\x96g\x96 par une peste# dans l'arbre Mojo est", /*spanish*/"un #deku del Gran Árbol Deku# esconde"},
  });
    ...
    hintTable[DEKU_TREE_MQ_COMPASS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #treasure guarded by a large spider# in the Deku Tree is", /*french*/"le #tr\x96sor prot\x96g\x96 par une grosse araign\x96e# dans l'arbre Mojo est", /*spanish*/"una #gran araña del Gran Árbol Deku# esconde"},
  });
    ...
    hintTable[DEKU_TREE_MQ_BEFORE_SPINNING_LOG_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#magical fire in the Deku Tree# leads to", /*french*/"le #feu magique dans l'arbre Mojo# \x96claire", /*spanish*/"el #fuego m\x91gico en el Gran Árbol Deku# conduce a"},
  });
    ...
    hintTable[DODONGOS_CAVERN_MAP_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #muddy wall in Dodongo's Cavern# hides", /*french*/"le #mur fragile dans la caverne Dodongo# rec\x95le", /*spanish*/"tras una #agrietada pared en la Cueva de los Dodongos# yace"},
  });

    hintTable[DODONGOS_CAVERN_COMPASS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #statue in Dodongo's Cavern# guards", /*french*/"la #statue dans la caverne Dodongo# prot\x95ge", /*spanish*/"una #estatua de la Cueva de los Dodongos# esconde"},
  });
    ...
    hintTable[DODONGOS_CAVERN_BOMB_BAG_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #second lizard cavern battle# yields", /*french*/"le #deuxi\x95me duel de l\x96zards de caverne# octroie", /*spanish*/"#luchar dos veces contra reptiles en una cueva# conduce a"},
  });

    hintTable[DODONGOS_CAVERN_END_OF_BRIDGE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #chest at the end of a bridge# yields", /*french*/"le #tr\x96sor \x90 l'extr\x96mit\x96 d'un pont# contient", /*spanish*/"un #cofre al final de un quebrado puente# contiene"},
  });


    hintTable[DODONGOS_CAVERN_MQ_MAP_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #muddy wall in Dodongo's Cavern# hides", /*french*/"le #mur fragile dans la caverne Dodongo# rec\x95le", /*spanish*/"una #agrietada pared en la Cueva de los Dodongos# esconde"},
  });

    hintTable[DODONGOS_CAVERN_MQ_BOMB_BAG_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"an #elevated alcove# in Dodongo's Cavern holds", /*french*/"l'#alcove haut perch\x96e# dans la caverne Dodongo cache", /*spanish*/"una #elevada alcoba# en la Cueva de los Dodongos brinda"},
  });

    hintTable[DODONGOS_CAVERN_MQ_COMPASS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#fire-breathing lizards# in Dodongo's Cavern guard", /*french*/"les #l\x96zards cracheurs de feu# dans la caverne Dodongo prot\x95gent", /*spanish*/"unos #flamígeros reptiles# en la Cueva de los Dodongos esconden"},
  });

    hintTable[DODONGOS_CAVERN_MQ_LARVAE_ROOM_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#baby spiders# in Dodongo's Cavern guard", /*french*/"les #petites araign\x96es dans la caverne Dodongo# prot\x95gent", /*spanish*/"unas #pequeñas larvas# en la Cueva de los Dodongos esconden"},
  });
    ...
    hintTable[JABU_JABUS_BELLY_MAP_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#tentacle trouble# in a deity's belly guards", /*french*/"la #membrane# dans le ventre du gardien prot\x95ge", /*spanish*/"un #problema tentaculoso# en la tripa de cierta deidad esconde"},
                     }, {},
                       //clear text
                       Text{"a #slimy thing# guards", /*french*/"la #chose gluante# gardien prot\x95ge", /*spanish*/"un #tent\x91culo parasitario# protege"}
  );

    hintTable[JABU_JABUS_BELLY_COMPASS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#bubble trouble# in a deity's belly guards", /*french*/"un #horde de bulles# dans le ventre du gardien prot\x95gent", /*spanish*/"un #problema burbujesco# en la tripa de cierta deidad esconde"},
                     }, {},
                       //clear text
    ...
    hintTable[JABU_JABUS_BELLY_MQ_FIRST_ROOM_SIDE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"shooting a #mouth cow# reveals", /*french*/"tirer sur une #vache# r\x96v\x95le", /*spanish*/"#dispararle a una vaca# revela"},
  });
    ...
    hintTable[JABU_JABUS_BELLY_MQ_MAP_CHEST] = HintText::Exclude({
                       ...
                       //clear text
                       Text{"a #boulder before cows# hides", /*french*/"des #rochers pr\x95s des vaches# cachent", /*spanish*/"cierta #roca rodeada de vacas# esconde"}
  );
    ...
    hintTable[JABU_JABUS_BELLY_MQ_COMPASS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #drowning cow# unveils", /*french*/"une #vache \x90 l'eau# a", /*spanish*/"una #vaca sumergida# revela"},
  });

    hintTable[JABU_JABUS_BELLY_MQ_SECOND_ROOM_UPPER_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#moving anatomy# creates a path to", /*french*/"un #organe descendant# m\x95ne \x90", /*spanish*/"un #ser movedizo entre paredes# conduce a"},
  });

    hintTable[JABU_JABUS_BELLY_MQ_BASEMENT_NEAR_SWITCHES_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #pair of digested cows# hold", /*french*/"#deux bœufs dig\x96r\x96s# d\x96tiennent", /*spanish*/"un #par de digeridas vacas# otorgan"},
  });
    ...
    hintTable[JABU_JABUS_BELLY_MQ_NEAR_BOSS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #final cows' reward# in a deity's belly is", /*french*/"le #cadeau des derni\x95res vaches# estomacales est", /*spanish*/"las #vacas al final# de la tripa de cierta deidad otorgan"},
  });

    hintTable[JABU_JABUS_BELLY_MQ_FALLING_LIKE_LIKE_ROOM_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#cows protected by falling monsters# in a deity's belly guard", /*french*/"des #vaches prot\x96g\x96es par des monstres tombants# cachent", /*spanish*/"unas #vacas custodiadas por monstruos del techo# de la tripa de cierta deidad otorgan"},
  });

    hintTable[JABU_JABUS_BELLY_MQ_BOOMERANG_ROOM_SMALL_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a school of #stingers swallowed by a deity# guard", /*french*/"les #raies avall\x96es par le gardien# prot\x95gent", /*spanish*/"unos #stingers engullidos por cierta deidad# guardan"},
                     }, {},
                       //clear text
                       Text{"a school of #stingers swallowed by Jabu-Jabu# guard", /*french*/"les #raies avall\x96es par Jabu-Jabu# prot\x95gent", /*spanish*/"unos #stingers engullidos por Jabu-Jabu# guardan"}
  );
    ...
    hintTable[FOREST_TEMPLE_FIRST_STALFOS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#defeating enemies beneath a falling ceiling# in Forest Temple yields", /*french*/"#deux squelettes# dans le temple de la forêt prot\x95gent", /*spanish*/"#derrotar enemigos caídos de lo alto# del Templo del Bosque revela"},
  });

    hintTable[FOREST_TEMPLE_WELL_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #sunken chest deep in the woods# contains", /*french*/"le #coffre submerg\x96 dans la forêt# contient", /*spanish*/"un #sumergido cofre en lo profundo del bosque# contiene"},
  });

    hintTable[FOREST_TEMPLE_MAP_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #fiery skull# in Forest Temple guards", /*french*/"le #cr\x92ne enflamm\x96# dans le temple de la forêt prot\x95ge", /*spanish*/"una #ardiente calavera# del Templo del Bosque esconde"},
  });
    ...
    hintTable[FOREST_TEMPLE_EYE_SWITCH_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #sharp eye# will spot", /*french*/"l'#oeil per\x94ant# dans la forêt verra", /*spanish*/"un #afilado ojo# revela"},
                     }, {},
                       //clear text
    ...
    hintTable[FOREST_TEMPLE_BOSS_KEY_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #turned trunk# contains", /*french*/"le #coffre pivot\x96# contient", /*spanish*/"en una #sala con otro punto de vista# se esconde"},
  });

    hintTable[FOREST_TEMPLE_FLOORMASTER_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"deep in the forest #shadows guard a chest# containing", /*french*/"l'#ombre de la forêt# prot\x95ge un coffre contenant", /*spanish*/"en lo profundo del bosque #unas sombras# esconden"},
  });

    hintTable[FOREST_TEMPLE_BOW_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"an #army of the dead# guards", /*french*/"des #squelettes sylvestres# prot\x95gent", /*spanish*/"un #ej\x96rcito de soldados caídos# guarda"},
                     }, {},
                       //clear text
                       Text{"#Stalfos deep in the Forest Temple# guard", /*french*/"#trois squelettes dans le temple de la forêt# prot\x95gent", /*spanish*/"los #Stalfos en lo profundo del Templo del Bosque# guardan"}
  );

    hintTable[FOREST_TEMPLE_RED_POE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#Joelle# guards", /*french*/"#Joelle# prot\x95ge", /*spanish*/"#Joelle# guarda"},
                     }, {},
                       //clear text
                       Text{"a #red ghost# guards", /*french*/"le #fantôme rouge# prot\x95ge", /*spanish*/"un #espectro rojo# guarda"}
  );

    hintTable[FOREST_TEMPLE_BLUE_POE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#Beth# guards", /*french*/"#Beth# prot\x95ge", /*spanish*/"#Beth# guarda"},
                     }, {},
                       //clear text
                       Text{"a #blue ghost# guards", /*french*/"le #fantôme bleu# prot\x95ge", /*spanish*/"un #espectro azul# guarda"}
  );

    hintTable[FOREST_TEMPLE_BASEMENT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#revolving walls# in the Forest Temple conceal", /*french*/"des #murs rotatifs dans la forêt# rec\x95lent", /*spanish*/"las #paredes giratorias# del Templo del Bosque conceden"},
  });
    ...
    hintTable[FOREST_TEMPLE_MQ_MAP_CHEST] = HintText::Exclude({
                       ...
                       //clear text
                       Text{"a #red ghost# guards", /*french*/"le #fantôme rouge# prot\x95ge", /*spanish*/"un #fantasma rojo# guarda"}
  );
    ...
    hintTable[FOREST_TEMPLE_MQ_COMPASS_CHEST] = HintText::Exclude({
                       ...
                       //clear text
                       Text{"a #blue ghost# guards", /*french*/"le #fantôme bleu# prot\x95ge", /*spanish*/"un #fantasma azul# guarda"}
  );
    ...
    hintTable[FOREST_TEMPLE_MQ_REDEAD_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"deep in the forest #undead guard a chest# containing", /*french*/"des #revenants dans le temple de la forêt# prot\x95gent", /*spanish*/"en lo profundo del bosque #guardias del m\x91s all\x91# guardan"},
  });
    ...
    hintTable[FIRE_TEMPLE_FLARE_DANCER_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #Flare Dancer behind a totem# guards", /*french*/"le #Danse-Flamme derri\x95re un totem# prot\x95ge", /*spanish*/"el #Bailafuego tras unos tótems# esconde"},
  });

    hintTable[FIRE_TEMPLE_BOSS_KEY_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #prison beyond a totem# holds", /*french*/"la #prison derri\x95re un totem# contient", /*spanish*/"en una #prisión tras unos tótems# yace"},
  });

    hintTable[FIRE_TEMPLE_BIG_LAVA_ROOM_BLOCKED_DOOR_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#explosives over a lava pit# unveil", /*french*/"des #explosifs dans un lac de lave# r\x96v\x95lent", /*spanish*/"los #explosivos en un mar de llamas# revelan"},
  });

    hintTable[FIRE_TEMPLE_BIG_LAVA_ROOM_LOWER_OPEN_DOOR_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron trapped near lava# holds", /*french*/"le #Goron emprisonn\x96 pr\x95s de la lave# a", /*spanish*/"un #goron atrapado cerca de un mar de llamas# guarda"},
  });
    ...
    hintTable[FIRE_TEMPLE_BOULDER_MAZE_SIDE_ROOM_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron hidden near a maze# holds", /*french*/"le #Goron cach\x96 pr\x95s du labyrinthe# a", /*spanish*/"un #goron escondido tras un laberinto# guarda"},
  });
    ...
    hintTable[FIRE_TEMPLE_MAP_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #caged chest# in the Fire Temple hoards", /*french*/"un #coffre emprisonn\x96# dans le temple du feu contient", /*spanish*/"un #cofre entre rejas# del Templo del Fuego contiene"},
  });

    hintTable[FIRE_TEMPLE_COMPASS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #chest in a fiery maze# contains", /*french*/"un #coffre dans un labyrinthe enflamm\x96# contient", /*spanish*/"un #cofre de un ardiente laberinto# contiene"},
  });
    ...
    hintTable[FIRE_TEMPLE_MQ_MEGATON_HAMMER_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #Flare Dancer in the depths of a volcano# guards", /*french*/"le #Danse-Flamme au cœur du volcan# a", /*spanish*/"el #Bailafuego en lo profundo del volc\x91n# esconde"},
                     }, {},
                       //clear text
    ...
    hintTable[FIRE_TEMPLE_MQ_COMPASS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #blocked path# in Fire Temple holds", /*french*/"le #chemin scell\x96# dans le temple du feu contient", /*spanish*/"en un #camino bloqueado# del Templo del Fuego yace"},
  });
    ...
    hintTable[FIRE_TEMPLE_MQ_MAP_ROOM_SIDE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #falling slug# in the Fire Temple guards", /*french*/"la #limace tombante# dans le temple du feu prot\x95ge", /*spanish*/"una #babosa del techo# del Templo del Fuego guarda"},
  });

    hintTable[FIRE_TEMPLE_MQ_MAP_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"using a #hammer in the depths of the Fire Temple# reveals", "frapper du #marteau au cœur du volcan# r\x96v\x95le", /*spanish*/"usar el #martillo en lo profundo del Templo del Fuego# revela"},
  });

    hintTable[FIRE_TEMPLE_MQ_BOSS_KEY_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#illuminating a lava pit# reveals the path to", /*french*/"#\x96clairer le lac de lave# r\x96v\x95le", /*spanish*/"#iluminar un mar de llamas# revela"},
  });
    ...
    hintTable[FIRE_TEMPLE_MQ_LIZALFOS_MAZE_SIDE_ROOM_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron hidden near a maze# holds", /*french*/"le #Goron cach\x96 pr\x95s du labyrinthe# a", /*spanish*/"un #goron cerca de un laberinto# guarda"},
  });
    ...
    hintTable[WATER_TEMPLE_COMPASS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#roaming stingers in the Water Temple# guard", /*french*/"des #raies dans le temple de l'eau# prot\x95gent", /*spanish*/"unos #errantes stingers# del Templo del Agua guardan"},
  });

    hintTable[WATER_TEMPLE_TORCHES_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#fire in the Water Temple# reveals", /*french*/"des #flammes dans le temple de l'eau# r\x96v\x95lent", /*spanish*/"el #fuego en el Templo del Agua# revela"},
  });

    hintTable[WATER_TEMPLE_DRAGON_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #serpent's prize# in the Water Temple is", /*french*/"la #r\x96compense du dragon submerg\x96# est", /*spanish*/"el #escamado premio# del Templo del Agua se trata de"},
  });
    ...
    hintTable[WATER_TEMPLE_LONGSHOT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#facing yourself# reveals",              /*french*/"se #vaincre soi-même# r\x96v\x95le", /*spanish*/"#luchar contra ti mismo# revela"},
                       Text{"a #dark reflection# of yourself guards", /*french*/"son #propre reflet# cache",    /*spanish*/"el #oscuro reflejo de ti mismo# guarda"},
                     }, {},
                       //clear text
                       Text{"#Dark Link# guards", /*french*/"l'#Ombre de @# prot\x95ge", /*spanish*/"#@ Oscuro# guarda"}
  );
    ...
    hintTable[WATER_TEMPLE_MQ_BOSS_KEY_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"fire in the Water Temple unlocks a #vast gate# revealing a chest with", /*french*/"des #flammes au cœur du temple de l'eau# r\x96v\x95lent", /*spanish*/"el fuego en el Templo del Agua alza una #gran valla# con"},
  });
    ...
    hintTable[WATER_TEMPLE_MQ_MAP_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#sparring soldiers# in the Water Temple guard", /*french*/"les #soldats du temple de l'eau# prot\x95gent", /*spanish*/"#acabar con unos soldados# del Templo del Agua revela"},
  });


    hintTable[SPIRIT_TEMPLE_CHILD_BRIDGE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a child conquers a #skull in green fire# in the Spirit Temple to reach", /*french*/"le #cr\x92ne au halo vert dans le colosse# cache", /*spanish*/"el joven que #baje el puente# del Templo del Espíritu encontrar\x91"},
  });

    hintTable[SPIRIT_TEMPLE_CHILD_EARLY_TORCHES_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a child can find a #caged chest# in the Spirit Temple with", /*french*/"le #coffre embarr\x96 dans le colosse# contient", /*spanish*/"un joven puede encontrar un #cofre entre rejas# del Templo del Espíritu con"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_EARLY_ADULT_RIGHT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#dodging boulders to collect silver rupees# in the Spirit Temple yields", /*french*/"les #pi\x95ces argent\x96es entour\x96es de rochers dans le colosse# r\x96v\x95lent", /*spanish*/"#esquivar rocas y conseguir plateadas rupias# en el Templo del Espíritu conduce a"},
  });

    hintTable[SPIRIT_TEMPLE_FIRST_MIRROR_LEFT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #shadow circling reflected light# in the Spirit Temple guards", /*french*/"l'#ombre pr\x95s d'un miroir# prot\x95ge", /*spanish*/"un #círculo de reflectante luz# del Templo del Espíritu guarda"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_CHILD_CLIMB_NORTH_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#lizards in the Spirit Temple# guard", /*french*/"les #l\x96zards dans le colosse# prot\x95gent", /*spanish*/"los #reptiles del Templo del Espíritu# guardan"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_SUN_BLOCK_ROOM_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#torchlight among Beamos# in the Spirit Temple reveals", /*french*/"les #torches autour des Sentinelles# \x96clairent", /*spanish*/"las #antorchas junto a Beamos# del Templo del Espíritu revelan"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_NEAR_FOUR_ARMOS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"those who #show the light among statues# in the Spirit Temple find", /*french*/"le #soleil pr\x95s des statues# cache", /*spanish*/"aquellos que #iluminen ante las estatuas# del Templo del Espíritu encontrar\x91n"},
  });

    hintTable[SPIRIT_TEMPLE_HALLWAY_RIGHT_INVISIBLE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #Eye of Truth in the Spirit Temple# reveals", /*french*/"le #tr\x96sor invisible pr\x95s du Hache-Viande# contient", /*spanish*/"el #Ojo de la Verdad# en el Templo del Espíritu revela"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_BOSS_KEY_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #chest engulfed in flame# in the Spirit Temple holds", /*french*/"le #coffre enflamm\x96 dans le colosse# contient", /*spanish*/"un #cofre rodeado de llamas# del Templo del Espíritu contiene"},
  });

    hintTable[SPIRIT_TEMPLE_TOPMOST_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"those who #show the light above the Colossus# find", /*french*/"le #soleil au sommet du colosse# r\x96v\x95le", /*spanish*/"aquellos que #iluminen en lo alto del Coloso# encontrar\x91n"},
  });


    hintTable[SPIRIT_TEMPLE_MQ_ENTRANCE_FRONT_LEFT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#lying unguarded# in the Spirit Temple is", /*french*/"dans #l'entr\x96e du colosse# se trouve", /*spanish*/"en la #entrada del Templo del Espíritu# yace"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_MQ_ENTRANCE_FRONT_RIGHT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#collecting rupees through a water jet# reveals", /*french*/"les #pi\x95ces argent\x96es dans le jet d'eau# du colosse r\x96v\x95lent", /*spanish*/"#hacerte con rupias tras un g\x96iser# revela"},
  });

    hintTable[SPIRIT_TEMPLE_MQ_ENTRANCE_BACK_LEFT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"an #eye blinded by stone# within the Spirit Temple conceals", /*french*/"#l'oeil derri\x95re le rocher# dans le colosse voit", /*spanish*/"#cegar a un ojo# del Templo del Espíritu revela"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_MQ_MAP_ROOM_ENEMY_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a child defeats a #gauntlet of monsters# within the Spirit Temple to find", /*french*/"l'enfant qui vainc #plusieurs monstres# dans le colosse trouvera", /*spanish*/"el joven que derrote #unos monstruos# del Templo del Espíritu encontrar\x91"},
  });

    hintTable[SPIRIT_TEMPLE_MQ_CHILD_CLIMB_NORTH_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#explosive sunlight# within the Spirit Temple uncovers", /*french*/"le #rayon de lumi\x95re explosif dans le colosse# r\x96v\x95le", /*spanish*/"una #explosiva luz solar# del Templo del Espíritu revela"},
  });

    hintTable[SPIRIT_TEMPLE_MQ_CHILD_CLIMB_SOUTH_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#trapped by falling enemies# within the Spirit Temple is", /*french*/"des #ennemis tombants# dans le colosse prot\x95gent", /*spanish*/"#rodeado de enemigos del cielo# del Templo del Espíritu yace"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_MQ_STATUE_ROOM_LULLABY_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #royal melody awakens the colossus# to reveal", /*french*/"la #m\x96lodie royale \x96veille le colosse# et r\x96v\x95le", /*spanish*/"la #melodía real que despierte al coloso# revelar\x91"},
  });

    hintTable[SPIRIT_TEMPLE_MQ_STATUE_ROOM_INVISIBLE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #Eye of Truth# finds the colossus's hidden", /*french*/"#l'oeil de v\x96rit\x96# verra dans le colosse", /*spanish*/"el #Ojo de la Verdad# en el Templo del Espíritu encontrar\x91"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_MQ_SUN_BLOCK_ROOM_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#sunlight in a maze of fire# hides", /*french*/"#la lumi\x95re dans le labyrinthe de feu# du colosse r\x96v\x95le", /*spanish*/"la #luz solar de un ígneo laberinto# esconde"},
  });

    hintTable[SPIRIT_TEMPLE_MQ_LEEVER_ROOM_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#across a pit of sand# in the Spirit Temple lies", /*french*/"le #trou sableux# dans le colosse a", /*spanish*/"#a trav\x96s del pozo de arena# del Templo del Espíritu yace"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_MQ_CHEST_SWITCH_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #chest of double purpose# holds", /*french*/"le #coffre \x90 usage double# du colosse contient", /*spanish*/"un #cofre de doble uso# contiene"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_MQ_MIRROR_PUZZLE_INVISIBLE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"those who #show the light above the Colossus# find", /*french*/"le tr\x96sor invisible #au sommet du colosse# contient", /*spanish*/"aquellos que #revelen la luz sobre el Coloso# encontrar\x91n"},
  });

    hintTable[SHADOW_TEMPLE_MAP_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #Eye of Truth# pierces a hall of faces to reveal", /*french*/"l'#oeil de v\x96rit\x96# voit dans les couloirs du temple de l'ombre", /*spanish*/"el #Ojo de la Verdad# descubrir\x91 un pasillo de facetas con"},
  });
    ...
    hintTable[SHADOW_TEMPLE_COMPASS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#mummies revealed by the Eye of Truth# guard", /*french*/"les #Gibdos dans les couloirs# du temple de l'ombre prot\x95gent", /*spanish*/"las #momias reveladas por el Ojo de la Verdad# guardan"},
  });

    hintTable[SHADOW_TEMPLE_EARLY_SILVER_RUPEE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#spinning scythes# protect", /*french*/"les #faucheurs danseurs# du temple de l'ombre prot\x95gent", /*spanish*/"las #giratorias guadañas# protegen"},
  });

    hintTable[SHADOW_TEMPLE_INVISIBLE_BLADES_VISIBLE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#invisible blades# guard", /*french*/"les #faucheurs invisibles# du temple de l'ombre prot\x95gent", /*spanish*/"las #hojas invisibles# guardan"},
  });
    ...
    hintTable[SHADOW_TEMPLE_WIND_HINT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"an #invisible chest guarded by the dead# holds", /*french*/"le #tr\x96sor invisible du cul-de-sac# du temple de l'ombre contient", /*spanish*/"un #cofre invisible custodiado por los del m\x91s all\x91# contiene"},
  });
    ...
    hintTable[SHADOW_TEMPLE_SPIKE_WALLS_LEFT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#walls consumed by a ball of fire# reveal", /*french*/"le #pi\x95ge de bois# du temple de l'ombre cache", /*spanish*/"las #paredes consumidas por una esfera ígnea# revelan"},
  });
    ...
    hintTable[SHADOW_TEMPLE_MQ_COMPASS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #Eye of Truth# pierces a hall of faces to reveal", /*french*/"l'#oeil de v\x96rit\x96# voit dans les couloirs du temple de l'ombre", /*spanish*/"el #Ojo de la Verdad# descubre un pasillo de facetas con"},
  });
    ...
    hintTable[SHADOW_TEMPLE_MQ_BEAMOS_SILVER_RUPEES_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#collecting rupees in a vast cavern# with the Shadow Temple unveils", /*french*/"les #pi\x95ces argent\x96es dans le temple de l'ombre# r\x96v\x95lent", /*spanish*/"hacerte con las #rupias en una gran caverna# del Templo de las Sombras revela"},
  });
    ...
    hintTable[SHADOW_TEMPLE_MQ_INVISIBLE_BLADES_INVISIBLE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#invisible blades# guard", /*french*/"les #faucheurs invisibles# du temple de l'ombre prot\x95gent", /*spanish*/"unas #hojas invisibles# guardan"},
  });
    ...
    hintTable[BOTTOM_OF_THE_WELL_FRONT_LEFT_FAKE_WALL_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #Eye of Truth in the well# reveals", /*french*/"l'#oeil de v\x96rit\x96 dans le puits# r\x96v\x95le", /*spanish*/"el #Ojo de la Verdad en el pozo# revela"},
  });

    hintTable[BOTTOM_OF_THE_WELL_FRONT_CENTER_BOMBABLE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#gruesome debris# in the well hides", /*french*/"des #d\x96bris dans le puits# cachent", /*spanish*/"unos #horripilantes escombros# del pozo esconden"},
  });
    ...
    hintTable[BOTTOM_OF_THE_WELL_CENTER_SKULLTULA_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider guarding a cage# in the well protects", /*french*/"l'#araign\x96e dans la cage du puits# prot\x95ge", /*spanish*/"una #araña protegiendo una celda# del pozo guarda"},
  });
    ...
    hintTable[BOTTOM_OF_THE_WELL_INVISIBLE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#Dead Hand's invisible secret# is", /*french*/"le #tr\x96sor invisible du Poigneur# est", /*spanish*/"el #secreto invisible de la Mano Muerta# esconde"},
  });

    hintTable[BOTTOM_OF_THE_WELL_UNDERWATER_FRONT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #royal melody in the well# uncovers", /*french*/"la #m\x96lodie royale r\x96v\x95le dans le puits#", /*spanish*/"una #melodía real en el pozo# revela"},
  });
    ...
    hintTable[BOTTOM_OF_THE_WELL_FIRE_KEESE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#perilous pits# in the well guard the path to", /*french*/"#trois trous# dans le puits prot\x95gent", /*spanish*/"#peligrosos fosos# del pozo conducen a"},
  });
    ...
    hintTable[BOTTOM_OF_THE_WELL_MQ_LENS_OF_TRUTH_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"an #army of the dead# in the well guards", /*french*/"l'#arm\x96e des morts# dans le puits prot\x95ge", /*spanish*/"un #ej\x96rcito del m\x91s all\x91# del pozo guarda"},
  });
    ...
    hintTable[ICE_CAVERN_COMPASS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #wall of ice# protects", /*french*/"#un mur de glace rouge# cache", /*spanish*/"una #g\x96lida pared# protege"},
  });

    hintTable[ICE_CAVERN_IRON_BOOTS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a #monster in a frozen cavern# guards", /*french*/"le #monstre de la caverne de glace# prot\x95ge", /*spanish*/"un #monstruo de una helada caverna# guarda"},
  });
    ...
    hintTable[GERUDO_TRAINING_GROUNDS_STALFOS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#soldiers walking on shifting sands# in the Gerudo Training Grounds guard", /*french*/"les #squelettes# du gymnase Gerudo prot\x95gent", /*spanish*/"#soldados en resbaladizas arenas# del Centro de Instrucción Gerudo protegen"},
  });

    hintTable[GERUDO_TRAINING_GROUNDS_BEAMOS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#reptilian warriors# in the Gerudo Training Grounds protect", /*french*/"les #l\x96zards# dans le gymnase Gerudo prot\x95gent", /*spanish*/"#unos escamosos guerreros# del Centro de Instrucción Gerudo protegen"},
  });
    ...
    hintTable[GERUDO_TRAINING_GROUNDS_MAZE_PATH_FIRST_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the first prize of #the thieves' training# is", /*french*/"le #premier tr\x96sor du gymnase Gerudo# est", /*spanish*/"el primer premio de la #instrucción bandida# se trata de"},
  });

    hintTable[GERUDO_TRAINING_GROUNDS_MAZE_PATH_SECOND_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the second prize of #the thieves' training# is", /*french*/"le #deuxi\x95me tr\x96sor du gymnase Gerudo# est", /*spanish*/"el segundo premio de la #instrucción bandida# se trata de"},
  });

    hintTable[GERUDO_TRAINING_GROUNDS_MAZE_PATH_THIRD_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the third prize of #the thieves' training# is", /*french*/"le #troisi\x95me tr\x96sor du gymnase Gerudo# est", /*spanish*/"el tercer premio de la #instrucción bandida# se trata de"},
  });

    hintTable[GERUDO_TRAINING_GROUNDS_MAZE_RIGHT_CENTRAL_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #Song of Time# in the Gerudo Training Grounds leads to", /*french*/"le #chant du temps# r\x96v\x95le dans le gymnase Gerudo", /*spanish*/"la #Canción del Tiempo# en el Centro de Instrucción Gerudo conduce a"},
  });
    ...
    hintTable[GERUDO_TRAINING_GROUNDS_HAMMER_ROOM_CLEAR_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#fiery foes# in the Gerudo Training Grounds guard", /*french*/"les #limaces de feu# du gymnase Gerudo prot\x95gent", /*spanish*/"unos #flamígeros enemigos# del Centro de Instrucción Gerudo guardan"},
  });

    hintTable[GERUDO_TRAINING_GROUNDS_HAMMER_ROOM_SWITCH_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#engulfed in flame# where thieves train lies", /*french*/"le #tr\x96sor enflamm\x96# du gymnase Gerudo est", /*spanish*/"donde entrenan las bandidas #entre llamas# yace"},
  });

    hintTable[GERUDO_TRAINING_GROUNDS_EYE_STATUE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"thieves #blind four faces# to find", /*french*/"l'#\x96preuve d'archerie# du gymnase Gerudo donne", /*spanish*/"las bandidas #ciegan cuatro bustos# para hallar"},
  });
    ...
    hintTable[GERUDO_TRAINING_GROUNDS_MQ_SECOND_IRON_KNUCKLE_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#fiery foes# in the Gerudo Training Grounds guard", /*french*/"les #ennemis de feu# du gymnase Gerudo prot\x95gent", /*spanish*/"unos #flamígeros enemigos# del Centro de Instrucción Gerudo guardan"},
  });
    ...
    hintTable[GANONS_TOWER_BOSS_KEY_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #Evil King# hoards", /*french*/"le #Roi du Mal# poss\x95de", /*spanish*/"el #Rey del Mal# acapara"},
  });


    hintTable[GANONS_CASTLE_FOREST_TRIAL_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #test of the wilds# holds", /*french*/"l'#\x96preuve des bois# contient", /*spanish*/"la #prueba de la naturaleza# brinda"},
  });

    hintTable[GANONS_CASTLE_WATER_TRIAL_LEFT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #test of the seas# holds", /*french*/"l'#\x96preuve des mers# contient", /*spanish*/"la #prueba del mar# brinda"},
  });
    ...
    hintTable[GANONS_CASTLE_SHADOW_TRIAL_FRONT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#music in the test of darkness# unveils", /*french*/"la #musique dans l'\x96preuve des t\x96n\x95bres# r\x96v\x95le", /*spanish*/"la #música en la prueba de la oscuridad# revela"},
  });

    hintTable[GANONS_CASTLE_SHADOW_TRIAL_GOLDEN_GAUNTLETS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#light in the test of darkness# unveils", /*french*/"la #lumi\x95re dans l'\x96preuve des t\x96n\x95bres# r\x96v\x95le", /*spanish*/"la #luz en la prueba de la oscuridad# revela"},
  });

    hintTable[GANONS_CASTLE_SPIRIT_TRIAL_CRYSTAL_SWITCH_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #test of the sands# holds", /*french*/"l'#\x96preuve des sables# contient", /*spanish*/"la #prueba de las arenas# brinda"},
  });
    ...
    hintTable[GANONS_CASTLE_LIGHT_TRIAL_FIRST_LEFT_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #test of radiance# holds", /*french*/"l'#\x96preuve du ciel# contient", /*spanish*/"la #prueba del resplandor# brinda"},
  });
    ...
    hintTable[GANONS_CASTLE_LIGHT_TRIAL_LULLABY_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#music in the test of radiance# reveals", /*french*/"la #musique dans l'\x96preuve du ciel# r\x96v\x95le", /*spanish*/"la #música en la prueba del resplandor# revela"},
  });
    ...
    hintTable[GANONS_CASTLE_MQ_SHADOW_TRIAL_BOMB_FLOWER_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"the #test of darkness# holds", /*french*/"l'#\x96preuve des t\x96n\x95bres# contient", /*spanish*/"la #prueba de la oscuridad# brinda"},
  });
    ...
    hintTable[GANONS_CASTLE_MQ_SPIRIT_TRIAL_GOLDEN_GAUNTLETS_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"#reflected light in the test of the sands# reveals", /*french*/"le #soleil dans l'\x96preuve des sables# r\x96v\x95le", /*spanish*/"#reflejar la luz en la prueba de las arenas# revela"},
  });
    ...
    hintTable[GANONS_CASTLE_MQ_FOREST_TRIAL_FREESTANDING_KEY] = HintText::Exclude({
                       //obscure text
                       Text{"the #test of the wilds# holds", /*french*/"l'#\x96preuve des bois# r\x96v\x95le", /*spanish*/"la #prueba de la naturaleza# brinda"},
  });


    hintTable[DEKU_TREE_QUEEN_GOHMA_HEART] = HintText::Exclude({
                       //obscure text
                       Text{"the #Parasitic Armored Arachnid# holds", /*french*/"le #monstre insectoïde g\x96ant# poss\x95de", /*spanish*/"el #ar\x91cnido parasitario acorazado# porta"},
                     }, {},
                       //clear text
                       Text{"#Queen Gohma# holds", /*french*/"la #Reine Gohma# poss\x95de", /*spanish*/"la #Reina Goma# porta"}
  );

    hintTable[DODONGOS_CAVERN_KING_DODONGO_HEART] = HintText::Exclude({
                       //obscure text
                       Text{"the #Infernal Dinosaur# holds", /*french*/"le #dinosaure infernal# poss\x95de", /*spanish*/"el #dinosaurio infernal# porta"},
                     }, {},
                       //clear text
                       Text{"#King Dodongo# holds", /*french*/"le #Roi Dodongo# poss\x95de", /*spanish*/"el #Rey Dodongo# porta"}
  );

    hintTable[JABU_JABUS_BELLY_BARINADE_HEART] = HintText::Exclude({
                       //obscure text
                       Text{"the #Bio-Electric Anemone# holds", /*french*/"l'#an\x96mone bio\x96lectrique# poss\x95de", /*spanish*/"la #an\x96mona bioel\x96ctrica# porta"},
                     }, {},
                       //clear text
                       Text{"#Barinade# holds", /*french*/"#Barinade# poss\x95de", /*spanish*/"#Barinade# porta"}
  );

    hintTable[FOREST_TEMPLE_PHANTOM_GANON_HEART] = HintText::Exclude({
                       //obscure text
                       Text{"the #Evil Spirit from Beyond# holds", /*french*/"l'#esprit mal\x96fique de l'au-del\x90# poss\x95de", /*spanish*/"el #espíritu maligno de ultratumba# porta"},
                     }, {},
                       //clear text
                       Text{"#Phantom Ganon# holds", /*french*/"#Ganon Spectral# poss\x95de", /*spanish*/"#Ganon Fantasma# porta"}
  );

    hintTable[FIRE_TEMPLE_VOLVAGIA_HEART] = HintText::Exclude({
                       //obscure text
                       Text{"the #Subterranean Lava Dragon# holds", /*french*/"le #dragon des profondeurs# poss\x95de", /*spanish*/"el #dragón de lava subterr\x91neo# porta"},
                     }, {},
                       //clear text
                       Text{"#Volvagia# holds", /*french*/"#Volvagia# poss\x95de", /*spanish*/"#Volvagia# porta"}
  );

    hintTable[WATER_TEMPLE_MORPHA_HEART] = HintText::Exclude({
                       //obscure text
                       Text{"the #Giant Aquatic Amoeba# holds", /*french*/"l'#amibe aquatique g\x96ante# poss\x95de", /*spanish*/"la #ameba acu\x91tica gigante# porta"},
                     }, {},
                       //clear text
                       Text{"#Morpha# holds", /*french*/"#Morpha# poss\x95de", /*spanish*/"#Morpha# porta"}
  );

    hintTable[SPIRIT_TEMPLE_TWINROVA_HEART] = HintText::Exclude({
                       //obscure text
                       Text{"the #Sorceress Sisters# hold", /*french*/"#les sorci\x95res jumelles# poss\x95de", /*spanish*/"las #hermanas hechiceras# portan"},
                     }, {},
                       //clear text
                       Text{"#Twinrova# holds", /*french*/"#Twinrova# poss\x95de", /*spanish*/"#Birova# porta"}
    );

    hintTable[SHADOW_TEMPLE_BONGO_BONGO_HEART] = HintText::Exclude({
                       //obscure text
                       Text{"the #Phantom Shadow Beast# holds", /*french*/"le #monstre de l'ombre# poss\x95de", /*spanish*/"la #alimaña oscura espectral# porta"},
                     }, {},
                       //clear text
                       Text{"#Bongo Bongo# holds", /*french*/"#Bongo Bongo# poss\x95de", /*spanish*/"#Bongo Bongo# porta"}
    );
    ...
    hintTable[DEKU_TREE_GS_BASEMENT_GATE] = HintText::Exclude({
                       //obscure text
                       Text{"a #web protects a spider# within the Deku Tree holding", /*french*/"une #Skulltula derri\x95re une toile dans l'arbre Mojo# a", /*spanish*/"una #Skulltula protegida por su tela# del Árbol Deku otorga"},
  });
    ...
    hintTable[DEKU_TREE_MQ_GS_COMPASS_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #wall of rock protects a spider# within the Deku Tree holding", /*french*/"une #Skulltula derri\x95re des rochers dans l'arbre Mojo# a", /*spanish*/"una #Skulltula protegida por una pared rocosa# del Árbol Deku otorga"},
  });
    ...
    hintTable[DODONGOS_CAVERN_GS_SIDE_ROOM_NEAR_LOWER_LIZALFOS] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider among bats# in Dodongo's Cavern holds", /*french*/"une #Skulltula entour\x96e de Saigneurs dans la caverne Dodongo# a", /*spanish*/"una #Skulltula rodeada de murci\x96lagos# de la Cueva de los Dodongos otorga"},
  });


    hintTable[DODONGOS_CAVERN_MQ_GS_SCRUB_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider high on a wall# in Dodongo's Cavern holds", /*french*/"une #Skulltula haut perch\x96e dans la caverne Dodongo# a", /*spanish*/"una #Skulltula en lo alto de una pared# de la Cueva de los Dodongos otorga"},
  });

    hintTable[DODONGOS_CAVERN_MQ_GS_LIZALFOS_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider on top of a pillar of rock# in Dodongo's Cavern holds", /*french*/"une #Skulltula sur l'\x96norme pilier de roc de la caverne Dodongo# a", /*spanish*/"una #Skulltula en lo alto de un pilar# de la Cueva de los Dodongos otorga"},
  });
    ...
    hintTable[DODONGOS_CAVERN_MQ_GS_BACK_AREA] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider among graves# in Dodongo's Cavern holds", /*french*/"une #Skulltula parmi les tombes de la caverne Dodongo# a", /*spanish*/"una #Skulltula entre l\x91pidas# en la Cueva de los Dodongos otorga"},
  });


    hintTable[JABU_JABUS_BELLY_GS_LOBBY_BASEMENT_LOWER] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider resting near a princess# in Jabu-Jabu's Belly holds", /*french*/"une #Skulltula pr\x95s de la princesse dans le ventre de Jabu-Jabu# a", /*spanish*/"una #Skulltula junto a una princesa# en la Tripa de Jabu-Jabu otorga"},
  });
    ...
    hintTable[JABU_JABUS_BELLY_GS_NEAR_BOSS] = HintText::Exclude({
                       //obscure text
                       Text{"#jellyfish surround a spider# holding", /*french*/"une #Skulltula entour\x96e de m\x96duses dans le ventre de Jabu-Jabu# a", /*spanish*/"una #Skulltula rodeada de medusas# otorga"},
  });

    hintTable[JABU_JABUS_BELLY_GS_WATER_SWITCH_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider guarded by a school of stingers# in Jabu-Jabu's Belly holds", /*french*/"une #Skulltula prot\x96g\x96e par des raies dans le ventre de Jabu-Jabu# a", /*spanish*/"una #Skulltula rodeada por unos stingers# en la Tripa de Jabu-Jabu otorga"},
  });


    hintTable[JABU_JABUS_BELLY_MQ_GS_TAILPASARAN_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider surrounded by electricity# in Jabu-Jabu's Belly holds", /*french*/"une #Skulltula entour\x96e d'\x96lectricit\x96 dans le ventre de Jabu-Jabu# a", /*spanish*/"una #Skulltula rodeada de electricidad# en la Tripa de Jabu-Jabu otorga"},
  });

    hintTable[JABU_JABUS_BELLY_MQ_GS_BOOMERANG_CHEST_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider guarded by a school of stingers# in Jabu-Jabu's Belly holds", /*french*/"une #Skulltula prot\x96g\x96e par des raies dans le ventre de Jabu-Jabu# a", /*spanish*/"una #Skulltula protegida por unos stingers# en la Tripa de Jabu-Jabu otorga"},
  });
    ...
    hintTable[FOREST_TEMPLE_GS_LEVEL_ISLAND_COURTYARD] = HintText::Exclude({
                       //obscure text
                       Text{"#stone columns# lead to a spider in the Forest Temple hiding", /*french*/"une #Skulltula haut perch\x96e dans le jardin du temple de la forêt# a", /*spanish*/"unas #columnas del Templo del Bosque# conducen a una Skulltula que otorga"},
  });
    ...
    hintTable[FOREST_TEMPLE_GS_BASEMENT] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider within revolving walls# in the Forest Temple holds", /*french*/"une #Skulltula derri\x95re les murs pivotants du temple de la forêt# a", /*spanish*/"una #Skulltula entre paredes giratorias# del Templo del Bosque otorga"},
  });


    hintTable[FOREST_TEMPLE_MQ_GS_FIRST_HALLWAY] = HintText::Exclude({
                       //obscure text
                       Text{"an #ivy-hidden spider# in the Forest Temple hoards", /*french*/"une #Skulltula pr\x95s de l'entr\x96e du temple de la forêt# a", /*spanish*/"una #Skulltula escondida entre cepas# del Templo del Bosque otorga"},
  });

    hintTable[FOREST_TEMPLE_MQ_GS_BLOCK_PUSH_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider in a hidden nook# within the Forest Temple holds", /*french*/"une #Skulltula dans un recoin cach\x96 du temple de la forêt# a", /*spanish*/"una #Skulltula en una esquina oculta# del Templo del Bosque otorga"},
  });
    ...
    hintTable[FIRE_TEMPLE_GS_SONG_OF_TIME_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"#eight tiles of malice# guard a spider holding", /*french*/"une #Skulltula prot\x96g\x96e par huit tuiles dans le temple du feu# a", /*spanish*/"#ocho baldosas de maldad# custodian una Skulltula que otorga"},
  });

    hintTable[FIRE_TEMPLE_GS_BOSS_KEY_LOOP] = HintText::Exclude({
                       //obscure text
                       Text{"#five tiles of malice# guard a spider holding", /*french*/"une #Skulltula prot\x96g\x96e par cinq tuiles dans le temple du feu# a", /*spanish*/"#cinco baldosas de maldad# custodian una Skulltula que otorga"},
  });

    hintTable[FIRE_TEMPLE_GS_BOULDER_MAZE] = HintText::Exclude({
                       //obscure text
                       Text{"#explosives in a maze# unveil a spider hiding", /*french*/"une #Skulltula derri\x95re un mur fragile du temple du feu# a", /*spanish*/"los #explosivos en un laberinto# desvelan una Skulltula que otorga"},
  });

    hintTable[FIRE_TEMPLE_GS_SCARECROW_TOP] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider-friendly scarecrow# atop a volcano hides", /*french*/"une #Skulltula rep\x96r\x96e par l'\x96pouvantail du volcan# a", /*spanish*/"un #espantap\x91jaros en lo alto de un volc\x91n# custodia una Skulltula que otorga"},
                     }, {},
                       //clear text
                       Text{"a #spider-friendly scarecrow# atop the Fire Temple hides", /*french*/"une #Skulltula rep\x96r\x96e par l'\x96pouvantail du temple du feu# a", /*spanish*/"un #espantap\x91jaros del Templo del Fuego# custodia una Skulltula que otorga"}
  );
    ...
    hintTable[FIRE_TEMPLE_MQ_GS_ABOVE_FIRE_WALL_MAZE] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider above a fiery maze# holds", /*french*/"une #Skulltula au dessus du labyrinthe enflamm\x96 du temple du feu# a", /*spanish*/"una #Skulltula sobre un ardiente laberinto# otorga"},
  });

    hintTable[FIRE_TEMPLE_MQ_GS_FIRE_WALL_MAZE_CENTER] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider within a fiery maze# holds", /*french*/"une #Skulltula dans le labyrinthe enflamm\x96 du temple du feu# a", /*spanish*/"una #Skulltula en el interior de un ardiente laberinto# otorga"},
  });

    hintTable[FIRE_TEMPLE_MQ_GS_BIG_LAVA_ROOM_OPEN_DOOR] = HintText::Exclude({
                       //obscure text
                       Text{"a #Goron trapped near lava# befriended a spider with", /*french*/"une #Skulltula emprisonn\x96e pr\x95s du lac de lave du temple du feu# a", /*spanish*/"una #Skulltula amiga de un Goron atrapado junto a la lava# otorga"},
  });

    hintTable[FIRE_TEMPLE_MQ_GS_FIRE_WALL_MAZE_SIDE_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider beside a fiery maze# holds", /*french*/"une #Skulltula pr\x95s du labyrinthe enflamm\x96 du temple du feu# a", /*spanish*/"una #Skulltula junto a un ardiente laberinto# otorga"},
  });
    ...
    hintTable[WATER_TEMPLE_GS_NEAR_BOSS_KEY_CHEST] = HintText::Exclude({
                       //obscure text
                       Text{"a spider protected by #rolling boulders under the lake# hides", /*french*/"une #Skulltula derri\x95re les rochers roulants sous le lac# a", /*spanish*/"una #Skulltula protegida por rocas rodantes# bajo el lago otorga"},
                     }, {},
                       //clear text
                       Text{"a spider protected by #rolling boulders in the Water Temple# hides", /*french*/"une #Skulltula derri\x95re les rochers roulants du temple de l'eau# a", /*spanish*/"una #Skulltula protegida por rocas rodantes# del Templo del Agua otorga"}
  );

    hintTable[WATER_TEMPLE_GS_RIVER] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider over a river# in the Water Temple holds", /*french*/"une #Skulltula au dessus de la rivi\x95re du temple de l'eau# a", /*spanish*/"una #Skulltula sobre un río# del Templo del Agua otorga"},
  });


    hintTable[WATER_TEMPLE_MQ_GS_BEFORE_UPPER_WATER_SWITCH] = HintText::Exclude({
                       //obscure text
                       Text{"#beyond a pit of lizards# is a spider holding", /*french*/"une #Skulltula pr\x95s des l\x96zards du temple de l'eau# a", /*spanish*/"#m\x91s all\x91 de un pozo de reptiles# una Skulltula otorga"},
  });

    hintTable[WATER_TEMPLE_MQ_GS_LIZALFOS_HALLWAY] = HintText::Exclude({
                       //obscure text
                       Text{"#lizards guard a spider# in the Water Temple with", /*french*/"une #Skulltula dans les couloirs crois\x96s du temple de l'eau# a", /*spanish*/"unos #reptiles custodian una Skulltula# del Templo del Agua que otorga"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_GS_BOULDER_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider behind a temporal stone# in the Spirit Temple yields", /*french*/"une #Skulltula derri\x95re une pierre temporelle du temple de l'esprit# a", /*spanish*/"una #Skulltula tras un bloque temporal# del Templo del Espíritu otorga"},
  });
    ...
    hintTable[SPIRIT_TEMPLE_GS_SUN_ON_FLOOR_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider at the top of a deep shaft# in the Spirit Temple holds", /*french*/"une #Skulltula pr\x95s d'un mur d'escalade du temple de l'esprit# a", /*spanish*/"una #Skulltula en lo alto de un gran hueco# del Templo del Espíritu otorga"},
  });

    hintTable[SPIRIT_TEMPLE_GS_METAL_FENCE] = HintText::Exclude({
                       //obscure text
                       Text{"a child defeats a #spider among bats# in the Spirit Temple to gain", /*french*/"une #Skulltula sur le grillage du temple de l'esprit# a", /*spanish*/"el joven que derrote la #Skulltula entre murci\x96lagos# del Templo del Espíritu hallar\x91"},
  });
    ...
    hintTable[SHADOW_TEMPLE_GS_SINGLE_GIANT_POT] = HintText::Exclude({
                       //obscure text
                       Text{"#beyond a burning skull# lies a spider with", /*french*/"une #Skulltula derri\x95re un cr\x92ne enflamm\x96 du temple de l'ombre# a", /*spanish*/"#tras una ardiente calavera# yace una Skulltula que otorga"},
  });

    hintTable[SHADOW_TEMPLE_GS_FALLING_SPIKES_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider beyond falling spikes# holds", /*french*/"une #Skulltula au del\x90 de la pluie de clous du temple de l'ombre# a", /*spanish*/"una #Skulltula tras los pinchos del techo# otorga"},
  });

    hintTable[SHADOW_TEMPLE_GS_TRIPLE_GIANT_POT] = HintText::Exclude({
                       //obscure text
                       Text{"#beyond three burning skulls# lies a spider with", /*french*/"une #Skulltula derri\x95re trois cr\x92nes enflamm\x96s du temple de l'ombre# a", /*spanish*/"#tras tres ardientes calaveras# yace una Skulltula que otorga"},
  });

    hintTable[SHADOW_TEMPLE_GS_LIKE_LIKE_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a spider guarded by #invisible blades# holds", /*french*/"une #Skulltula prot\x96g\x96e par les faucheurs invisibles du temple de l'ombre# a", /*spanish*/"una #Skulltula custodiada por hojas invisibles# otorga"},
  });

    hintTable[SHADOW_TEMPLE_GS_NEAR_SHIP] = HintText::Exclude({
                       //obscure text
                       Text{"a spider near a #docked ship# hoards", /*french*/"une #Skulltula pr\x95s du traversier du temple de l'ombre# a", /*spanish*/"una #Skulltula cercana a un navío# otorga"},
  });
    ...
    hintTable[SHADOW_TEMPLE_MQ_GS_WIND_HINT_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider amidst roaring winds# in the Shadow Temple holds", /*french*/"une #Skulltula pr\x95s des vents du temple de l'ombre# a", /*spanish*/"una #Skulltula entre ventarrones# del Templo de las Sombras otorga"},
  });

    hintTable[SHADOW_TEMPLE_MQ_GS_AFTER_WIND] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider beneath gruesome debris# in the Shadow Temple hides", /*french*/"une #Skulltula sous des d\x96bris du temple de l'ombre# a", /*spanish*/"una #Skulltula bajo unos horripilantes escombros# del Templo de las Sombras otorga"},
  });

    hintTable[SHADOW_TEMPLE_MQ_GS_AFTER_SHIP] = HintText::Exclude({
                       //obscure text
                       Text{"a #fallen statue# reveals a spider with", /*french*/"une #Skulltula pr\x95s de la statue \x96croul\x96e du temple de l'ombre# a", /*spanish*/"una #estatua caída# revelar\x91 una Skulltula que otorgue"},
  });

    hintTable[SHADOW_TEMPLE_MQ_GS_NEAR_BOSS] = HintText::Exclude({
                       //obscure text
                       Text{"a #suspended spider# guards", /*french*/"une #Skulltula pr\x95s du rep\x95re du temple de l'ombre# a", /*spanish*/"una #Skulltula flotante# del Templo de las Sombras otorga"},
  });
    ...
    hintTable[BOTTOM_OF_THE_WELL_GS_WEST_INNER_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider locked in a crypt# within the well guards", /*french*/"une #Skulltula embarr\x96e dans la crypte au fonds du puits# a", /*spanish*/"una #Skulltula encerrada en una cripta# del pozo otorga"},
  });


    hintTable[BOTTOM_OF_THE_WELL_MQ_GS_BASEMENT] = HintText::Exclude({
                       //obscure text
                       Text{"a #gauntlet of invisible spiders# protects", /*french*/"une #Skulltula prot\x96g\x96e par les araign\x96es invisibles au fonds du puits# a", /*spanish*/"unas #arañas invisibles# custodian una Skulltula que otorga"},
  });

    hintTable[BOTTOM_OF_THE_WELL_MQ_GS_COFFIN_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider crawling near the dead# in the well holds", /*french*/"une #Skulltula pr\x95s des cercueils au fonds du puits# a", /*spanish*/"una #Skulltula junto a los muertos# del pozo otorga"},
  });
    ...
    hintTable[ICE_CAVERN_GS_PUSH_BLOCK_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider above icy pits# holds", /*french*/"une #Skulltula au dessus d'un goufre glacial# a", /*spanish*/"una #Skulltula sobre g\x96lidos vacíos# otorga"},
  });

    hintTable[ICE_CAVERN_GS_SPINNING_SCYTHE_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"#spinning ice# guards a spider holding", /*french*/"une #Skulltula pr\x95s de deux lames de glace# a", /*spanish*/"unos #t\x96mpanos giratorios# custodian una Skulltula que otorga"},
  });

    hintTable[ICE_CAVERN_GS_HEART_PIECE_ROOM] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider behind a wall of ice# hides", /*french*/"une #Skulltula derri\x95re un mur de glace# a", /*spanish*/"una #Skulltula tras una g\x96lida pared# otorga"},
  });
    ...
    hintTable[ICE_CAVERN_MQ_GS_ICE_BLOCK] = HintText::Exclude({
                       //obscure text
                       Text{"a #web of ice# surrounds a spider with", /*french*/"une #Skulltula prot\x96g\x96e d'une toile glac\x96e# a", /*spanish*/"una #g\x96lida red# rodea a una Skulltula que otorga"},
  });

    hintTable[ICE_CAVERN_MQ_GS_RED_ICE] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider in fiery ice# hoards", /*french*/"une #Skulltula fig\x96e dans la glace rouge# a", /*spanish*/"una #Skulltula tras un ardiente hielo# otorga"},
  });
    ...
    hintTable[LLR_GS_BACK_WALL] = HintText::Exclude({
                       //obscure text
                       Text{"night reveals a #spider in a ranch# holding", /*french*/"une #Skulltula sur la fa\x94ade de la ferme# a", /*spanish*/"la noche revela una #Skulltula del rancho# que otorga"},
  });
    ...
    hintTable[LLR_GS_TREE] = HintText::Exclude({
                       //obscure text
                       Text{"a spider hiding in a #ranch tree# holds", /*french*/"une #Skulltula dans l'arbre de la ferme# a", /*spanish*/"una Skulltula escondida en el #\x91rbol de un rancho# otorga"},
  });


    hintTable[KF_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider buried in a forest# holds", /*french*/"une #Skulltula enterr\x96e dans la forêt# a", /*spanish*/"una #Skulltula enterrada en un bosque# otorga"},
  });

    hintTable[KF_GS_KNOW_IT_ALL_HOUSE] = HintText::Exclude({
                       //obscure text
                       Text{"night in the past reveals a #spider in a forest# holding", /*french*/"une #Skulltula derri\x95re une cabane de la forêt# a", /*spanish*/"la noche revela en el pasado una #Skulltula del bosque# que otorga"},
  });
    ...
    hintTable[LW_GS_BEAN_PATCH_NEAR_BRIDGE] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider buried deep in a forest maze# holds", /*french*/"une #Skulltula enterr\x96e dans les bois# a", /*spanish*/"una #Skulltula enterrada en un laberinto forestal# otorga"},
  });
    ...
    hintTable[LW_GS_ABOVE_THEATER] = HintText::Exclude({
                       //obscure text
                       Text{"night reveals a #spider deep in a forest maze# holding", /*french*/"une #Skulltula haut perch\x96e dans les bois# a", /*spanish*/"la noche revela una #Skulltula del laberinto forestal# que otorga"},
  });
    ...
    hintTable[OGC_GS] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider outside a tyrant's tower# holds", /*french*/"une #Skulltula parmi les ruines du ch\x92teau# a", /*spanish*/"una #Skulltula a las afueras de la torre de un tirano# otorga"},
  });

    hintTable[HC_GS_TREE] = HintText::Exclude({
                       //obscure text
                       Text{"a spider hiding in a #tree outside of a castle# holds", /*french*/"une #Skulltula dans l'arbre pr\x95s du ch\x92teau# a", /*spanish*/"una Skulltula escondida en el #\x91rbol de las afueras de un castillo# otorga"},
  });
    ...
    hintTable[DMC_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider buried in a volcano# holds", /*french*/"une #Skulltula enterr\x96e dans un volcan# a", /*spanish*/"una #Skulltula enterrada en un volc\x91n# otorga"},
  });


    hintTable[DMT_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider buried outside a cavern# holds", /*french*/"une #Skulltula enterr\x96e pr\x95s d'une caverne# a", /*spanish*/"una #Skulltula enterrada a la entrada de una cueva# otorga"},
  });

    hintTable[DMT_GS_NEAR_KAK] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider hidden in a mountain nook# holds", /*french*/"une #Skulltula cach\x96e dans le flanc d'une montagne# a", /*spanish*/"una #Skulltula oculta en el rincón de la montaña# otorga"},
  });

    hintTable[DMT_GS_ABOVE_DODONGOS_CAVERN] = HintText::Exclude({
                       //obscure text
                       Text{"the hammer reveals a #spider on a mountain# holding", /*french*/"une #Skulltula derri\x95re un rocher massif pr\x95s d'une caverne# a", /*spanish*/"el martillo revela #una Skulltula de la montaña# que otorga"},
  });

    hintTable[DMT_GS_FALLING_ROCKS_PATH] = HintText::Exclude({
                       //obscure text
                       Text{"the hammer reveals a #spider on a mountain# holding", /*french*/"une #Skulltula derri\x95re un rocher massif pr\x95s du sommet d'un volcan# a", /*spanish*/"el martillo revela #una Skulltula de la montaña# que otorga"},
  });


    hintTable[GC_GS_CENTER_PLATFORM] = HintText::Exclude({
                       //obscure text
                       Text{"a #suspended spider# in Goron City holds", /*french*/"une #Skulltula perch\x96e dans le village Goron# a", /*spanish*/"una #Skulltula suspendida# en la Ciudad Goron otorga"},
  });
    ...
    hintTable[KAK_GS_WATCHTOWER] = HintText::Exclude({
                       //obscure text
                       Text{"night in the past reveals a #spider in a town# holding", /*french*/"une #Skulltula sur une \x96chelle dans un village# a", /*spanish*/"la noche del pasado revela una #Skulltula del pueblo# que otorga"},
  });
    ...
    hintTable[GRAVEYARD_GS_WALL] = HintText::Exclude({
                       //obscure text
                       Text{"night reveals a #spider in a graveyard# holding", /*french*/"une #Skulltula sur une fa\x94ade du cimeti\x95re# a", /*spanish*/"la noche revela una #Skulltula del cementerio# que otorga"},
  });

    hintTable[GRAVEYARD_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider buried in a graveyard# holds", /*french*/"une #Skulltula enterr\x96e dans le cimeti\x95re# a", /*spanish*/"una #Skulltula enterrada en el cementerio# otorga"},
  });


    hintTable[ZR_GS_LADDER] = HintText::Exclude({
                       //obscure text
                       Text{"night in the past reveals a #spider in a river# holding", /*french*/"une #Skulltula sur une \x96chelle pr\x95s d'une cascade# a", /*spanish*/"la noche del pasado revela una #Skulltula del río# que otorga"},
  });

    hintTable[ZR_GS_TREE] = HintText::Exclude({
                       //obscure text
                       Text{"a spider hiding in a #tree by a river# holds", /*french*/"une #Skulltula dans un arbre pr\x95s du fleuve# a", /*spanish*/"una Skulltula escondida en el #\x91rbol de un río# otorga"},
  });

    hintTable[ZR_GS_ABOVE_BRIDGE] = HintText::Exclude({
                       //obscure text
                       Text{"night in the future reveals a #spider in a river# holding", /*french*/"une #Skulltula sur une fa\x94ade pr\x95s d'une cascade# a", /*spanish*/"la noche del futuro revela una #Skulltula del río# que otorga"},
  });

    hintTable[ZR_GS_NEAR_RAISED_GROTTOS] = HintText::Exclude({
                       //obscure text
                       Text{"night in the future reveals a #spider in a river# holding", /*french*/"une #Skulltula sur une fa\x94ade pr\x95s d'une grotte du fleuve# a", /*spanish*/"la noche del futuro revela una #Skulltula del río# que otorga"},
  });


    hintTable[ZD_GS_FROZEN_WATERFALL] = HintText::Exclude({
                       //obscure text
                       Text{"night reveals a #spider by a frozen waterfall# holding", /*french*/"une #Skulltula pr\x95s d'une cascade gel\x96e# a", /*spanish*/"la noche revela una #Skulltula junto a una congelada cascada# que otorga"},
  });

    hintTable[ZF_GS_ABOVE_THE_LOG] = HintText::Exclude({
                       //obscure text
                       Text{"night reveals a #spider near a deity# holding", /*french*/"une #Skulltula pr\x95s du gardien aquatique# a", /*spanish*/"la noche revela una #Skulltula junto a cierta deidad# que otorga"},
  });

    hintTable[ZF_GS_TREE] = HintText::Exclude({
                       //obscure text
                       Text{"a spider hiding in a #tree near a deity# holds", /*french*/"une #Skulltula dans un arbre dans un r\x96servoir# a", /*spanish*/"una Skulltula escondida en el #\x91rbol junto a cierta deidad# otorga"},
  });


    hintTable[LH_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider buried by a lake# holds", /*french*/"une #Skulltula enterr\x96e pr\x95s d'un lac# a", /*spanish*/"una #Skulltula enterrada junto a un lago# otorga"},
  });
    ...
    hintTable[LH_GS_TREE] = HintText::Exclude({
                       //obscure text
                       Text{"night reveals a #spider by a lake high in a tree# holding", /*french*/"une #Skulltula dans un grand arbre du lac# a", /*spanish*/"la noche revela #una Skulltula del lago sobre un \x91rbol# que otorga"},
  });


    hintTable[GV_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider buried in a valley# holds", /*french*/"une #Skulltula enterr\x96 dans une vall\x96e# a", /*spanish*/"una #Skulltula enterrada en un valle# otorga"},
  });
    ...
    hintTable[GV_GS_PILLAR] = HintText::Exclude({
                       //obscure text
                       Text{"night in the future reveals a #spider in a valley# holding", /*french*/"une #Skulltula sur une arche de pierre dans une vall\x96e# a", /*spanish*/"la noche del futuro revela una #Skulltula del valle# que otorga"},
  });

    hintTable[GV_GS_BEHIND_TENT] = HintText::Exclude({
                       //obscure text
                       Text{"night in the future reveals a #spider in a valley# holding", /*french*/"une #Skulltula derri\x95re une tente# a", /*spanish*/"la noche del futuro revela una #Skulltula del valle# que otorga"},
  });
    ...
    hintTable[COLOSSUS_GS_BEAN_PATCH] = HintText::Exclude({
                       //obscure text
                       Text{"a #spider buried in the desert# holds", /*french*/"une #Skulltula enterr\x96e au pied du colosse# a", /*spanish*/"una #Skulltula enterrada en el desierto# otorga"},
  });

    hintTable[COLOSSUS_GS_HILL] = HintText::Exclude({
                       //obscure text
                       Text{"night reveals a #spider deep in the desert# holding", /*french*/"une #Skulltula sur une colline dans le d\x96sert# a", /*spanish*/"la noche revela una #Skulltula en las profundidades del desierto# que otorga"},
  });

    hintTable[COLOSSUS_GS_TREE] = HintText::Exclude({
                       //obscure text
                       Text{"night reveals a #spider deep in the desert# holding", /*french*/"une #Skulltula dans un arbre du d\x96sert# a", /*spanish*/"la noche revela una #Skulltula en las profundidades del desierto# que otorga"},
  });
    ...
    hintTable[MARKET_POTION_SHOP_ITEM_1] = HintText::Exclude({
                       ...
                       //clear text
                       Text{"the #Market Potion Shop# offers", /*french*/"l'#apothicaire dans la place du march\x96# vend", /*spanish*/"la #tienda de pociones del mercado# ofrece"}
  );
    ...
    hintTable[MARKET_BAZAAR_ITEM_1] = HintText::Exclude({
                       //obscure text
                       Text{"the #Market Bazaar# offers", /*french*/"le #bazar de la place du march\x96# vend", /*spanish*/"el #bazar del mercado# ofrece"},
  });
    ...
    hintTable[LLR_DEKU_SCRUB_GROTTO_LEFT] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo \x90 la ferme# vend", /*spanish*/"un #trío de dekus# de una granja venden"},
  });
    ...
    hintTable[LW_DEKU_SCRUB_NEAR_DEKU_THEATER_RIGHT] = HintText::Exclude({
                       //obscure text
                       Text{"a pair of #scrubs in the woods# sells", /*french*/"le #duo de peste Mojo pr\x95s du th\x96\x92tre# vend", /*spanish*/"un par de #dekus del bosque# venden"},
  });
    ...
    hintTable[LW_DEKU_SCRUB_NEAR_BRIDGE] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub by a bridge# sells", /*french*/"la #peste Mojo pr\x95s du pont dans les bois# vend", /*spanish*/"un #deku bajo un puente# del bosque venden"},
  });

    hintTable[LW_DEKU_SCRUB_GROTTO_REAR] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub underground duo# sells", /*french*/"le #duo de peste Mojo dans les sous-bois# vend", /*spanish*/"un #par de dekus subterr\x91neos# del bosque venden"},
  });
    ...
    hintTable[SFM_DEKU_SCRUB_GROTTO_REAR] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub underground duo# sells", /*french*/"le #duo de peste Mojo au cœur du sanctuaire sylvestre# vend", /*spanish*/"un #par de dekus subterr\x91neos# de la pradera sagrada venden"},
  });
    ...
    hintTable[DODONGOS_CAVERN_DEKU_SCRUB_LOBBY] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub in Dodongo's Cavern# sells", /*french*/"la #peste Mojo dans l'entr\x96e de la caverne Dodongo# vend", /*spanish*/"un #deku en la Cueva de los Dodongos# vende"},
  });


    hintTable[DODONGOS_CAVERN_MQ_DEKU_SCRUB_LOBBY_REAR] = HintText::Exclude({
                       //obscure text
                       Text{"a pair of #scrubs in Dodongo's Cavern# sells", /*french*/"le #duo de peste Mojo dans l'entr\x96e de la caverne Dodongo# vend", /*spanish*/"un #par de dekus en la Cueva de los Dodongos# venden"},
  });
    ...
    hintTable[DMC_DEKU_SCRUB_GROTTO_LEFT] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo dans le volcan# vend", /*spanish*/"un #trío de dekus# del volc\x91n venden"},
  });
    ...
    hintTable[ZR_DEKU_SCRUB_GROTTO_REAR] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub underground duo# sells", /*french*/"le #duo de peste Mojo pr\x95s du fleuve# vend", /*spanish*/"un #par de dekus subterr\x91neos# del río venden"},
  });
    ...
    hintTable[LH_DEKU_SCRUB_GROTTO_LEFT] = HintText::Exclude({
                       //obscure text
                       Text{"a #trio of scrubs# sells", /*french*/"le #trio de peste Mojo pr\x95s du lac# vend", /*spanish*/"un #trío de dekus# del lago venden"},
  });
    ...
    hintTable[GV_DEKU_SCRUB_GROTTO_REAR] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub underground duo# sells", /*french*/"le #duo de peste Mojo pr\x95s de la vall\x96e# vend", /*spanish*/"un #par de dekus subterr\x91neos# del valle venden"},
  });
    ...
    hintTable[COLOSSUS_DEKU_SCRUB_GROTTO_FRONT] = HintText::Exclude({
                       //obscure text
                       Text{"a #scrub underground duo# sells", /*french*/"le #duo de peste Mojo dans le d\x96sert# vend", /*spanish*/"un #par de dekus subterr\x91neos# del desierto venden"},
  });
    ...
    hintTable[GANONS_CASTLE_DEKU_SCRUB_CENTER_LEFT] = HintText::Exclude({
                       //obscure text
                       Text{"#scrubs in Ganon's Castle# sell", /*french*/"les #pestes Mojo dans le ch\x92teau de Ganon# vendent", /*spanish*/"los #dekus del Castillo de Ganon# venden"},
  });
    ...
    hintTable[LLR_STABLES_LEFT_COW] = HintText::Exclude({
                       //obscure text
                       Text{"a #cow in a stable# gifts", /*french*/"la #vache dans l'\x96table# donne", /*spanish*/"una #vaca del establo# brinda"},
  });
    ...
    hintTable[DESERT_COLOSSUS_TO_COLOSSUS_GROTTO] = HintText::Entrance({
                     //obscure text
                     Text{"lifting a #rock in the desert# reveals", /*french*/"soulever une #roche dans le d\x96sert# r\x96v\x95le", /*spanish*/"levantar una #roca del desierto# revela"},
  });

    hintTable[GV_GROTTO_LEDGE_TO_GV_OCTOROK_GROTTO] = HintText::Entrance({
                     //obscure text
                     Text{"a rock on #a ledge in the valley# hides", /*french*/"soulever une #roche dans la vall\x96e# r\x96v\x95le", /*spanish*/"levantar una #roca al borde del valle# esconde"},
  });

    hintTable[GC_GROTTO_PLATFORM_TO_GC_GROTTO] = HintText::Entrance({
                     //obscure text
                     Text{"a #pool of lava# in Goron City blocks the way to", /*french*/"l'#\x96tang de lave# dans le village Goron renferme", /*spanish*/"un #estanque de lava# en la Ciudad Goron bloquea el paso a"},
  });

    hintTable[GERUDO_FORTRESS_TO_GF_STORMS_GROTTO] = HintText::Entrance({
                     //obscure text
                     Text{"a #storm within Gerudo's Fortress# reveals", /*french*/"la #tempête dans la forteresse# r\x96v\x95le", /*spanish*/"una #tormenta en la Fortaleza Gerudo# revela"},
  });

    hintTable[ZORAS_DOMAIN_TO_ZD_STORMS_GROTTO] = HintText::Entrance({
                     //obscure text
                     Text{"a #storm within Zora's Domain# reveals", /*french*/"la #tempête dans le domaine des Zoras# r\x96v\x95le", /*spanish*/"una #tormenta en la Región de los Zora# revela"},
  });

    hintTable[HYRULE_CASTLE_GROUNDS_TO_HC_STORMS_GROTTO] = HintText::Entrance({
                     //obscure text
                     Text{"a #storm near the castle# reveals", /*french*/"la #tempête pr\x95s du ch\x92teau# r\x96v\x95le", /*spanish*/"una #tormenta junto al castillo# revela"},
  });

    hintTable[GV_FORTRESS_SIDE_TO_GV_STORMS_GROTTO] = HintText::Entrance({
                     //obscure text
                     Text{"a #storm in the valley# reveals", /*french*/"la #tempête dans la vall\x96e# r\x96v\x95le", /*spanish*/"una #tormenta en el valle# revela"},
  });

    hintTable[DESERT_COLOSSUS_TO_COLOSSUS_GREAT_FAIRY_FOUNTAIN] = HintText::Entrance({
                     //obscure text
                     Text{"a #fractured desert wall# hides", /*french*/"le #mur fragile du d\x96sert# cache", /*spanish*/"una #agrietada pared del desierto# esconde"},
  });

    hintTable[GANONS_CASTLE_GROUNDS_TO_OGC_GREAT_FAIRY_FOUNTAIN] = HintText::Entrance({
                     //obscure text
                     Text{"a #heavy pillar# outside the castle obstructs", /*french*/"le #rocher fragile pr\x95s du ch\x92teau# cache", /*spanish*/"una #pesada columna# fuera del castillo obstruye"},
  });

    hintTable[ZORAS_FOUNTAIN_TO_ZF_GREAT_FAIRY_FOUNTAIN] = HintText::Entrance({
                     //obscure text
                     Text{"a #fountain wall# hides", /*french*/"le #mur fragile du r\x96servoir# cache", /*spanish*/"una #pared de la fuente# esconde"},
  });

    hintTable[GV_FORTRESS_SIDE_TO_GV_CARPENTER_TENT] = HintText::Entrance({
                     //obscure text
                     Text{"a #tent in the valley# covers", /*french*/"la #tente dans la vall\x96e# recouvre", /*spanish*/"una #tienda de campaña del valle# cubre"},
  });
    ...
    hintTable[GERUDO_FORTRESS_TO_GERUDO_TRAINING_GROUNDS_LOBBY] = HintText::Entrance({
                     //obscure text
                     Text{"paying a #fee to the Gerudos# grants access to", /*french*/"l'#entr\x96e payante des Gerudo# donne acc\x95s \x90", /*spanish*/"pagarle una #tasa a las gerudo# da acceso a"},
  });
    ...
    hintTable[THE_LOST_WOODS] = HintText::Exclude({
                     //obscure text
                     Text{"the Lost Woods", /*french*/"la forêt des m\x96andres", /*spanish*/"el Bosque Perdido"},
  });

    hintTable[SACRED_FOREST_MEADOW] = HintText::Exclude({
                     //obscure text
                     Text{"Sacred Forest Meadow", /*french*/"le bosquet sacr\x96", /*spanish*/"la pradera sagrada del bosque"},
  });
    ...
    hintTable[GERUDO_VALLEY] = HintText::Exclude({
                     //obscure text
                     Text{"Gerudo Valley", /*french*/"la vall\x96e Gerudo", /*spanish*/"el Valle Gerudo"},
  });
    ...
    hintTable[HAUNTED_WASTELAND] = HintText::Exclude({
                     //obscure text
                     Text{"Haunted Wasteland", /*french*/"le d\x96sert hant\x96", /*spanish*/"el desierto encantado"},
  });

    hintTable[DESERT_COLOSSUS] = HintText::Exclude({
                     //obscure text
                     Text{"Desert Colossus", /*french*/"le colosse du d\x96sert", /*spanish*/"el Coloso del Desierto"},
  });

    hintTable[THE_MARKET] = HintText::Exclude({
                     //obscure text
                     Text{"the Market", /*french*/"la place du march\x96", /*spanish*/"la plaza del mercado"},
  });
    ...
    hintTable[HYRULE_CASTLE] = HintText::Exclude({
                     //obscure text
                     Text{"Hyrule Castle", /*french*/"le ch\x92teau d'Hyrule", /*spanish*/"el Castillo de Hyrule"},
  });

    hintTable[OUTSIDE_GANONS_CASTLE] = HintText::Exclude({
                     //obscure text
                     Text{"outside Ganon's Castle", /*french*/"les alentours du ch\x92teau de Ganon", /*spanish*/"el exterior del Castillo de Ganon"},
  });
    ...
    hintTable[THE_GRAVEYARD] = HintText::Exclude({
                     //obscure text
                     Text{"the Graveyard", /*french*/"le cimeti\x95re", /*spanish*/"el cementerio"},
  });
    ...
    hintTable[DEATH_MOUNTAIN_CRATER] = HintText::Exclude({
                     //obscure text
                     Text{"Death Mountain Crater", /*french*/"le crat\x95re du mont de la Mort", /*spanish*/"el cr\x91ter de la Montaña de la Muerte"},
  });
  ...
  // });
    ...
    hintTable[KF_KNOW_IT_ALL_HOUSE] = HintText::Region({
                     //obscure text
                     Text{"Know-It-All Brothers' House", /*french*/"la #cabane des fr\x95res Je-Sais-Tout#", /*spanish*/"la casa de los hermanos Sabelotodo"},
  });
    ...
    hintTable[LH_FISHING_HOLE] = HintText::Region({
                     //obscure text
                     Text{"the #Fishing Pond#", /*french*/"l'#\x96tang#", /*spanish*/"el estanque"},
  });
    ...
    hintTable[MARKET_MASK_SHOP] = HintText::Region({
                     //obscure text
                     Text{"the #Happy Mask Shop#", /*french*/"la #foire aux masques#", /*spanish*/"la tienda de La M\x91scara Feliz"},
  });
    ...
    hintTable[MARKET_POTION_SHOP] = HintText::Region({
                     //obscure text
                     Text{"the #Market Potion Shop#", /*french*/"l'#apothicaire de la place du march\x96#", /*spanish*/"la tienda de pociones de la plaza del mercado"},
  });

    hintTable[MARKET_TREASURE_CHEST_GAME] = HintText::Region({
                     //obscure text
                     Text{"the #Treasure Chest Shop#", /*french*/"la #chasse aux tr\x96sors#", /*spanish*/"el Cofre del Tesoro"},
  });
    ...
    hintTable[KAK_IMPAS_HOUSE_BACK] = HintText::Region({
                     //obscure text
                     Text{"Impa's cow cage", /*french*/"la #cage \x90 vache d'Impa#", /*spanish*/"la jaula de la vaca de Impa"},
  });
    ...
    hintTable[GRAVEYARD_DAMPES_HOUSE] = HintText::Region({
                     //obscure text
                     Text{"Damp\x96's Hut", /*french*/"la #cabane du fossoyeur#", /*spanish*/"la cabaña de Damp\x96"},
  });
    ...
    hintTable[LLR_STABLES] = HintText::Region({
                     //obscure text
                     Text{"a #stable#", /*french*/"l'#\x96table#", /*spanish*/"el establo"},
  });
    ...
    hintTable[MARKET_BAZAAR] = HintText::Region({
                     //obscure text
                     Text{"the #Market Bazaar#", /*french*/"le #bazar de la place du march\x96#", /*spanish*/"el bazar de la plaza del mercado"},
  });

    hintTable[MARKET_SHOOTING_GALLERY] = HintText::Region({
                     //obscure text
                     Text{"a #Slingshot Shooting Gallery#", /*french*/"le #jeu d'adresse de la place du march\x96#", /*spanish*/"el Tiro al Blanco con tirachinas"},
  });
    ...
    hintTable[COLOSSUS_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
                     //obscure text
                     Text{"a #Great Fairy Fountain#", /*french*/"la #grande f\x96e du colosse#", /*spanish*/"una fuente de la Gran Hada"},
  });

    hintTable[HC_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
                     //obscure text
                     Text{"a #Great Fairy Fountain#", /*french*/"la #grande f\x96e du ch\x92teau#", /*spanish*/"una fuente de la Gran Hada"},
  });

    hintTable[OGC_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
                     //obscure text
                     Text{"a #Great Fairy Fountain#", /*french*/"la #grande f\x96e des ruines#", /*spanish*/"una fuente de la Gran Hada"},
  });

    hintTable[DMC_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
                     //obscure text
                     Text{"a #Great Fairy Fountain#", /*french*/"la #grande f\x96e du volcan#", /*spanish*/"una fuente de la Gran Hada"},
  });

    hintTable[DMT_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
                     //obscure text
                     Text{"a #Great Fairy Fountain#", /*french*/"la #grande f\x96e de la montagne#", /*spanish*/"una fuente de la Gran Hada"},
  });

    hintTable[ZF_GREAT_FAIRY_FOUNTAIN] = HintText::Region({
                     //obscure text
                     Text{"a #Great Fairy Fountain#", /*french*/"la #grande f\x96e de la fontaine#", /*spanish*/"una fuente de la Gran Hada"},
  });

    hintTable[GRAVEYARD_SHIELD_GRAVE] = HintText::Region({
                     //obscure text
                     Text{"a #grave with a free chest#", /*french*/"le #tombeau avec un tr\x96sor#", /*spanish*/"la #tumba con un cofre#"},
  });
    ...
    hintTable[GRAVEYARD_DAMPES_GRAVE] = HintText::Region({
                     //obscure text
                     Text{"Damp\x96's Grave", /*french*/"la #tombe d'Igor#", /*spanish*/"la #tumba de Damp\x96#"},
  });
    ...
    hintTable[HC_STORMS_GROTTO] = HintText::Region({
                     //obscure text
                     Text{"a sandy grotto with #fragile walls#", /*french*/"la #grotte avec des murs fragiles#", /*spanish*/"la arenosa gruta de #fr\x91giles paredes#"},
  });

    hintTable[HF_TEKTITE_GROTTO] = HintText::Region({
                     //obscure text
                     Text{"a pool guarded by a #Tektite#", /*french*/"l'#\x96tang sous-terrain avec un Araknon#", /*spanish*/"un charco custodiado por un #Tektite#"},
  });

    hintTable[HF_NEAR_KAK_GROTTO] = HintText::Region({
                     //obscure text
                     Text{"a #Big Skulltula# guarding a Gold one", /*french*/"la #grotte d'araign\x96es#", /*spanish*/"una #gran Skulltula# custodiando una dorada"},
  });

    hintTable[HF_COW_GROTTO] = HintText::Region({
                     //obscure text
                     Text{"a grotto full of #spider webs#", /*french*/"la #grotte couverte de toiles d'araign\x96es#", /*spanish*/"una gruta llena de #telarañas#"},
  });
    ...
    hintTable[GV_OCTOROK_GROTTO] = HintText::Region({
                     //obscure text
                     Text{"an #Octorok# guarding a rich pool", /*french*/"un #\x96tang sous-terrain avec un Octorok#", /*spanish*/"un #Octorok# que custodia un lujoso charco"},
  });

    hintTable[DEKU_THEATER] = HintText::Region({
                     //obscure text
                     Text{"the #Lost Woods Stage#", /*french*/"le #th\x96\x92tre sylvestre#", /*spanish*/"el #escenario del Bosque Perdido#"},
  });

    hintTable[ZR_OPEN_GROTTO] = HintText::Region({
                     //obscure text
                     Text{"a #generic grotto#", /*french*/"une #grotte avec un tr\x96sor#", /*spanish*/"una #cueva gen\x96rica#"},
  });
    ...
    hintTable[ZR_FAIRY_GROTTO] = HintText::Region({
                     //obscure text
                     Text{"a small #Fairy Fountain#", /*french*/"une #fontaine de f\x96es#", /*spanish*/"una pequeña #fuente de hadas#"},
  });
    ...
    hintTable[JUNK02] = HintText::Junk({
                     //obscure text
                     Text{"They say you must read the names of \"Special Deal\" shop items carefully.", /*french*/"Selon moi, les « Offres sp\x96ciales » sont parfois trompeuses... Lisez attentivement!", /*spanish*/"Según dicen, se debería prestar atención a los nombres de las ofertas especiales."},
    });
    ...
    hintTable[JUNK04] = HintText::Junk({
                     //obscure text
                     Text{"These hints can be quite useful. This is an exception.", /*french*/"Ces indices sont tr\x95s utiles, \x90 l'exception de celui-ci.", /*spanish*/"Las pistas suelen servir de ayuda. En cambio, esta no."},
    });

    hintTable[JUNK05] = HintText::Junk({
                     //obscure text
                     Text{"They say that the Lizalfos in Dodongo's Cavern like to play in lava.", /*french*/"Selon moi, les L\x96zalfos de la caverne Dodongo aiment patauger dans la lave.", /*spanish*/"Según dicen, a los Lizalfos de la Cueva de los Dodongos les gusta jugar en la lava."},
    });

    hintTable[JUNK06] = HintText::Junk({
                     //obscure text
                     Text{"They say that all the Zora drowned in Wind Waker.", /*french*/"Selon moi, les Zoras se sont noy\x96s dans Wind Waker.", /*spanish*/"Según dicen, en Wind Waker todos los zora se ahogaron."},
    });
    ...
    hintTable[JUNK08] = HintText::Junk({
                     //obscure text
                     Text{"'Member when Ganon was a blue pig?^I 'member.", /*french*/"Dans mon temps, Ganon \x96tait un cochon bleu...^Pff! Les jeunes de nos jours, et leur Ganondorf!", /*spanish*/"¿T'acuerdas cuando Ganon era un cerdo azul?^Qu\x96 tiempos, chico."},
    });

    hintTable[JUNK09] = HintText::Junk({
                     //obscure text
                     Text{"One who does not have Triforce can't go in.", /*french*/"Ceux sans Triforce doivent rebrousser chemin.", /*spanish*/"Aquel que no porte la Trifuerza no podr\x91 pasar."},
    });

    hintTable[JUNK10] = HintText::Junk({
                     //obscure text
                     Text{"Save your future, end the Happy Mask Salesman.", /*french*/"Selon moi, tu t'\x96viteras des jours de malheur si tu vaincs le vendeur de masques...", /*spanish*/"Salva tu futuro, acaba con el dueño de La M\x91scara Feliz."},
    });

    hintTable[JUNK11] = HintText::Junk({
                     //obscure text
                     Text{"Glitches are a pathway to many abilities some consider to be... Unnatural.", /*french*/"Les glitchs sont un moyen d'acqu\x96rir de nombreuses facult\x96s consid\x96r\x96es par certains comme... contraire \x90 la nature.", /*spanish*/"Los glitches son el camino a muchas habilidades que varios consideran... nada natural."},
    });
    ...
    hintTable[JUNK13] = HintText::Junk({
                     //obscure text
                     Text{"Hoot! Hoot! Would you like me to repeat that?", /*french*/"Hou hou! Veux-tu que je r\x96p\x95te tout \x94a?", /*spanish*/"¡Buuu, buuu! ¿Te lo vuelvo a repetir?"},
    });
    ...
    hintTable[JUNK15] = HintText::Junk({
                     //obscure text
                     Text{"They say that Lon Lon Ranch prospered under Ingo.", /*french*/"Selon moi, le ranch Lon Lon \x96tait plus prosp\x95re sous Ingo.", /*spanish*/"Según dicen, el Rancho Lon Lon prosperó gracias a Ingo."},
    });
    ...
    hintTable[JUNK17] = HintText::Junk({
                     //obscure text
                     Text{"Without the Lens of Truth, the Treasure Chest Mini-Game is a 1 out of 32 chance.^Good luck!", /*french*/"Gagner la chasse aux tr\x96sors est 1 chance sur 32.^Bonne chance!", /*spanish*/"Sin la Lupa de la Verdad, ganarías 1/32 veces en el Cofre del Tesoro.^¡Buena suerte con ello!"},
    });

    hintTable[JUNK18] = HintText::Junk({
                     //obscure text
                     Text{"Use bombs wisely.", /*french*/"Utilise les bombes avec pr\x96caution.", /*spanish*/"No desperdicies las bombas."},
    });

    hintTable[JUNK19] = HintText::Junk({
                     //obscure text
                     Text{"They say that Volvagia hates splinters", /*french*/"Selon moi, Volvagia d\x96teste les \x96chardes.", /*spanish*/"Según dicen, Volvagia le teme a las astillas."},
    });
    ...
    hintTable[JUNK21] = HintText::Junk({
                     //obscure text
                     Text{"I found you, faker!", /*french*/"Ah-ha! Je t'ai trouv\x96!", /*spanish*/"¡Ahí est\x91s, impostor!"},
    });

    hintTable[JUNK22] = HintText::Junk({
                     //obscure text
                     Text{"They say the Groose is loose.", /*french*/"Selon moi, Hergo est le vrai h\x96ros.", /*spanish*/"Según dicen, Malton es un espanto."},
    });
    ...
    hintTable[JUNK24] = HintText::Junk({
                     //obscure text
                     Text{"What happened to Sheik?", /*french*/"Donc... Qu'est-ce qui arrive avec Sheik?", /*spanish*/"¿Qu\x96 la habr\x91 pasado a Sheik?"},
    });
    ...
    hintTable[JUNK27] = HintText::Junk({
                     //obscure text
                     Text{"I'm Lonk from Pennsylvania.", /*french*/"Je suis Lonk, le h\x96ros de Pennsylvanie!", /*spanish*/"Soy Lonk, de Pensilvania."},
    });

    hintTable[JUNK28] = HintText::Junk({
                     //obscure text
                     Text{"I bet you'd like to have more bombs.", /*french*/"Je parie que tu veux plus de bombes.", /*spanish*/"Me apuesto a que quisieras tener m\x91s bombas."},
    });
    ...
    hintTable[JUNK31] = HintText::Junk({
                     //obscure text
                     Text{"Game Over. Return of Ganon.", /*french*/"Partie termin\x96e. RETOUR DE GANON.", /*spanish*/"Fin de la partida. El regreso de Ganon."},
    });

    hintTable[JUNK32] = HintText::Junk({
                     //obscure text
                     Text{"May the way of the Hero lead to the Triforce.", /*french*/"Que le chemin du h\x96ros te m\x95ne \x90 la Triforce.", /*spanish*/"Puede que la senda del h\x96roe te lleve hacia la Trifuerza."},
    });
    ...
    hintTable[JUNK34] = HintText::Junk({
                     //obscure text
                     Text{"They say this game has just a few glitches.", /*french*/"Selon moi, ce jeu est compl\x95tement exempt de glitchs.", /*spanish*/"Dicen que este juego apenas tiene glitches."},
    });

    hintTable[JUNK35] = HintText::Junk({
                     //obscure text
                     Text{"BRRING BRRING This is Ulrira. Wrong number?", /*french*/"DRING DRING!! P\x96p\x96 le Ramollo \x90 l'appareil... Quoi? Faux num\x96ro?", /*spanish*/"¡Ring! ¡Ring! Al habla Ulrira. ¿Me he equivocado de número?"},
    });
    ...
    hintTable[JUNK38] = HintText::Junk({
                     //obscure text
                     Text{"They say that Ganondorf will appear in the next Mario Tennis.", /*french*/"Selon moi, Ganondorf sera la nouvelle recrue dans Mario Tennis.", /*spanish*/"Según dicen, Ganondorf estar\x91 en el próximo Mario Tennis."},
    });

    hintTable[JUNK39] = HintText::Junk({
                     //obscure text
                     Text{"Medigoron sells the earliest Breath of the Wild demo.", /*french*/"Selon moi, Medigoron vend une d\x96mo de #Breath of the Wild#.", /*spanish*/"Medigoron vende la primera demo del Breath of the Wild."},
    });

    hintTable[JUNK40] = HintText::Junk({
                     //obscure text
                     Text{"Can you move me? I don't get great service here.", /*french*/"Peux-tu me d\x96placer? J'ai pas une bonne r\x96ception ici.", /*spanish*/"¿Puedes llevarme a otro lado? Aquí nadie me presta atención."},
    });
    ...
    hintTable[JUNK43] = HintText::Junk({
                     //obscure text
                     Text{"Dear @, please come to the castle. I've baked a cake for you.&Yours truly, Princess Zelda.", /*french*/"Mon tr\x95s cher @:&Viens vite au ch\x92teau, je t'ai pr\x96par\x96 un d\x96licieux g\x92teau...&À bientôt, Princesse Zelda", /*spanish*/"Querido @: Por favor, ven al castillo. He hecho una tarta para ti.&Sinceramente tuya: Princesa Zelda."},
    });
    ...
    hintTable[JUNK45] = HintText::Junk({
                     //obscure text
                     Text{"You thought it would be a useful hint, but it was me, junk hint!", /*french*/"Tu t'attendais \x90 un bon indice... Mais c'\x96tait moi, un mauvais indice!", /*spanish*/"Je... Creeías que iba a ser una piedra de utilidad, ¡pero no, era yo, la piedra de la agonía!"},
    });

    hintTable[JUNK46] = HintText::Junk({
                     //obscure text
                     Text{"They say that quest guidance can be found at a talking rock.", /*french*/"Selon moi, des #indices# se trouvent aupr\x95s d'une pierre parlante... Duh!", /*spanish*/"Según dicen, puedes consultarle ayuda a rocas parlanchinas."},
    });
    ...
    hintTable[JUNK49] = HintText::Junk({
                     //obscure text
                     Text{"They say that Barinade fears Deku Nuts.", /*french*/"Selon moi, Barinade a la frousse des noix Mojo.", /*spanish*/"Según dicen, lo que m\x91s teme a Barinade son las nueces deku."},
    });
    ...
    hintTable[JUNK51] = HintText::Junk({
                     //obscure text
                     Text{"They say that Morpha is easily trapped in a corner.", /*french*/"Selon moi, Morpha est facilement coinc\x96.", /*spanish*/"Según dicen, puedes atrapar a Morpha con facilidad en una esquina."},
    });
    ...
    hintTable[JUNK53] = HintText::Junk({
                     //obscure text
                     Text{"They say that your sword is most powerful when you put it away.", /*french*/"Selon moi, ton \x96p\x96e est \x90 pleine puissance quand tu la rengaines.", /*spanish*/"Según dicen, tu espada se vuelve m\x91s poderosa si la guardas."},
    });

    hintTable[JUNK54] = HintText::Junk({
                     //obscure text
                     Text{"They say that bombing the hole Volvagia last flew into can be rewarding.", /*french*/"Selon moi, le trou o\x9C se creuse Volvagia est vuln\x96rable aux bombes.", /*spanish*/"Según dicen, trae buena suerte colocar una bomba en el último agujero de donde salió Volvagia."},
    });
    ...
    hintTable[JUNK57] = HintText::Junk({
                     //obscure text
                     Text{"They say that walking backwards is very fast.", /*french*/"Selon moi, tu fais marche arri\x95re tr\x95s rapidement pour un h\x96ros.", /*spanish*/"Según dicen, es m\x91s r\x91pido caminar hacia atr\x91s."},
    });
    ...
    hintTable[JUNK59] = HintText::Junk({
                     //obscure text
                     Text{"They say Ingo is not very good at planning ahead.", /*french*/"Selon moi, Ingo ne fait pas un tr\x95s bon geôlier.", /*spanish*/"Según dicen, a Ingo no se le da especialmente bien planificar con antelación."},
    });

    hintTable[JUNK60] = HintText::Junk({
                     //obscure text
                     Text{"You found a spiritual Stone! By which I mean, I worship Nayru.", /*french*/"Vous avez trouv\x96 une pierre spirituelle! En effet, je v\x96n\x95re la d\x96esse Hylia.", /*spanish*/"¡Has encontrado una piedra espiritual! Es que le rindo culto a Nayru..."},
    });

    hintTable[JUNK61] = HintText::Junk({
                     //obscure text
                     Text{"They say that a flying strike with a Deku Stick is no stronger than a grounded one.", /*french*/"Selon moi, un coup de b\x92ton saut\x96 n'est pas meilleur qu'au sol.", /*spanish*/"Según dicen, los golpes a\x96reos con palos deku son tan fuertes como los normales."},
    });

    hintTable[JUNK62] = HintText::Junk({
                     //obscure text
                     Text{"Open your eyes.^Open your eyes.^Wake up, @.", /*french*/"R\x96veille-toi...^R\x96veille-toi.^Ouvre les yeux, @.", /*spanish*/"Abre los ojos...^Abre los ojos...^Despierta, @..."},
    });

    hintTable[JUNK63] = HintText::Junk({
                     //obscure text
                     Text{"They say that the Nocturne of Shadow can bring you very close to Ganon.", /*french*/"Selon moi, le nocturne de l'ombre peut t'amener tr\x95s pr\x95s de Ganon.", /*spanish*/"Según dicen, el Nocturno de la sombra te puede acercar mucho a Ganon."},
    });
    ...
    hintTable[JUNK66] = HintText::Junk({
                     //obscure text
                     Text{"You're playing a Randomizer. I'm randomized!^Here's a random number:  #4#.&Enjoy your Randomizer!", /*french*/"Tu joues \x90 un randomizer. Je suis al\x96atoire!^Voici un nombre al\x96atoire: #4#.&Bonne partie!", /*spanish*/"¡Est\x91s jugando un Randomizer! ¡Yo tambi\x96n estoy aleatorizada!^Aquí tienes un número aleatorio:  #8#.&¡Divi\x96rtete!"},
    });

    hintTable[JUNK67] = HintText::Junk({
                     //obscure text
                     Text{"They say Ganondorf's bolts can be reflected with glass or steel.", /*french*/"Selon moi, les \x96clairs de Ganon se refl\x95tent sur l'acier et le verre.", /*spanish*/"Según dicen, puedes reflejar las esferas de energía de Ganondorf con cristal y acero."},
    });

    hintTable[JUNK68] = HintText::Junk({
                     //obscure text
                     Text{"They say Ganon's tail is vulnerable to nuts, arrows, swords, explosives, hammers...^...sticks, seeds, boomerangs...^...rods, shovels, iron balls, angry bees...", /*french*/"Selon moi, la queue de Ganon est vuln\x96rable aux noix, fl\x95ches, \x96p\x96es, bombes, marteaux...^...b\x92tons, graines, boomerangs...^...baguettes, pelles, boulets de fer, abeilles enrag\x96es...", /*spanish*/"Según dicen, la cola de Ganon es vulnerable a nueces, flechas, espadas, explosivos, martillos...^...palos, semillas, bumer\x91ns...^...cetros, palas, bolas de hierro, abejas..."},
    });

    hintTable[JUNK69] = HintText::Junk({
                     //obscure text
                     Text{"They say that you're wasting time reading this hint, but I disagree. Talk to me again!", /*french*/"Selon moi... tu sais quoi? Parle-moi encore, et je te le dirai!", /*spanish*/"Según dicen, pierdes el tiempo en leer esta pista, pero no pienso igual. ¡Vuelve a hablarme, ya ver\x91s!"},
    });

    hintTable[JUNK70] = HintText::Junk({
                     //obscure text
                     Text{"They say Ganondorf knows where to find the instrument of his doom.", /*french*/"Selon moi, Ganondorf sait o\x9C il a cach\x96 son point faible.", /*spanish*/"Según dicen, Ganondorf sabe dónde hallar el instrumento de su perdición."},
    });

    hintTable[JUNK71] = HintText::Junk({
                     //obscure text
                     Text{"I heard @ is pretty good at Zelda.", /*french*/"Apparemment, @ est super bon \x90 Zelda.", /*spanish*/"He oído que a @ se le dan muy bien los Zelda."},
    });
    ...
    hintTable[JUNK73] = HintText::Junk({
                     //obscure text
                     Text{"They say that the best weapon against Iron Knuckles is item 176.", /*french*/"Selon moi, les hache-viandes sont vuln\x96rables contre l'objet 176.", /*spanish*/"Según dicen, la mejor arma para enfrentarse a los Nudillos de hierro es el objeto 176."},
    });
    ...
    hintTable[DEKU_TREE] = HintText::DungeonName({
                     //obscure text
                     Text{"an ancient tree", /*french*/"le vieil arbre", /*spanish*/"un ancestral \x91rbol"},
                   }, {},
                     //clear text
    ...
    hintTable[SPIRIT_TEMPLE] = HintText::DungeonName({
                     //obscure text
                     Text{"the goddess of the sand", /*french*/"la d\x96esse des sables", /*spanish*/"la diosa de las arenas"},
                   }, {},
                     //clear text
    ...
    hintTable[ICE_CAVERN] = HintText::DungeonName({
                     //obscure text
                     Text{"a frozen maze", /*french*/"le d\x96dale glac\x96", /*spanish*/"un g\x96lido laberinto"},
                   }, {},
                     //clear text
    ...
    hintTable[GERUDO_TRAINING_GROUNDS] = HintText::DungeonName({
                     //obscure text
                     Text{"the test of thieves", /*french*/"l'\x96preuve des voleurs", /*spanish*/"la prueba de las bandidas"},
                   }, {},
                     //clear text
    ...
    hintTable[GANONS_CASTLE] = HintText::DungeonName({
                     //obscure text
                     Text{"a conquered citadel", /*french*/"la citadelle assi\x96g\x96e", /*spanish*/"una conquistada ciudadela"},
                   }, {},
                     //clear text
                     Text{"Inside Ganon's Castle", /*french*/"l'int\x96rieur du ch\x92teau de Ganon", /*spanish*/"el interior del Castillo de Ganon"}
    );
    ...
    hintTable[QUEEN_GOHMA] = HintText::Boss({
                     //obscure text
                     Text{"An #ancient tree# rewards", /*french*/"le #vieil arbre# octroie", /*spanish*/"un #ancestral \x91rbol# premia con"},
                   }, {},
                     //clear text
    ...
    hintTable[TWINROVA] = HintText::Boss({
                     //obscure text
                     Text{"a #goddess of the sand# rewards", /*french*/"la #d\x96esse des sables# octroie", /*spanish*/"la #diosa de la arena# premia con"},
                   }, {},
                     //clear text
    ...
    //                    //obscure text
    //                    Text{"#@'s pocket# rewards", /*french*/"#@ d\x96bute avec#", /*spanish*/"el #bolsillo de @# premia con"},
    //                  },
    //                    //clear text
    //                           Text{"#@ already has#", /*french*/"#@ a d\x96j\x90#", /*spanish*/"el #bolsillo de @ ya tiene#"}
    // );
    ...
    hintTable[BRIDGE_OPEN_HINT] = HintText::Bridge({
                ...
                /*french*/"Les êtres de sagesse ont#d\x96j\x90 cr\x96\x96&un pont# vers le repaire du mal.",
               /*spanish*/"Los sabios #ya habr\x91n creado un puente#&al castillo, de donde emana el mal."},
    });
    ...
    hintTable[BRIDGE_VANILLA_HINT] = HintText::Bridge({
                ...
                /*french*/"Les êtres de sagesse attendront le&h\x96ros muni des #m\x96daillons de l'ombre et&l'esprit# et des #fl\x95ches de lumi\x95re#.",
               /*spanish*/"Los sabios aguardar\x91n a que el h\x96roe&obtenga tanto el #Medallón de las&Sombras y el del Espíritu# junto a la #flecha de luz#."},
    });
    ...
    hintTable[BRIDGE_STONES_HINT] = HintText::Bridge({
                ...
                /*french*/"Les êtres de sagesse attendront le&h\x96ros muni de #%d |pierre spirituelle|pierres spirituelles|#.",
               /*spanish*/"Los sabios aguardar\x91n a que el h\x96roe&obtenga #%d |piedra espiritual|piedras espirituales|#."},
    });
    ...
    hintTable[BRIDGE_MEDALLIONS_HINT] = HintText::Bridge({
                ...
                /*french*/"Les êtres de sagesse attendront le&h\x96ros muni de #%d |m\x96daillon|m\x96daillons|#.",
               /*spanish*/"Los sabios aguardar\x91n a que el h\x96roe&obtenga #%d |medallón|medallones|#."},
    });
    ...
    hintTable[BRIDGE_REWARDS_HINT] = HintText::Bridge({
                ...
                /*french*/"Les êtres de sagesse attendront le&h\x96ros muni de #%d |pierre spirituelle&ou m\x96daillon|pierres spirituelles&et m\x96daillons|#.",
               /*spanish*/"Los sabios aguardar\x91n a que el h\x96roe&obtenga #%d |piedra espiritual o medallón|piedras espirtuales y medallones|#."},
    });
    ...
    hintTable[BRIDGE_DUNGEONS_HINT] = HintText::Bridge({
               ...
               /*spanish*/"Los sabios aguardar\x91n a que el h\x96roe& complete #%d |mazmorra|mazmorras|#."},
    });
    ...
    hintTable[BRIDGE_TOKENS_HINT] = HintText::Bridge({
                ...
                /*french*/"Les êtres de sagesse attendront le&h\x96ros muni de #%d |symbole|symboles| de&Skulltula d'or#.",
               /*spanish*/"Los sabios aguardar\x91n a que el h\x96roe&obtenga #%d |símbolo|símbolos| de&skulltula dorada#."},
    });
    ...
    hintTable[GANON_BK_START_WITH_HINT] = HintText::GanonsBossKey({
                ...
                /*french*/"Aussi, la cl\x96 du #Malin# sera #possession même du h\x96ros#.",
               /*spanish*/"Y obtendr\x91s la llave del #señor del mal# desde el #inicio#."},
    });
    ...
    hintTable[GANON_BK_VANILLA_HINT] = HintText::GanonsBossKey({
                ...
                /*french*/"Aussi, la cl\x96 du #Malin# sera encoffr\x96e #dans sa tour#.",
               /*spanish*/"Y la llave del #señor del mal# aguardar\x91 en un gran cofre de #su torre#."},
    });
    ...
    hintTable[GANON_BK_OWN_DUNGEON_HINT] = HintText::GanonsBossKey({
                ...
                /*french*/"Aussi, la cl\x96 du #Malin# sera cach\x96e #dans son vaste ch\x92teau#.",
               /*spanish*/"Y la llave del #señor del mal# aguardar\x91 en #algún lugar de su castillo#."},
    });
    ...
    hintTable[GANON_BK_OVERWORLD_HINT] = HintText::GanonsBossKey({
                ...
                /*french*/"Aussi, la cl\x96 du #Malin# se trouve #hors des donjons# d'Hyrule.",
               /*spanish*/"Y la llave del #señor del mal# aguardar\x91 #fuera de las mazmorras# de Hyrule."},
    });
    ...
    hintTable[GANON_BK_ANY_DUNGEON_HINT] = HintText::GanonsBossKey({
                ...
                /*french*/"Aussi, la cl\x96 du #Malin# se trouve #dans un donjon# d'Hyrule.",
               /*spanish*/"Y la llave del #señor del mal# aguardar\x91 #en una mazmorra# de Hyrule."},
    });

    hintTable[GANON_BK_ANYWHERE_HINT] = HintText::GanonsBossKey({
                     //obscure text
                     Text{"And the #evil one#'s key will be hidden somewhere #in Hyrule#.",
                /*french*/"Aussi, la cl\x96 du #Malin# se trouve quelque part #dans Hyrule#.",
               /*spanish*/"Y la llave del #señor del mal# aguardar\x91 en #cualquier lugar de Hyrule#."},
    });
    ...
    hintTable[GANON_BK_TRIFORCE_HINT] = HintText::GanonsBossKey({
                ...
                /*french*/"Aussi, la cl\x96 du #Malin# se r\x96v\x95lera une fois la #Triforce# assembl\x96e.",
               /*spanish*/"Y el h\x96roe recibir\x91 la llave del #señor del mal# cuando haya completado la #Trifuerza#."},
    });
    ...
    hintTable[LACS_VANILLA_HINT] = HintText::LACS({
                ...
                /*french*/"Aussi, Zelda cr\x96\x96ra la cl\x96 du&#Malin# avec les #m\x96daillons de&l'ombre et de l'esprit#.",
               /*spanish*/"Y Zelda entregar\x91 la llave&del #señor del mal# tras obtener&#el medallón de las sombras y del espíritu#."},
    });
    ...
    hintTable[LACS_MEDALLIONS_HINT] = HintText::LACS({
                ...
                /*french*/"Aussi, Zelda cr\x96\x96ra la cl\x96 du&#Malin# avec #%d |m\x96daillon|m\x96daillons|#.",
               /*spanish*/"Y Zelda entregar\x91 la llave&del #señor del mal# tras obtener&#%d |medallón|medallones|#."},
    });
    ...
    hintTable[LACS_STONES_HINT] = HintText::LACS({
                ...
                /*french*/"Aussi, Zelda cr\x96\x96ra la cl\x96 du&#Malin# avec #%d des |pierre&spirituelle|pierres&spirituelles|#.",
               /*spanish*/"Y Zelda entregar\x91 la llave&del #señor del mal# tras obtener&#%d |piedra espiritual|piedras espirituales|#."},
    });
    ...
    hintTable[LACS_REWARDS_HINT] = HintText::LACS({
                ...
                /*french*/"Aussi, Zelda cr\x96\x96ra la cl\x96 du&#Malin# avec #%d |pierre spirituelle&et des m\x96daillon|pierres spirituelles&et des m\x96daillons|#.",
               /*spanish*/"Y Zelda entregar\x91 la llave&del #señor del mal# tras obtener&#%d |piedra espiritual o medallón|piedras espirituales o medallones|#."},
    });
    ...
    hintTable[LACS_DUNGEONS_HINT] = HintText::LACS({
                ...
                /*french*/"Aussi, Zelda cr\x96\x96ra la cl\x96 du&#Malin# une fois #%d |donjon conqu\x96ri|donjons conqu\x96ris|#.",
               /*spanish*/"Y Zelda entregar\x91 la llave&del #señor del mal# tras completar&#%d |mazmorra|mazmorras|#."},
    });
    ...
    hintTable[LACS_TOKENS_HINT] = HintText::LACS({
                ...
                /*french*/"Aussi, Zelda cr\x96\x96ra la cl\x96 du&#Malin# avec #%d |symbole|symboles| de&Skulltula d'or#.",
               /*spanish*/"Y Zelda entregar\x91 la llave&del #señor del mal# tras obtener&#%d |símbolo|símbolos| de&skulltula dorada#."},
    });
    /*--------------------------
    |     TRIAL HINT TEXT      |
    ---------------------------*/
    ...
    hintTable[SIX_TRIALS] = HintText::Exclude({
                     //obscure text
                     Text{"#Ganon's Tower# is protected by a powerful barrier.", /*french*/"#la tour de Ganon# est prot\x96g\x96e par une puissante barri\x95re", /*spanish*/"la #torre de Ganon# est\x91 protegida por una poderosa barrera"},
    });

    hintTable[ZERO_TRIALS] = HintText::Exclude({
                     //obscure text
                     Text{"Sheik dispelled the barrier around #Ganon's Tower#.", /*french*/"Sheik a dissip\x96 la barri\x95re autour de #la tour de Ganon#", /*spanish*/"Sheik disipó la barrera alrededor de la #torre de Ganon#."},
    });

    hintTable[FOUR_TO_FIVE_TRIALS] = HintText::Exclude({
                     //obscure text
                     Text{" was dispelled by Sheik.", /*french*/" a \x96t\x96 dissip\x96e par Sheik.", /*spanish*/" se disipó gracias a Sheik."},
    });

    hintTable[ONE_TO_THREE_TRIALS] = HintText::Exclude({
                     //obscure text
                     Text{" protects Ganons Tower.", /*french*/" prot\x95ge la tour de Ganon.", /*spanish*/" protege la torre de Ganon"},
    });
    ...
    hintTable[SPIRITUAL_STONE_TEXT_START] = HintText::Altar({
                ...
                /*french*/"Les trois pierres spirituelles cach\x96es dans Hyrule...",
    ...
    hintTable[CHILD_ALTAR_TEXT_END_DOTOPEN] = HintText::Altar({
                ...
                /*french*/"À celui qui a quête de devenir h\x96ros...&Le futur vous accueille b\x96ant...",
               /*spanish*/"Para aquel que se convierta en el h\x96roe...&La puerta al futuro est\x91 a su disposición..."},
    });
    ...
    hintTable[CHILD_ALTAR_TEXT_END_DOTCLOSED] = HintText::Altar({
                ...
                /*french*/"À celui qui a quête de devenir h\x96ros...&Portez l'Ocarina et&jouez le chant du temps.",
               /*spanish*/"Para aquel que se convierta en el h\x96roe...&Tome la ocarina y&entone la Canción del Tiempo."},
    });
    ...
    hintTable[CHILD_ALTAR_TEXT_END_DOTINTENDED] = HintText::Altar({
                ...
                /*french*/"À celui qui a quête de devenir h\x96ros...&Pr\x96sentez les pierres spirituelles et&jouez le chant du temps.",
               /*spanish*/"Para aquel que se convierta en el h\x96roe...&Tome las piedras espirituales y&entone la Canción del Tiempo."},
    });
    ...
    hintTable[ADULT_ALTAR_TEXT_START] = HintText::Altar({
                ...
                /*french*/"Quand le mal aura triomph\x96, une voix du Saint Royaume appellera ceux cach\x96s dans les #cinq temples#, destin\x96s \x90 être Sages.",
               /*spanish*/"Cuando el mal lo impregne todo, desde el Reino Sagrado surgir\x91 una voz que har\x91 despertar a los sabios que moran en los #cinco templos#."},
    });
    ...
    hintTable[ADULT_ALTAR_TEXT_END] = HintText::Altar({
                ...
                /*french*/"Ensemble avec le H\x96ros du Temps,&ces Sages emprisonneront le mal et&r\x96instaureront la lumi\x95re de paix dans&le monde...",
               /*spanish*/"Con el H\x96roe del Tiempo, aquellos&que despierten detendr\x91n el mal y&volver\x91n al mundo de luz la paz..."},
    });
    ...
    hintTable[VALIDATION_LINE] = HintText::Validation({
                ...
                /*french*/"Pah! Puisque tu t'es rendu ici, je te dirai quel tr\x96sor tu as manqu\x96 dans ma tour.^Et c'est...^",
               /*spanish*/"Mmm... Ya que has llegado hasta aquí, te dir\x96 qu\x96 preciado objeto de mi propiedad puedes haberte dejado en mi torre.^He aquí...^"},
    });
    ...
    hintTable[LIGHT_ARROW_LOCATION_HINT] = HintText::LightArrow({
                ...
                /*french*/"Ha ha ha... Pauvre fou! Tu ne pourras jamais me vaincre sans les fl\x95ches que j'ai cach\x96 dans ",
               /*spanish*/"Ja, ja, ja... Nunca me derrotar\x91s reflejando mis esferas de energía y desplegando la flecha de luz de "},
    });
    ...
    hintTable[GANON_LINE01] = HintText::GanonLine({
                ...
                /*french*/"Ah, c'est @.&J'attendais un certain Sheik. Tu sais ce qui lui est arriv\x96?",
               /*spanish*/"¡Oh! Pero si es @.&Estaba esperando a alguien llamado Sheik. ¿Sabes qu\x96 puede haberle pasado?"},
    });

    hintTable[GANON_LINE02] = HintText::GanonLine({
                     //obscure text
                     Text{"I knew I shouldn't have put the key on the other side of my door.",
                /*french*/"J'aurais d\x9D garder la cl\x96 ici. H\x96las...",
    ...
    hintTable[GANON_LINE04] = HintText::GanonLine({
                ...
                /*french*/"Ne perds pas ton temps \x90 frapper mes \x96clairs d'\x96nergie avec ton \x96p\x96e et me tirer avec tes fl\x95ches de Lumi\x95re!",
               /*spanish*/"Nunca reflejar\x91s mis esferas de energía con tu espada, para despu\x96s dispararme con las flechas de luz que tendr\x91s."},
    });

    hintTable[GANON_LINE05] = HintText::GanonLine({
                     //obscure text
                     Text{"Why did I leave my trident back in the desert?",
                /*french*/"Sale bêtise... Et j'ai oubli\x96 mon trident dans le d\x96sert!",
               /*spanish*/"Santa Hylia... ¿Por qu\x96 me habr\x96 dejado el tridente en el desierto?"},
    });
    ...
    hintTable[GANON_LINE06] = HintText::GanonLine({
                ...
                /*french*/"Même si je suis vaincu... Zelda te renverra dans ton \x95re, et je reviendrai conqu\x96rir!^Telle est la proph\x96cie d'Hyrule Historia!",
    ...
    hintTable[GANON_LINE07] = HintText::GanonLine({
                ...
                /*french*/"Zelda ne sera jamais un meilleur monarque que moi!^J'ai un ch\x92teau volant, mes sujets sont des belles amazones... et mes Moblins sont clairement plus puissants que jamais!",
               /*spanish*/"¿Qu\x96 te hace pensar que Zelda gobierna mejor que yo?^Yo he salvado el Rancho Lon Lon,&he alimentado a los hambrientos&y hasta hago que mi castillo flote."},
    });

    hintTable[GANON_LINE08] = HintText::GanonLine({
                     //obscure text
                     Text{"I've learned this spell,&it's really neat,&I'll keep it later&for your treat!",
                /*french*/"Gamin, ton destin ach\x95ve,&sous mon sort tu p\x96riras!&Cette partie ne fut pas br\x95ve,&et cette mort, tu subiras!",
               /*spanish*/"Veamos ahora que har\x91s,&la batalla ha de comenzar,&te enviar\x96 de una vez al m\x91s all\x91,&¿listo para afrontar la verdad?"},
    });

    hintTable[GANON_LINE09] = HintText::GanonLine({
                     //obscure text
                     Text{"Many tricks are up my sleeve,&to save yourself&you'd better leave!",
                /*french*/"Sale petit garnement,&tu fais erreur!&C'est maintenant que marque&ta derni\x95re heure!",
               /*spanish*/"¿No osar\x91s a mí enfrentarte?&Rimas aparte,&¡voy a matarte!"},
    });

    hintTable[GANON_LINE10] = HintText::GanonLine({
                     //obscure text
                     Text{"After what you did to Koholint Island, how can you call me the bad guy?",
                /*french*/"J'admire ce que tu as fait \x90 l'Île Koholint... Toi et moi, nous devrions faire \x96quipe!",
               /*spanish*/"Despu\x96s de lo que le hiciste a la Isla Koholint, ¿cómo te atreves a llamarme malvado?"},
    });

    hintTable[GANON_LINE11] = HintText::GanonLine({
                     //obscure text
                     Text{"Today, let's begin down&'The Hero is Defeated' timeline.",
                /*french*/"Si tu me vaincs, Hyrule sera englouti... mais si tu meurs, on aura A Link to the Past, le meilleur opus de la s\x96rie!",
               /*spanish*/"Hoy daremos lugar a la línea temporal del H\x96roe Derrotado.&¡Prep\x91rate para el culmen de esta saga!"},
    });
    ...
    hintTable[CARPET_SALESMAN_DIALOG_FIRST] = HintText::MerchantsDialogs({
                ...
                /*french*/"Bienvenue!^Je vends des objets rares et merveilleux du&monde entier. En sp\x96cial aujourd'hui...^",
               /*spanish*/"¡Ac\x96rcate!^Vendo productos extraños y difíciles de&encontrar... De todo el mundo a todo el&mundo. La oferta de hoy es...^¡"},
    });
    ...
    hintTable[CARPET_SALESMAN_DIALOG_SECOND] = HintText::MerchantsDialogs({
                ...
                /*french*/"! Un&concentr\x96 de puissance! Mais montre tes&rubis avant que je te dise ce que c'est...^Disons #200 rubis#?&&"+TWO_WAY_CHOICE()+"#Acheter&Ne pas acheter#",
               /*spanish*/"! ¡Terrorífico!&No te revelar\x96 su nombre hasta que&vea el dinero...^#200 rupias#, ¿qu\x96 te parece?&&"+TWO_WAY_CHOICE()+"#Comprar&No comprar#"},
    });
    ...
    hintTable[CARPET_SALESMAN_DIALOG_FOURTH] = HintText::MerchantsDialogs({
                ...
                /*french*/"!#^La marque qui te m\x95nera au #Temple de l'esprit# est le #drapeau "+IF_NOT_MQ()+"gauche"+MQ_ELSE()+"droite"+MQ_END()+"# en sortant d'ici. À la prochaine!",
               /*spanish*/"!#^La marca que te guiar\x91 al #Templo del&Espíritu# es la #bandera que est\x91 a la&"+IF_NOT_MQ()+"izquierda"+MQ_ELSE()+"derecha"+MQ_END()+"# al salir de aquí. ¡Nos vemos!"},
    });
}
