...
std::array<SongMapEntry, 12> songMapping = { {
    SONG_MAP_ENTRY(QUEST_SONG_LULLABY,  109,  73, 143),
    SONG_MAP_ENTRY(QUEST_SONG_EPONA,    217, 110,  48),
    SONG_MAP_ENTRY(QUEST_SONG_SARIA,     62, 109,  23),
    SONG_MAP_ENTRY(QUEST_SONG_SUN,      237, 231,  62),
    SONG_MAP_ENTRY(QUEST_SONG_TIME,      98, 177, 211),
    SONG_MAP_ENTRY(QUEST_SONG_STORMS,   146, 146, 146),
