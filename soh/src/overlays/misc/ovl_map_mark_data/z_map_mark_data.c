...
MapMarkData* gMapMarkDataTableVanilla[] = {
    sMapMarkDekuTreeVanilla,
    sMapMarkDodongosCavernVanilla,
    sMapMarkJabuJabuBellyVanilla,
    sMapMarkForestTempleVanilla,
    sMapMarkFireTempleVanilla,
    sMapMarkWaterTempleVanilla,
    sMapMarkSpiritTempleVanilla,
    sMapMarkShadowTempleVanilla,
    sMapMarkBottomWellVanilla,
    sMapMarkIceCavernVanilla,
};
...
MapMarkData* gMapMarkDataTableMq[] = {
    sMapMarkDekuTreeMq,
    sMapMarkDodongosCavernMq,
    sMapMarkJabuJabuBellyMq,
    sMapMarkForestTempleMq,
    sMapMarkFireTempleMq,
    sMapMarkWaterTempleMq,
    sMapMarkSpiritTempleMq,
    sMapMarkShadowTempleMq,
    sMapMarkBottomWellMq,
    sMapMarkIceCavernMq,
};
