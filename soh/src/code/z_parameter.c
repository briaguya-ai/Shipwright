...
void Interface_DrawMagicBar(PlayState* play) {
    ...
    if (gSaveContext.magicLevel != 0) {
        ...
        if (CVarGetInteger("gHudColors", 1) == 2) {//Original game add color there so to prevent miss match we make it all white :)
            gDPSetEnvColor(OVERLAY_DISP++, 255, 255, 255, 255);
        } else {
...
void Interface_DrawItemButtons(PlayState* play) {
    ...
    for (temp = 1; temp < 4; temp++) {
        if (gSaveContext.equips.buttonItems[temp] > 0xF0) {
            ...
            if (CVarGetInteger("gHudColors", 1) == 2 && !CVarGetInteger("gCCparated", 0)) {
                gDPSetPrimColor(OVERLAY_DISP++, 0, 0, C_button_uni.r, C_button_uni.g, C_button_uni.b, interfaceCtx->cRightAlpha);
            } else if (temp == 1 && CVarGetInteger("gHudColors", 1) == 2 && CVarGetInteger("gCCparated", 0)) {
                gDPSetPrimColor(OVERLAY_DISP++, 0, 0, C_button_L.r, C_button_L.g, C_button_L.b, interfaceCtx->cLeftAlpha);
            } else if (temp == 2 && CVarGetInteger("gHudColors", 1) == 2 && CVarGetInteger("gCCparated", 0)) {
                gDPSetPrimColor(OVERLAY_DISP++, 0, 0, C_button_D.r, C_button_D.g, C_button_D.b, interfaceCtx->cDownAlpha);
            } else if (CVarGetInteger("gHudColors", 1) == 2 && CVarGetInteger("gCCparated", 0)) {
                gDPSetPrimColor(OVERLAY_DISP++, 0, 0, C_button_R.r, C_button_R.g, C_button_R.b, interfaceCtx->cRightAlpha);
            }
    ...
    if (pauseCtx->debugState == 0) {
        ...
        if (fullUi) {
            ...
            if (CVarGetInteger("gHudColors", 1) == 2) {
                ...
                if (CVarGetInteger("gDynamicWalletIcon", 0) != 0) {
            ...
            if (CVarGetInteger("gHudColors", 1) == 2 && CVarGetInteger("gDynamicWalletIcon", 0) != 1) {
